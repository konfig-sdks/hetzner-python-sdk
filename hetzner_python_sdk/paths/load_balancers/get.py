...
from hetzner_python_sdk.model.load_balancers_get_all_response import LoadBalancersGetAllResponse as LoadBalancersGetAllResponseSchema

from hetzner_python_sdk.type.load_balancers_get_all_response import LoadBalancersGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancers_get_all_response import LoadBalancersGetAllResponse as LoadBalancersGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancersGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancersGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersGetAllResponsePydantic:
        ...
        if validate:
            return LoadBalancersGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancersGetAllResponsePydantic, raw_response.body)
