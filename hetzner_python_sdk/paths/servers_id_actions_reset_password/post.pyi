...
from hetzner_python_sdk.model.server_actions_reset_server_password_response import ServerActionsResetServerPasswordResponse as ServerActionsResetServerPasswordResponseSchema

from hetzner_python_sdk.type.server_actions_reset_server_password_response import ServerActionsResetServerPasswordResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_reset_server_password_response import ServerActionsResetServerPasswordResponse as ServerActionsResetServerPasswordResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsResetServerPasswordResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsResetServerPasswordResponse
...
class BaseApi(api_client.Api):
    ...
    def _reset_server_password_mapped_args(
        self,
        id: int,
    ...
    async def _areset_server_password_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/reset_password',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _reset_server_password_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ResetServerPasswordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_server_password(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._reset_server_password_mapped_args(
            id=id,
        )
        return await self._areset_server_password_oapg(
    ...
    def reset_server_password(
        ...
        return self._reset_server_password_oapg(
            path_params=args.path,
        )

class ResetServerPassword(BaseApi):
    ...
    async def areset_server_password(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsResetServerPasswordResponsePydantic:
        raw_response = await self.raw.areset_server_password(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsResetServerPasswordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsResetServerPasswordResponsePydantic, raw_response.body)
    ...
    def reset_server_password(
        ...
        raw_response = self.raw.reset_server_password(
            id=id,
        )
        if validate:
            return ServerActionsResetServerPasswordResponsePydantic(**raw_response.body)
