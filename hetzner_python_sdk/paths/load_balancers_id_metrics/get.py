...
from hetzner_python_sdk.model.load_balancers_get_metrics_response import LoadBalancersGetMetricsResponse as LoadBalancersGetMetricsResponseSchema

from hetzner_python_sdk.type.load_balancers_get_metrics_response import LoadBalancersGetMetricsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancers_get_metrics_response import LoadBalancersGetMetricsResponse as LoadBalancersGetMetricsResponsePydantic
...
class TypeSchema(
    ...
    def OPEN_CONNECTIONS(cls):
        return cls("open_connections")
    
    @schemas.classproperty
    def CONNECTIONS_PER_SECOND(cls):
        return cls("connections_per_second")
    
    @schemas.classproperty
    def REQUESTS_PER_SECOND(cls):
        return cls("requests_per_second")
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancersGetMetricsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancersGetMetricsResponse
    ...
    async def _aget_metrics_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/metrics',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMetricsRaw(BaseApi):
    ...
    async def aget_metrics(
        ...
        **kwargs,
        ...
        args = self._get_metrics_mapped_args(
            id=id,
            type=type,
            start=start,
            end=end,
        ...
        return await self._aget_metrics_oapg(
    ...
    def get_metrics(
        ...
        return self._get_metrics_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMetrics(BaseApi):
    ...
    async def aget_metrics(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersGetMetricsResponsePydantic:
        raw_response = await self.raw.aget_metrics(
            id=id,
            type=type,
            start=start,
            end=end,
        ...
        if validate:
            return LoadBalancersGetMetricsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancersGetMetricsResponsePydantic, raw_response.body)
    ...
    def get_metrics(
        ...
        raw_response = self.raw.get_metrics(
            id=id,
            type=type,
            start=start,
            end=end,
