...
from hetzner_python_sdk.model.certificates_get_all_response import CertificatesGetAllResponse as CertificatesGetAllResponseSchema

from hetzner_python_sdk.type.certificates_get_all_response import CertificatesGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificates_get_all_response import CertificatesGetAllResponse as CertificatesGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CertificatesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CertificatesGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesGetAllResponsePydantic:
        ...
        if validate:
            return CertificatesGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificatesGetAllResponsePydantic, raw_response.body)
