...
from hetzner_python_sdk.model.load_balancer_actions_detach_from_network_request import LoadBalancerActionsDetachFromNetworkRequest as LoadBalancerActionsDetachFromNetworkRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_detach_from_network_response import LoadBalancerActionsDetachFromNetworkResponse as LoadBalancerActionsDetachFromNetworkResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_detach_from_network_request import LoadBalancerActionsDetachFromNetworkRequest
from hetzner_python_sdk.type.load_balancer_actions_detach_from_network_response import LoadBalancerActionsDetachFromNetworkResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_detach_from_network_request import LoadBalancerActionsDetachFromNetworkRequest as LoadBalancerActionsDetachFromNetworkRequestPydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_detach_from_network_response import LoadBalancerActionsDetachFromNetworkResponse as LoadBalancerActionsDetachFromNetworkResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsDetachFromNetworkRequestSchema


request_body_load_balancer_actions_detach_from_network_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsDetachFromNetworkResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsDetachFromNetworkResponse
...
class BaseApi(api_client.Api):
    ...
    def _detach_from_network_mapped_args(
        self,
        network: int,
        id: int,
    ...
    async def _adetach_from_network_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/detach_from_network',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_detach_from_network_request.serialize(body, content_type)
...
class DetachFromNetworkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetach_from_network(
        self,
        network: int,
        id: int,
        **kwargs,
        ...
        args = self._detach_from_network_mapped_args(
            network=network,
            id=id,
        )
        return await self._adetach_from_network_oapg(
            body=args.body,
    ...
    def detach_from_network(
        ...
        return self._detach_from_network_oapg(
            body=args.body,
            path_params=args.path,
        )

class DetachFromNetwork(BaseApi):
    ...
    async def adetach_from_network(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsDetachFromNetworkResponsePydantic:
        raw_response = await self.raw.adetach_from_network(
            network=network,
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsDetachFromNetworkResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsDetachFromNetworkResponsePydantic, raw_response.body)
    ...
    def detach_from_network(
        ...
        raw_response = self.raw.detach_from_network(
            network=network,
            id=id,
        )
        if validate:
