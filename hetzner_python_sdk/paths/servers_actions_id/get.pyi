...
from hetzner_python_sdk.model.server_actions_get_action_by_id_response import ServerActionsGetActionByIdResponse as ServerActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.server_actions_get_action_by_id_response import ServerActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_get_action_by_id_response import ServerActionsGetActionByIdResponse as ServerActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServerActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsGetActionByIdResponsePydantic, raw_response.body)
