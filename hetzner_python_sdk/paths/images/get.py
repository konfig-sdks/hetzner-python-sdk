...
from hetzner_python_sdk.model.images_get_all_response import ImagesGetAllResponse as ImagesGetAllResponseSchema

from hetzner_python_sdk.type.images_get_all_response import ImagesGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.images_get_all_response import ImagesGetAllResponse as ImagesGetAllResponsePydantic
...
class SortSchema(
    ...
    @schemas.classproperty
    def CREATEDASC(cls):
        return cls("created:asc")
    
    @schemas.classproperty
    def CREATEDDESC(cls):
        return cls("created:desc")
...
class StatusSchema(
    ...
    def CREATING(cls):
        return cls("creating")
BoundToSchema = schemas.StrSchema
IncludeDeprecatedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'bound_to': typing.Union[BoundToSchema, str, ],
        'include_deprecated': typing.Union[IncludeDeprecatedSchema, bool, ],
...
request_query_bound_to = api_client.QueryParameter(
    name="bound_to",
    style=api_client.ParameterStyle.FORM,
    schema=BoundToSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ImagesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImagesGetAllResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        ...
        bound_to: typing.Optional[str] = None,
        ...
        if bound_to is not None:
            _query_params["bound_to"] = bound_to
        if include_deprecated is not None:
            _query_params["include_deprecated"] = include_deprecated
        if name is not None:
            _query_params["name"] = name
        if label_selector is not None:
            _query_params["label_selector"] = label_selector
        if architecture is not None:
            _query_params["architecture"] = architecture
        if page is not None:
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return ImagesGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagesGetAllResponsePydantic, raw_response.body)
