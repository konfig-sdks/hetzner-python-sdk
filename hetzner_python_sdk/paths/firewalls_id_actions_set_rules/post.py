...
from hetzner_python_sdk.model.firewall_actions_set_rules_response import FirewallActionsSetRulesResponse as FirewallActionsSetRulesResponseSchema
from hetzner_python_sdk.model.firewall_actions_set_rules_request_rules import FirewallActionsSetRulesRequestRules as FirewallActionsSetRulesRequestRulesSchema
from hetzner_python_sdk.model.firewall_actions_set_rules_request import FirewallActionsSetRulesRequest as FirewallActionsSetRulesRequestSchema

from hetzner_python_sdk.type.firewall_actions_set_rules_request import FirewallActionsSetRulesRequest
from hetzner_python_sdk.type.firewall_actions_set_rules_request_rules import FirewallActionsSetRulesRequestRules
from hetzner_python_sdk.type.firewall_actions_set_rules_response import FirewallActionsSetRulesResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewall_actions_set_rules_request import FirewallActionsSetRulesRequest as FirewallActionsSetRulesRequestPydantic
from hetzner_python_sdk.pydantic.firewall_actions_set_rules_response import FirewallActionsSetRulesResponse as FirewallActionsSetRulesResponsePydantic
from hetzner_python_sdk.pydantic.firewall_actions_set_rules_request_rules import FirewallActionsSetRulesRequestRules as FirewallActionsSetRulesRequestRulesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallActionsSetRulesRequestSchema


request_body_firewall_actions_set_rules_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FirewallActionsSetRulesResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FirewallActionsSetRulesResponse
...
class BaseApi(api_client.Api):
    ...
    def _set_rules_mapped_args(
        self,
        rules: FirewallActionsSetRulesRequestRules,
        id: int,
    ...
    async def _aset_rules_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/firewalls/{id}/actions/set_rules',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_firewall_actions_set_rules_request.serialize(body, content_type)
...
class SetRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_rules(
        self,
        rules: FirewallActionsSetRulesRequestRules,
        id: int,
        **kwargs,
        ...
        args = self._set_rules_mapped_args(
            rules=rules,
            id=id,
        )
        return await self._aset_rules_oapg(
            body=args.body,
    ...
    def set_rules(
        ...
        return self._set_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class SetRules(BaseApi):
    ...
    async def aset_rules(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallActionsSetRulesResponsePydantic:
        raw_response = await self.raw.aset_rules(
            rules=rules,
            id=id,
            **kwargs,
        )
        if validate:
            return FirewallActionsSetRulesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallActionsSetRulesResponsePydantic, raw_response.body)
    ...
    def set_rules(
        ...
        raw_response = self.raw.set_rules(
            rules=rules,
            id=id,
        )
        if validate:
