...
from hetzner_python_sdk.model.firewall_actions_get_action_by_id_response import FirewallActionsGetActionByIdResponse as FirewallActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.firewall_actions_get_action_by_id_response import FirewallActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewall_actions_get_action_by_id_response import FirewallActionsGetActionByIdResponse as FirewallActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FirewallActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/firewalls/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return FirewallActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallActionsGetActionByIdResponsePydantic, raw_response.body)
