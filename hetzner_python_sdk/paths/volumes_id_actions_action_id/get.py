...
from hetzner_python_sdk.model.volume_actions_get_action_response import VolumeActionsGetActionResponse as VolumeActionsGetActionResponseSchema

from hetzner_python_sdk.type.volume_actions_get_action_response import VolumeActionsGetActionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_get_action_response import VolumeActionsGetActionResponse as VolumeActionsGetActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumeActionsGetActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumeActionsGetActionResponse
    ...
    async def _aget_action_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/{id}/actions/{action_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_action(
        self,
        id: int,
        action_id: int,
        **kwargs,
        ...
        args = self._get_action_mapped_args(
            id=id,
            action_id=action_id,
        )
        return await self._aget_action_oapg(
    ...
    def get_action(
        ...
        return self._get_action_oapg(
            path_params=args.path,
        )

class GetAction(BaseApi):
    ...
    async def aget_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsGetActionResponsePydantic:
        raw_response = await self.raw.aget_action(
            id=id,
            action_id=action_id,
            **kwargs,
        )
        if validate:
            return VolumeActionsGetActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsGetActionResponsePydantic, raw_response.body)
    ...
    def get_action(
        ...
        raw_response = self.raw.get_action(
            id=id,
            action_id=action_id,
        )
        if validate:
