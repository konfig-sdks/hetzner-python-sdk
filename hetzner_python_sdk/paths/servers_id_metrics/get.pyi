...
from hetzner_python_sdk.model.servers_get_metrics_for_server_response import ServersGetMetricsForServerResponse as ServersGetMetricsForServerResponseSchema

from hetzner_python_sdk.type.servers_get_metrics_for_server_response import ServersGetMetricsForServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.servers_get_metrics_for_server_response import ServersGetMetricsForServerResponse as ServersGetMetricsForServerResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServersGetMetricsForServerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServersGetMetricsForServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_metrics_for_server_mapped_args(
        self,
        id: int,
        type: str,
        start: str,
    ...
    async def _aget_metrics_for_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/metrics',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_metrics_for_server_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMetricsForServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_metrics_for_server(
        self,
        id: int,
        type: str,
        start: str,
        ...
        **kwargs,
        ...
        args = self._get_metrics_for_server_mapped_args(
            id=id,
            type=type,
            start=start,
            end=end,
        ...
        return await self._aget_metrics_for_server_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_metrics_for_server(
        self,
        id: int,
        type: str,
        start: str,
        ...
        return self._get_metrics_for_server_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMetricsForServer(BaseApi):
    ...
    async def aget_metrics_for_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServersGetMetricsForServerResponsePydantic:
        raw_response = await self.raw.aget_metrics_for_server(
            id=id,
            type=type,
            start=start,
            end=end,
        ...
        if validate:
            return ServersGetMetricsForServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServersGetMetricsForServerResponsePydantic, raw_response.body)
    ...
    def get_metrics_for_server(
        ...
        raw_response = self.raw.get_metrics_for_server(
            id=id,
            type=type,
            start=start,
            end=end,
