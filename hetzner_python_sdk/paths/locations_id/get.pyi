...
from hetzner_python_sdk.model.locations_get_location_by_id_response import LocationsGetLocationByIdResponse as LocationsGetLocationByIdResponseSchema

from hetzner_python_sdk.type.locations_get_location_by_id_response import LocationsGetLocationByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.locations_get_location_by_id_response import LocationsGetLocationByIdResponse as LocationsGetLocationByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LocationsGetLocationByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LocationsGetLocationByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_location_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _aget_location_by_id_oapg(
        self,
...
class GetLocationByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_location_by_id(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_location_by_id_mapped_args(
            id=id,
        )
        return await self._aget_location_by_id_oapg(
...
class GetLocationById(BaseApi):
    ...
    async def aget_location_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LocationsGetLocationByIdResponsePydantic:
        raw_response = await self.raw.aget_location_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return LocationsGetLocationByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LocationsGetLocationByIdResponsePydantic, raw_response.body)
    ...
    def get_location_by_id(
        ...
        raw_response = self.raw.get_location_by_id(
            id=id,
        )
        if validate:
            return LocationsGetLocationByIdResponsePydantic(**raw_response.body)
