...
from hetzner_python_sdk.model.network_actions_delete_subnet_request import NetworkActionsDeleteSubnetRequest as NetworkActionsDeleteSubnetRequestSchema
from hetzner_python_sdk.model.network_actions_delete_subnet_response import NetworkActionsDeleteSubnetResponse as NetworkActionsDeleteSubnetResponseSchema

from hetzner_python_sdk.type.network_actions_delete_subnet_request import NetworkActionsDeleteSubnetRequest
from hetzner_python_sdk.type.network_actions_delete_subnet_response import NetworkActionsDeleteSubnetResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_delete_subnet_request import NetworkActionsDeleteSubnetRequest as NetworkActionsDeleteSubnetRequestPydantic
from hetzner_python_sdk.pydantic.network_actions_delete_subnet_response import NetworkActionsDeleteSubnetResponse as NetworkActionsDeleteSubnetResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsDeleteSubnetRequestSchema


request_body_network_actions_delete_subnet_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = NetworkActionsDeleteSubnetResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsDeleteSubnetResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_subnet_mapped_args(
        self,
        ip_range: str,
        id: int,
    ...
    async def _adelete_subnet_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/delete_subnet',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_delete_subnet_request.serialize(body, content_type)
...
class DeleteSubnetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_subnet(
        self,
        ip_range: str,
        id: int,
        **kwargs,
        ...
        args = self._delete_subnet_mapped_args(
            ip_range=ip_range,
            id=id,
        )
        return await self._adelete_subnet_oapg(
            body=args.body,
    ...
    def delete_subnet(
        ...
        return self._delete_subnet_oapg(
            body=args.body,
            path_params=args.path,
        )

class DeleteSubnet(BaseApi):
    ...
    async def adelete_subnet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsDeleteSubnetResponsePydantic:
        raw_response = await self.raw.adelete_subnet(
            ip_range=ip_range,
            id=id,
            **kwargs,
        )
        if validate:
            return NetworkActionsDeleteSubnetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsDeleteSubnetResponsePydantic, raw_response.body)
    ...
    def delete_subnet(
        ...
        raw_response = self.raw.delete_subnet(
            ip_range=ip_range,
            id=id,
        )
        if validate:
