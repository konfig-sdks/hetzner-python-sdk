...
from hetzner_python_sdk.model.volumes_create_volume_response import VolumesCreateVolumeResponse as VolumesCreateVolumeResponseSchema
from hetzner_python_sdk.model.volumes_create_volume_request import VolumesCreateVolumeRequest as VolumesCreateVolumeRequestSchema

from hetzner_python_sdk.type.volumes_create_volume_request import VolumesCreateVolumeRequest
from hetzner_python_sdk.type.volumes_create_volume_response import VolumesCreateVolumeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volumes_create_volume_request import VolumesCreateVolumeRequest as VolumesCreateVolumeRequestPydantic
from hetzner_python_sdk.pydantic.volumes_create_volume_response import VolumesCreateVolumeResponse as VolumesCreateVolumeResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = VolumesCreateVolumeRequestSchema


request_body_volumes_create_volume_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = VolumesCreateVolumeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: VolumesCreateVolumeResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_volume_mapped_args(
        self,
        name: str,
        size: int,
    ...
    async def _acreate_volume_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_volumes_create_volume_request.serialize(body, content_type)
...
class CreateVolumeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_volume(
        self,
        name: str,
        size: int,
        automount: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_volume_mapped_args(
            name=name,
            size=size,
            automount=automount,
            format=format,
        ...
        return await self._acreate_volume_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_volume(
        ...
        return self._create_volume_oapg(
            body=args.body,
        )

class CreateVolume(BaseApi):
    ...
    async def acreate_volume(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumesCreateVolumeResponsePydantic:
        raw_response = await self.raw.acreate_volume(
            name=name,
            size=size,
            automount=automount,
            format=format,
        ...
        if validate:
            return VolumesCreateVolumeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumesCreateVolumeResponsePydantic, raw_response.body)
    ...
    def create_volume(
        ...
        raw_response = self.raw.create_volume(
            name=name,
            size=size,
            automount=automount,
            format=format,
