...
from hetzner_python_sdk.model.volumes_get_all_response import VolumesGetAllResponse as VolumesGetAllResponseSchema

from hetzner_python_sdk.type.volumes_get_all_response import VolumesGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volumes_get_all_response import VolumesGetAllResponse as VolumesGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumesGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return VolumesGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumesGetAllResponsePydantic, raw_response.body)
