...
from hetzner_python_sdk.model.server_actions_change_protection_response import ServerActionsChangeProtectionResponse as ServerActionsChangeProtectionResponseSchema
from hetzner_python_sdk.model.server_actions_change_protection_request import ServerActionsChangeProtectionRequest as ServerActionsChangeProtectionRequestSchema

from hetzner_python_sdk.type.server_actions_change_protection_response import ServerActionsChangeProtectionResponse
from hetzner_python_sdk.type.server_actions_change_protection_request import ServerActionsChangeProtectionRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_change_protection_response import ServerActionsChangeProtectionResponse as ServerActionsChangeProtectionResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_change_protection_request import ServerActionsChangeProtectionRequest as ServerActionsChangeProtectionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsChangeProtectionRequestSchema


request_body_server_actions_change_protection_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsChangeProtectionResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsChangeProtectionResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_protection_mapped_args(
        ...
        rebuild: typing.Optional[bool] = None,
    ...
    async def _achange_protection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_change_protection_request.serialize(body, content_type)
...
class ChangeProtection(BaseApi):
    ...
    async def achange_protection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsChangeProtectionResponsePydantic:
        ...
        if validate:
            return ServerActionsChangeProtectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsChangeProtectionResponsePydantic, raw_response.body)
