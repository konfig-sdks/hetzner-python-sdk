...
from hetzner_python_sdk.model.firewall_actions_get_all_actions_response import FirewallActionsGetAllActionsResponse as FirewallActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.firewall_actions_get_all_actions_response import FirewallActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewall_actions_get_all_actions_response import FirewallActionsGetAllActionsResponse as FirewallActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FirewallActionsGetAllActionsResponse
    ...
    async def _aget_all_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/firewalls/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return FirewallActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallActionsGetAllActionsResponsePydantic, raw_response.body)
