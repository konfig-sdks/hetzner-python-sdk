...
from hetzner_python_sdk.model.server_actions_power_off_server_response import ServerActionsPowerOffServerResponse as ServerActionsPowerOffServerResponseSchema

from hetzner_python_sdk.type.server_actions_power_off_server_response import ServerActionsPowerOffServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_power_off_server_response import ServerActionsPowerOffServerResponse as ServerActionsPowerOffServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsPowerOffServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsPowerOffServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _power_off_server_mapped_args(
        self,
        id: int,
    ...
    async def _apower_off_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/poweroff',
            auth_settings=_auth,
            headers=_headers,
        )
...
class PowerOffServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apower_off_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._power_off_server_mapped_args(
            id=id,
        )
        return await self._apower_off_server_oapg(
    ...
    def power_off_server(
        ...
        return self._power_off_server_oapg(
            path_params=args.path,
        )

class PowerOffServer(BaseApi):
    ...
    async def apower_off_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsPowerOffServerResponsePydantic:
        raw_response = await self.raw.apower_off_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsPowerOffServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsPowerOffServerResponsePydantic, raw_response.body)
    ...
    def power_off_server(
        ...
        raw_response = self.raw.power_off_server(
            id=id,
        )
        if validate:
            return ServerActionsPowerOffServerResponsePydantic(**raw_response.body)
