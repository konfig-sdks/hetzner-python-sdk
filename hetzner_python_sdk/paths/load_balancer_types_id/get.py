...
from hetzner_python_sdk.model.load_balancer_types_get_by_id_response import LoadBalancerTypesGetByIdResponse as LoadBalancerTypesGetByIdResponseSchema

from hetzner_python_sdk.type.load_balancer_types_get_by_id_response import LoadBalancerTypesGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_types_get_by_id_response import LoadBalancerTypesGetByIdResponse as LoadBalancerTypesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerTypesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerTypesGetByIdResponse
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancer_types/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerTypesGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerTypesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerTypesGetByIdResponsePydantic, raw_response.body)
