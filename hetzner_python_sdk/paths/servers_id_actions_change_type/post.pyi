...
from hetzner_python_sdk.model.server_actions_change_server_type_response import ServerActionsChangeServerTypeResponse as ServerActionsChangeServerTypeResponseSchema
from hetzner_python_sdk.model.server_actions_change_server_type_request import ServerActionsChangeServerTypeRequest as ServerActionsChangeServerTypeRequestSchema

from hetzner_python_sdk.type.server_actions_change_server_type_request import ServerActionsChangeServerTypeRequest
from hetzner_python_sdk.type.server_actions_change_server_type_response import ServerActionsChangeServerTypeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_change_server_type_request import ServerActionsChangeServerTypeRequest as ServerActionsChangeServerTypeRequestPydantic
from hetzner_python_sdk.pydantic.server_actions_change_server_type_response import ServerActionsChangeServerTypeResponse as ServerActionsChangeServerTypeResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsChangeServerTypeRequestSchema


request_body_server_actions_change_server_type_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsChangeServerTypeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsChangeServerTypeResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_server_type_mapped_args(
        self,
        server_type: str,
        upgrade_disk: bool,
        id: int,
        ...
        if upgrade_disk is not None:
            _body["upgrade_disk"] = upgrade_disk
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _achange_server_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/change_type',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_change_server_type_request.serialize(body, content_type)
...
class ChangeServerTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_server_type(
        self,
        server_type: str,
        upgrade_disk: bool,
        id: int,
        **kwargs,
        ...
        args = self._change_server_type_mapped_args(
            server_type=server_type,
            upgrade_disk=upgrade_disk,
            id=id,
        )
        return await self._achange_server_type_oapg(
            body=args.body,
    ...
    def change_server_type(
        ...
        return self._change_server_type_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeServerType(BaseApi):
    ...
    async def achange_server_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsChangeServerTypeResponsePydantic:
        raw_response = await self.raw.achange_server_type(
            server_type=server_type,
            upgrade_disk=upgrade_disk,
            id=id,
            **kwargs,
        ...
        if validate:
            return ServerActionsChangeServerTypeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsChangeServerTypeResponsePydantic, raw_response.body)
    ...
    def change_server_type(
        ...
        raw_response = self.raw.change_server_type(
            server_type=server_type,
            upgrade_disk=upgrade_disk,
            id=id,
        )
