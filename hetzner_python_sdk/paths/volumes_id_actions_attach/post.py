...
from hetzner_python_sdk.model.volume_actions_attach_volume_to_server_response import VolumeActionsAttachVolumeToServerResponse as VolumeActionsAttachVolumeToServerResponseSchema
from hetzner_python_sdk.model.volume_actions_attach_volume_to_server_request import VolumeActionsAttachVolumeToServerRequest as VolumeActionsAttachVolumeToServerRequestSchema

from hetzner_python_sdk.type.volume_actions_attach_volume_to_server_response import VolumeActionsAttachVolumeToServerResponse
from hetzner_python_sdk.type.volume_actions_attach_volume_to_server_request import VolumeActionsAttachVolumeToServerRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_attach_volume_to_server_response import VolumeActionsAttachVolumeToServerResponse as VolumeActionsAttachVolumeToServerResponsePydantic
from hetzner_python_sdk.pydantic.volume_actions_attach_volume_to_server_request import VolumeActionsAttachVolumeToServerRequest as VolumeActionsAttachVolumeToServerRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VolumeActionsAttachVolumeToServerRequestSchema


request_body_volume_actions_attach_volume_to_server_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VolumeActionsAttachVolumeToServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: VolumeActionsAttachVolumeToServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _attach_volume_to_server_mapped_args(
        self,
        server: int,
        id: int,
    ...
    async def _aattach_volume_to_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/{id}/actions/attach',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_volume_actions_attach_volume_to_server_request.serialize(body, content_type)
    ...
    def _attach_volume_to_server_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AttachVolumeToServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattach_volume_to_server(
        self,
        server: int,
        id: int,
        automount: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._attach_volume_to_server_mapped_args(
            server=server,
            id=id,
            automount=automount,
        )
        return await self._aattach_volume_to_server_oapg(
            body=args.body,
    ...
    def attach_volume_to_server(
        ...
        return self._attach_volume_to_server_oapg(
            body=args.body,
            path_params=args.path,
        )

class AttachVolumeToServer(BaseApi):
    ...
    async def aattach_volume_to_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsAttachVolumeToServerResponsePydantic:
        raw_response = await self.raw.aattach_volume_to_server(
            server=server,
            id=id,
            automount=automount,
            **kwargs,
        ...
        if validate:
            return VolumeActionsAttachVolumeToServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsAttachVolumeToServerResponsePydantic, raw_response.body)
    ...
    def attach_volume_to_server(
        ...
        raw_response = self.raw.attach_volume_to_server(
            server=server,
            id=id,
            automount=automount,
        )
