...
from hetzner_python_sdk.model.floating_ip_actions_get_action_by_id_response import FloatingIpActionsGetActionByIdResponse as FloatingIpActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.floating_ip_actions_get_action_by_id_response import FloatingIpActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_get_action_by_id_response import FloatingIpActionsGetActionByIdResponse as FloatingIpActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIpActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIpActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return FloatingIpActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsGetActionByIdResponsePydantic, raw_response.body)
