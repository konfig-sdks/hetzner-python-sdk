...
from hetzner_python_sdk.model.server_actions_enable_backup_response import ServerActionsEnableBackupResponse as ServerActionsEnableBackupResponseSchema

from hetzner_python_sdk.type.server_actions_enable_backup_response import ServerActionsEnableBackupResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_enable_backup_response import ServerActionsEnableBackupResponse as ServerActionsEnableBackupResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsEnableBackupResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsEnableBackupResponse
...
class BaseApi(api_client.Api):
    ...
    def _enable_backup_mapped_args(
        self,
        id: int,
    ...
    async def _aenable_backup_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/enable_backup',
            auth_settings=_auth,
            headers=_headers,
        )
...
class EnableBackupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aenable_backup(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._enable_backup_mapped_args(
            id=id,
        )
        return await self._aenable_backup_oapg(
    ...
    def enable_backup(
        ...
        return self._enable_backup_oapg(
            path_params=args.path,
        )

class EnableBackup(BaseApi):
    ...
    async def aenable_backup(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsEnableBackupResponsePydantic:
        raw_response = await self.raw.aenable_backup(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsEnableBackupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsEnableBackupResponsePydantic, raw_response.body)
    ...
    def enable_backup(
        ...
        raw_response = self.raw.enable_backup(
            id=id,
        )
        if validate:
            return ServerActionsEnableBackupResponsePydantic(**raw_response.body)
