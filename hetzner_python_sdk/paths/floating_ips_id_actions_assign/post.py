...
from hetzner_python_sdk.model.floating_ip_actions_assign_to_server_response import FloatingIpActionsAssignToServerResponse as FloatingIpActionsAssignToServerResponseSchema
from hetzner_python_sdk.model.floating_ip_actions_assign_to_server_request import FloatingIpActionsAssignToServerRequest as FloatingIpActionsAssignToServerRequestSchema

from hetzner_python_sdk.type.floating_ip_actions_assign_to_server_response import FloatingIpActionsAssignToServerResponse
from hetzner_python_sdk.type.floating_ip_actions_assign_to_server_request import FloatingIpActionsAssignToServerRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_assign_to_server_response import FloatingIpActionsAssignToServerResponse as FloatingIpActionsAssignToServerResponsePydantic
from hetzner_python_sdk.pydantic.floating_ip_actions_assign_to_server_request import FloatingIpActionsAssignToServerRequest as FloatingIpActionsAssignToServerRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FloatingIpActionsAssignToServerRequestSchema


request_body_floating_ip_actions_assign_to_server_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FloatingIpActionsAssignToServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIpActionsAssignToServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _assign_to_server_mapped_args(
        self,
        server: int,
        id: int,
    ...
    async def _aassign_to_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}/actions/assign',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_floating_ip_actions_assign_to_server_request.serialize(body, content_type)
...
class AssignToServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_to_server(
        self,
        server: int,
        id: int,
        **kwargs,
        ...
        args = self._assign_to_server_mapped_args(
            server=server,
            id=id,
        )
        return await self._aassign_to_server_oapg(
            body=args.body,
    ...
    def assign_to_server(
        ...
        return self._assign_to_server_oapg(
            body=args.body,
            path_params=args.path,
        )

class AssignToServer(BaseApi):
    ...
    async def aassign_to_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsAssignToServerResponsePydantic:
        raw_response = await self.raw.aassign_to_server(
            server=server,
            id=id,
            **kwargs,
        )
        if validate:
            return FloatingIpActionsAssignToServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsAssignToServerResponsePydantic, raw_response.body)
    ...
    def assign_to_server(
        ...
        raw_response = self.raw.assign_to_server(
            server=server,
            id=id,
        )
        if validate:
