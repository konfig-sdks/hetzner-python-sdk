...
from hetzner_python_sdk.model.load_balancer_types_get_all_types_response import LoadBalancerTypesGetAllTypesResponse as LoadBalancerTypesGetAllTypesResponseSchema

from hetzner_python_sdk.type.load_balancer_types_get_all_types_response import LoadBalancerTypesGetAllTypesResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_types_get_all_types_response import LoadBalancerTypesGetAllTypesResponse as LoadBalancerTypesGetAllTypesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerTypesGetAllTypesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerTypesGetAllTypesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_types_mapped_args(
        self,
    ...
    async def _aget_all_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancer_types',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_types(
        self,
        name: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        per_page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_all_types_mapped_args(
            name=name,
            page=page,
            per_page=per_page,
        )
        return await self._aget_all_types_oapg(
    ...
    def get_all_types(
        ...
        return self._get_all_types_oapg(
            query_params=args.query,
        )

class GetAllTypes(BaseApi):
    ...
    async def aget_all_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerTypesGetAllTypesResponsePydantic:
        raw_response = await self.raw.aget_all_types(
            name=name,
            page=page,
            per_page=per_page,
            **kwargs,
        ...
        if validate:
            return LoadBalancerTypesGetAllTypesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerTypesGetAllTypesResponsePydantic, raw_response.body)
    ...
    def get_all_types(
        ...
        raw_response = self.raw.get_all_types(
            name=name,
            page=page,
            per_page=per_page,
        )
