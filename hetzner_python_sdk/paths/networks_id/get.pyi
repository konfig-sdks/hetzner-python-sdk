...
from hetzner_python_sdk.model.networks_get_by_id_response import NetworksGetByIdResponse as NetworksGetByIdResponseSchema

from hetzner_python_sdk.type.networks_get_by_id_response import NetworksGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.networks_get_by_id_response import NetworksGetByIdResponse as NetworksGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NetworksGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworksGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworksGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return NetworksGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworksGetByIdResponsePydantic, raw_response.body)
