...
class BaseApi(api_client.Api):
    ...
    def _delete_network_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_network_oapg(
        self,
...
class DeleteNetworkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_network(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_network_mapped_args(
            id=id,
        )
        return await self._adelete_network_oapg(
    ...
    def delete_network(
        ...
        return self._delete_network_oapg(
            path_params=args.path,
        )

class DeleteNetwork(BaseApi):
    ...
    async def adelete_network(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_network(
            id=id,
            **kwargs,
        )
    ...
    def delete_network(
        ...
        raw_response = self.raw.delete_network(
            id=id,
        )
