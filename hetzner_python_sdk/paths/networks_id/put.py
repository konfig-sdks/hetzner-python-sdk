...
from hetzner_python_sdk.model.networks_update_properties_request import NetworksUpdatePropertiesRequest as NetworksUpdatePropertiesRequestSchema
from hetzner_python_sdk.model.networks_update_properties_response import NetworksUpdatePropertiesResponse as NetworksUpdatePropertiesResponseSchema
from hetzner_python_sdk.model.networks_update_properties_request_labels import NetworksUpdatePropertiesRequestLabels as NetworksUpdatePropertiesRequestLabelsSchema

from hetzner_python_sdk.type.networks_update_properties_request_labels import NetworksUpdatePropertiesRequestLabels
from hetzner_python_sdk.type.networks_update_properties_response import NetworksUpdatePropertiesResponse
from hetzner_python_sdk.type.networks_update_properties_request import NetworksUpdatePropertiesRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.networks_update_properties_request import NetworksUpdatePropertiesRequest as NetworksUpdatePropertiesRequestPydantic
from hetzner_python_sdk.pydantic.networks_update_properties_request_labels import NetworksUpdatePropertiesRequestLabels as NetworksUpdatePropertiesRequestLabelsPydantic
from hetzner_python_sdk.pydantic.networks_update_properties_response import NetworksUpdatePropertiesResponse as NetworksUpdatePropertiesResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworksUpdatePropertiesRequestSchema


request_body_networks_update_properties_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = NetworksUpdatePropertiesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworksUpdatePropertiesResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_properties_mapped_args(
        ...
        labels: typing.Optional[NetworksUpdatePropertiesRequestLabels] = None,
    ...
    async def _aupdate_properties_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_networks_update_properties_request.serialize(body, content_type)
...
class UpdateProperties(BaseApi):
    ...
    async def aupdate_properties(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworksUpdatePropertiesResponsePydantic:
        ...
        if validate:
            return NetworksUpdatePropertiesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworksUpdatePropertiesResponsePydantic, raw_response.body)
