...
from hetzner_python_sdk.model.primary_ip_actions_get_all_actions_response import PrimaryIpActionsGetAllActionsResponse as PrimaryIpActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.primary_ip_actions_get_all_actions_response import PrimaryIpActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_get_all_actions_response import PrimaryIpActionsGetAllActionsResponse as PrimaryIpActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PrimaryIpActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrimaryIpActionsGetAllActionsResponse
    ...
    async def _aget_all_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return PrimaryIpActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsGetAllActionsResponsePydantic, raw_response.body)
