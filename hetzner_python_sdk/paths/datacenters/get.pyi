...
from hetzner_python_sdk.model.datacenters_get_all_response import DatacentersGetAllResponse as DatacentersGetAllResponseSchema

from hetzner_python_sdk.type.datacenters_get_all_response import DatacentersGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.datacenters_get_all_response import DatacentersGetAllResponse as DatacentersGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatacentersGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DatacentersGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatacentersGetAllResponsePydantic:
        ...
        if validate:
            return DatacentersGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatacentersGetAllResponsePydantic, raw_response.body)
