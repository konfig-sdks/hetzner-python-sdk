...
from hetzner_python_sdk.model.placement_groups_get_all_response import PlacementGroupsGetAllResponse as PlacementGroupsGetAllResponseSchema

from hetzner_python_sdk.type.placement_groups_get_all_response import PlacementGroupsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.placement_groups_get_all_response import PlacementGroupsGetAllResponse as PlacementGroupsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PlacementGroupsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PlacementGroupsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlacementGroupsGetAllResponsePydantic:
        ...
        if validate:
            return PlacementGroupsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlacementGroupsGetAllResponsePydantic, raw_response.body)
