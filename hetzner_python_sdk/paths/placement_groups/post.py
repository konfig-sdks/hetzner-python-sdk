...
from hetzner_python_sdk.model.placement_groups_create_new_group_request import PlacementGroupsCreateNewGroupRequest as PlacementGroupsCreateNewGroupRequestSchema
from hetzner_python_sdk.model.placement_groups_create_new_group_response import PlacementGroupsCreateNewGroupResponse as PlacementGroupsCreateNewGroupResponseSchema

from hetzner_python_sdk.type.placement_groups_create_new_group_request import PlacementGroupsCreateNewGroupRequest
from hetzner_python_sdk.type.placement_groups_create_new_group_response import PlacementGroupsCreateNewGroupResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.placement_groups_create_new_group_response import PlacementGroupsCreateNewGroupResponse as PlacementGroupsCreateNewGroupResponsePydantic
from hetzner_python_sdk.pydantic.placement_groups_create_new_group_request import PlacementGroupsCreateNewGroupRequest as PlacementGroupsCreateNewGroupRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = PlacementGroupsCreateNewGroupRequestSchema


request_body_placement_groups_create_new_group_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PlacementGroupsCreateNewGroupResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PlacementGroupsCreateNewGroupResponse
    ...
    async def _acreate_new_group_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/placement_groups',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_placement_groups_create_new_group_request.serialize(body, content_type)
...
class CreateNewGroup(BaseApi):
    ...
    async def acreate_new_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlacementGroupsCreateNewGroupResponsePydantic:
        ...
        if validate:
            return PlacementGroupsCreateNewGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlacementGroupsCreateNewGroupResponsePydantic, raw_response.body)
