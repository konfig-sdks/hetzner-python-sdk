...
from hetzner_python_sdk.model.server_actions_soft_reboot_server_response import ServerActionsSoftRebootServerResponse as ServerActionsSoftRebootServerResponseSchema

from hetzner_python_sdk.type.server_actions_soft_reboot_server_response import ServerActionsSoftRebootServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_soft_reboot_server_response import ServerActionsSoftRebootServerResponse as ServerActionsSoftRebootServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsSoftRebootServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsSoftRebootServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _soft_reboot_server_mapped_args(
        self,
        id: int,
    ...
    async def _asoft_reboot_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/reboot',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SoftRebootServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asoft_reboot_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._soft_reboot_server_mapped_args(
            id=id,
        )
        return await self._asoft_reboot_server_oapg(
    ...
    def soft_reboot_server(
        ...
        return self._soft_reboot_server_oapg(
            path_params=args.path,
        )

class SoftRebootServer(BaseApi):
    ...
    async def asoft_reboot_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsSoftRebootServerResponsePydantic:
        raw_response = await self.raw.asoft_reboot_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsSoftRebootServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsSoftRebootServerResponsePydantic, raw_response.body)
    ...
    def soft_reboot_server(
        ...
        raw_response = self.raw.soft_reboot_server(
            id=id,
        )
        if validate:
            return ServerActionsSoftRebootServerResponsePydantic(**raw_response.body)
