...
from hetzner_python_sdk.model.server_actions_disable_rescue_mode_response import ServerActionsDisableRescueModeResponse as ServerActionsDisableRescueModeResponseSchema

from hetzner_python_sdk.type.server_actions_disable_rescue_mode_response import ServerActionsDisableRescueModeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_disable_rescue_mode_response import ServerActionsDisableRescueModeResponse as ServerActionsDisableRescueModeResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsDisableRescueModeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsDisableRescueModeResponse
...
class BaseApi(api_client.Api):
    ...
    def _disable_rescue_mode_mapped_args(
        self,
        id: int,
    ...
    async def _adisable_rescue_mode_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/disable_rescue',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DisableRescueModeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisable_rescue_mode(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._disable_rescue_mode_mapped_args(
            id=id,
        )
        return await self._adisable_rescue_mode_oapg(
    ...
    def disable_rescue_mode(
        ...
        return self._disable_rescue_mode_oapg(
            path_params=args.path,
        )

class DisableRescueMode(BaseApi):
    ...
    async def adisable_rescue_mode(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsDisableRescueModeResponsePydantic:
        raw_response = await self.raw.adisable_rescue_mode(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsDisableRescueModeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsDisableRescueModeResponsePydantic, raw_response.body)
    ...
    def disable_rescue_mode(
        ...
        raw_response = self.raw.disable_rescue_mode(
            id=id,
        )
        if validate:
            return ServerActionsDisableRescueModeResponsePydantic(**raw_response.body)
