...
from hetzner_python_sdk.model.server_actions_remove_from_placement_group_response import ServerActionsRemoveFromPlacementGroupResponse as ServerActionsRemoveFromPlacementGroupResponseSchema

from hetzner_python_sdk.type.server_actions_remove_from_placement_group_response import ServerActionsRemoveFromPlacementGroupResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_remove_from_placement_group_response import ServerActionsRemoveFromPlacementGroupResponse as ServerActionsRemoveFromPlacementGroupResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsRemoveFromPlacementGroupResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsRemoveFromPlacementGroupResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_from_placement_group_mapped_args(
        self,
        id: int,
    ...
    async def _aremove_from_placement_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/remove_from_placement_group',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_from_placement_group_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveFromPlacementGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_placement_group(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_from_placement_group_mapped_args(
            id=id,
        )
        return await self._aremove_from_placement_group_oapg(
    ...
    def remove_from_placement_group(
        ...
        return self._remove_from_placement_group_oapg(
            path_params=args.path,
        )

class RemoveFromPlacementGroup(BaseApi):
    ...
    async def aremove_from_placement_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsRemoveFromPlacementGroupResponsePydantic:
        raw_response = await self.raw.aremove_from_placement_group(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsRemoveFromPlacementGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsRemoveFromPlacementGroupResponsePydantic, raw_response.body)
    ...
    def remove_from_placement_group(
        ...
        raw_response = self.raw.remove_from_placement_group(
            id=id,
        )
        if validate:
            return ServerActionsRemoveFromPlacementGroupResponsePydantic(**raw_response.body)
