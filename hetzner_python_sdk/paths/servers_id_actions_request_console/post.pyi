...
from hetzner_python_sdk.model.server_actions_request_console_response import ServerActionsRequestConsoleResponse as ServerActionsRequestConsoleResponseSchema

from hetzner_python_sdk.type.server_actions_request_console_response import ServerActionsRequestConsoleResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_request_console_response import ServerActionsRequestConsoleResponse as ServerActionsRequestConsoleResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsRequestConsoleResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsRequestConsoleResponse
...
class BaseApi(api_client.Api):
    ...
    def _request_console_mapped_args(
        self,
        id: int,
    ...
    async def _arequest_console_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/request_console',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RequestConsoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arequest_console(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._request_console_mapped_args(
            id=id,
        )
        return await self._arequest_console_oapg(
    ...
    def request_console(
        ...
        return self._request_console_oapg(
            path_params=args.path,
        )

class RequestConsole(BaseApi):
    ...
    async def arequest_console(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsRequestConsoleResponsePydantic:
        raw_response = await self.raw.arequest_console(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsRequestConsoleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsRequestConsoleResponsePydantic, raw_response.body)
    ...
    def request_console(
        ...
        raw_response = self.raw.request_console(
            id=id,
        )
        if validate:
            return ServerActionsRequestConsoleResponsePydantic(**raw_response.body)
