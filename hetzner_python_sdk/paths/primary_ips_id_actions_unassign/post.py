...
from hetzner_python_sdk.model.primary_ip_actions_unassign_primary_ip_response import PrimaryIpActionsUnassignPrimaryIpResponse as PrimaryIpActionsUnassignPrimaryIpResponseSchema

from hetzner_python_sdk.type.primary_ip_actions_unassign_primary_ip_response import PrimaryIpActionsUnassignPrimaryIpResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_unassign_primary_ip_response import PrimaryIpActionsUnassignPrimaryIpResponse as PrimaryIpActionsUnassignPrimaryIpResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = PrimaryIpActionsUnassignPrimaryIpResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PrimaryIpActionsUnassignPrimaryIpResponse
...
class BaseApi(api_client.Api):
    ...
    def _unassign_primary_ip_mapped_args(
        self,
        id: int,
    ...
    async def _aunassign_primary_ip_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/{id}/actions/unassign',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UnassignPrimaryIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunassign_primary_ip(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unassign_primary_ip_mapped_args(
            id=id,
        )
        return await self._aunassign_primary_ip_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def unassign_primary_ip(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._unassign_primary_ip_oapg(
            path_params=args.path,
        )

class UnassignPrimaryIp(BaseApi):
    ...
    async def aunassign_primary_ip(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsUnassignPrimaryIpResponsePydantic:
        raw_response = await self.raw.aunassign_primary_ip(
            id=id,
            **kwargs,
        )
        if validate:
            return PrimaryIpActionsUnassignPrimaryIpResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsUnassignPrimaryIpResponsePydantic, raw_response.body)
    ...
    def unassign_primary_ip(
        ...
        raw_response = self.raw.unassign_primary_ip(
            id=id,
        )
        if validate:
            return PrimaryIpActionsUnassignPrimaryIpResponsePydantic(**raw_response.body)
