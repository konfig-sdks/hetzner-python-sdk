...
from hetzner_python_sdk.model.primary_ip_actions_change_dns_ptr_response import PrimaryIpActionsChangeDnsPtrResponse as PrimaryIpActionsChangeDnsPtrResponseSchema
from hetzner_python_sdk.model.primary_ip_actions_change_dns_ptr_request import PrimaryIpActionsChangeDnsPtrRequest as PrimaryIpActionsChangeDnsPtrRequestSchema

from hetzner_python_sdk.type.primary_ip_actions_change_dns_ptr_response import PrimaryIpActionsChangeDnsPtrResponse
from hetzner_python_sdk.type.primary_ip_actions_change_dns_ptr_request import PrimaryIpActionsChangeDnsPtrRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_change_dns_ptr_request import PrimaryIpActionsChangeDnsPtrRequest as PrimaryIpActionsChangeDnsPtrRequestPydantic
from hetzner_python_sdk.pydantic.primary_ip_actions_change_dns_ptr_response import PrimaryIpActionsChangeDnsPtrResponse as PrimaryIpActionsChangeDnsPtrResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PrimaryIpActionsChangeDnsPtrRequestSchema


request_body_primary_ip_actions_change_dns_ptr_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PrimaryIpActionsChangeDnsPtrResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PrimaryIpActionsChangeDnsPtrResponse
    ...
    async def _achange_dns_ptr_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/{id}/actions/change_dns_ptr',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_primary_ip_actions_change_dns_ptr_request.serialize(body, content_type)
...
class ChangeDnsPtr(BaseApi):
    ...
    async def achange_dns_ptr(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsChangeDnsPtrResponsePydantic:
        ...
        if validate:
            return PrimaryIpActionsChangeDnsPtrResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsChangeDnsPtrResponsePydantic, raw_response.body)
