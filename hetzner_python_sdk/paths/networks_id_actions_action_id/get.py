...
from hetzner_python_sdk.model.network_actions_get_action200_response import NetworkActionsGetAction200Response as NetworkActionsGetAction200ResponseSchema

from hetzner_python_sdk.type.network_actions_get_action200_response import NetworkActionsGetAction200Response

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_get_action200_response import NetworkActionsGetAction200Response as NetworkActionsGetAction200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NetworkActionsGetAction200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworkActionsGetAction200Response
    ...
    async def _aget_action_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/{action_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAction0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_action_0(
        self,
        id: int,
        action_id: int,
        **kwargs,
        ...
        args = self._get_action_0_mapped_args(
            id=id,
            action_id=action_id,
        )
        return await self._aget_action_0_oapg(
    ...
    def get_action_0(
        ...
        return self._get_action_0_oapg(
            path_params=args.path,
        )

class GetAction0(BaseApi):
    ...
    async def aget_action_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsGetAction200ResponsePydantic:
        raw_response = await self.raw.aget_action_0(
            id=id,
            action_id=action_id,
            **kwargs,
        )
        if validate:
            return NetworkActionsGetAction200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsGetAction200ResponsePydantic, raw_response.body)
    ...
    def get_action_0(
        ...
        raw_response = self.raw.get_action_0(
            id=id,
            action_id=action_id,
        )
        if validate:
