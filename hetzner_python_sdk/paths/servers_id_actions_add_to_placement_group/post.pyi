...
from hetzner_python_sdk.model.server_actions_add_to_placement_group_response import ServerActionsAddToPlacementGroupResponse as ServerActionsAddToPlacementGroupResponseSchema
from hetzner_python_sdk.model.server_actions_add_to_placement_group_request import ServerActionsAddToPlacementGroupRequest as ServerActionsAddToPlacementGroupRequestSchema

from hetzner_python_sdk.type.server_actions_add_to_placement_group_response import ServerActionsAddToPlacementGroupResponse
from hetzner_python_sdk.type.server_actions_add_to_placement_group_request import ServerActionsAddToPlacementGroupRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_add_to_placement_group_response import ServerActionsAddToPlacementGroupResponse as ServerActionsAddToPlacementGroupResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_add_to_placement_group_request import ServerActionsAddToPlacementGroupRequest as ServerActionsAddToPlacementGroupRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsAddToPlacementGroupRequestSchema


request_body_server_actions_add_to_placement_group_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsAddToPlacementGroupResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsAddToPlacementGroupResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_to_placement_group_mapped_args(
        self,
        placement_group: int,
        id: int,
    ...
    async def _aadd_to_placement_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/add_to_placement_group',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_add_to_placement_group_request.serialize(body, content_type)
    ...
    def _add_to_placement_group_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddToPlacementGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_placement_group(
        self,
        placement_group: int,
        id: int,
        **kwargs,
        ...
        args = self._add_to_placement_group_mapped_args(
            placement_group=placement_group,
            id=id,
        )
        return await self._aadd_to_placement_group_oapg(
            body=args.body,
    ...
    def add_to_placement_group(
        ...
        return self._add_to_placement_group_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddToPlacementGroup(BaseApi):
    ...
    async def aadd_to_placement_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsAddToPlacementGroupResponsePydantic:
        raw_response = await self.raw.aadd_to_placement_group(
            placement_group=placement_group,
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsAddToPlacementGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsAddToPlacementGroupResponsePydantic, raw_response.body)
    ...
    def add_to_placement_group(
        ...
        raw_response = self.raw.add_to_placement_group(
            placement_group=placement_group,
            id=id,
        )
        if validate:
