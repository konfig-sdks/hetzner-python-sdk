...
from hetzner_python_sdk.model.load_balancer_actions_get_specific_action200_response import LoadBalancerActionsGetSpecificAction200Response as LoadBalancerActionsGetSpecificAction200ResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_get_specific_action200_response import LoadBalancerActionsGetSpecificAction200Response

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_get_specific_action200_response import LoadBalancerActionsGetSpecificAction200Response as LoadBalancerActionsGetSpecificAction200ResponsePydantic

# Path params
IdSchema = schemas.Int64Schema
ActionIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'id': typing.Union[IdSchema, decimal.Decimal, int, ],
        'action_id': typing.Union[ActionIdSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerActionsGetSpecificAction200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerActionsGetSpecificAction200Response
...
class BaseApi(api_client.Api):
    ...
    def _get_specific_action_0_mapped_args(
        self,
        id: int,
        action_id: int,
    ...
    async def _aget_specific_action_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/{action_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_specific_action_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificAction0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_action_0(
        self,
        id: int,
        action_id: int,
        **kwargs,
        ...
        args = self._get_specific_action_0_mapped_args(
            id=id,
            action_id=action_id,
        )
        return await self._aget_specific_action_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_action_0(
        self,
        id: int,
        action_id: int,
    ) -> typing.Union[
        ...
        return self._get_specific_action_0_oapg(
            path_params=args.path,
        )

class GetSpecificAction0(BaseApi):
    ...
    async def aget_specific_action_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsGetSpecificAction200ResponsePydantic:
        raw_response = await self.raw.aget_specific_action_0(
            id=id,
            action_id=action_id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsGetSpecificAction200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsGetSpecificAction200ResponsePydantic, raw_response.body)
    ...
    def get_specific_action_0(
        ...
        raw_response = self.raw.get_specific_action_0(
            id=id,
            action_id=action_id,
        )
        if validate:
