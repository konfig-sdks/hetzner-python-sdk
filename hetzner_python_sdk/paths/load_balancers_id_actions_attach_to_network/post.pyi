...
from hetzner_python_sdk.model.load_balancer_actions_attach_to_network_request import LoadBalancerActionsAttachToNetworkRequest as LoadBalancerActionsAttachToNetworkRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_attach_to_network_response import LoadBalancerActionsAttachToNetworkResponse as LoadBalancerActionsAttachToNetworkResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_attach_to_network_response import LoadBalancerActionsAttachToNetworkResponse
from hetzner_python_sdk.type.load_balancer_actions_attach_to_network_request import LoadBalancerActionsAttachToNetworkRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_attach_to_network_response import LoadBalancerActionsAttachToNetworkResponse as LoadBalancerActionsAttachToNetworkResponsePydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_attach_to_network_request import LoadBalancerActionsAttachToNetworkRequest as LoadBalancerActionsAttachToNetworkRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsAttachToNetworkRequestSchema


request_body_load_balancer_actions_attach_to_network_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsAttachToNetworkResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsAttachToNetworkResponse
    ...
    async def _aattach_to_network_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/attach_to_network',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_attach_to_network_request.serialize(body, content_type)
...
class AttachToNetwork(BaseApi):
    ...
    async def aattach_to_network(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsAttachToNetworkResponsePydantic:
        ...
        if validate:
            return LoadBalancerActionsAttachToNetworkResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsAttachToNetworkResponsePydantic, raw_response.body)
