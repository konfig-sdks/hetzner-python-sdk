...
class BaseApi(api_client.Api):
    ...
    def _delete_firewall_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_firewall_by_id_oapg(
        self,
    ...
    def _delete_firewall_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteFirewallByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_firewall_by_id(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_firewall_by_id_mapped_args(
            id=id,
        )
        return await self._adelete_firewall_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_firewall_by_id(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_firewall_by_id_oapg(
            path_params=args.path,
        )

class DeleteFirewallById(BaseApi):
    ...
    async def adelete_firewall_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_firewall_by_id(
            id=id,
            **kwargs,
        )
    ...
    def delete_firewall_by_id(
        ...
        raw_response = self.raw.delete_firewall_by_id(
            id=id,
        )
