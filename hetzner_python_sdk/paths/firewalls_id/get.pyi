...
from hetzner_python_sdk.model.firewalls_get_firewall_by_id_response import FirewallsGetFirewallByIdResponse as FirewallsGetFirewallByIdResponseSchema

from hetzner_python_sdk.type.firewalls_get_firewall_by_id_response import FirewallsGetFirewallByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewalls_get_firewall_by_id_response import FirewallsGetFirewallByIdResponse as FirewallsGetFirewallByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallsGetFirewallByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FirewallsGetFirewallByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_firewall_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _aget_firewall_by_id_oapg(
        self,
...
class GetFirewallByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_firewall_by_id(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_firewall_by_id_mapped_args(
            id=id,
        )
        return await self._aget_firewall_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_firewall_by_id(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_firewall_by_id_oapg(
            path_params=args.path,
        )

class GetFirewallById(BaseApi):
    ...
    async def aget_firewall_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsGetFirewallByIdResponsePydantic:
        raw_response = await self.raw.aget_firewall_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return FirewallsGetFirewallByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsGetFirewallByIdResponsePydantic, raw_response.body)
    ...
    def get_firewall_by_id(
        ...
        raw_response = self.raw.get_firewall_by_id(
            id=id,
        )
        if validate:
            return FirewallsGetFirewallByIdResponsePydantic(**raw_response.body)
