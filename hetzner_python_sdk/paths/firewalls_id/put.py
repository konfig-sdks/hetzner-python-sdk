...
from hetzner_python_sdk.model.firewalls_update_firewall_by_id_request import FirewallsUpdateFirewallByIdRequest as FirewallsUpdateFirewallByIdRequestSchema
from hetzner_python_sdk.model.firewalls_update_firewall_by_id_response import FirewallsUpdateFirewallByIdResponse as FirewallsUpdateFirewallByIdResponseSchema

from hetzner_python_sdk.type.firewalls_update_firewall_by_id_response import FirewallsUpdateFirewallByIdResponse
from hetzner_python_sdk.type.firewalls_update_firewall_by_id_request import FirewallsUpdateFirewallByIdRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewalls_update_firewall_by_id_request import FirewallsUpdateFirewallByIdRequest as FirewallsUpdateFirewallByIdRequestPydantic
from hetzner_python_sdk.pydantic.firewalls_update_firewall_by_id_response import FirewallsUpdateFirewallByIdResponse as FirewallsUpdateFirewallByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsUpdateFirewallByIdRequestSchema


request_body_firewalls_update_firewall_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FirewallsUpdateFirewallByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FirewallsUpdateFirewallByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_firewall_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_firewall_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/firewalls/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_update_firewall_by_id_request.serialize(body, content_type)
    ...
    def _update_firewall_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFirewallByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_firewall_by_id(
        self,
        id: int,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_firewall_by_id_mapped_args(
            id=id,
            labels=labels,
            name=name,
        )
        return await self._aupdate_firewall_by_id_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_firewall_by_id(
        self,
        id: int,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        name: typing.Optional[str] = None,
        ...
        return self._update_firewall_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFirewallById(BaseApi):
    ...
    async def aupdate_firewall_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsUpdateFirewallByIdResponsePydantic:
        raw_response = await self.raw.aupdate_firewall_by_id(
            id=id,
            labels=labels,
            name=name,
            **kwargs,
        ...
        if validate:
            return FirewallsUpdateFirewallByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsUpdateFirewallByIdResponsePydantic, raw_response.body)
    ...
    def update_firewall_by_id(
        ...
        raw_response = self.raw.update_firewall_by_id(
            id=id,
            labels=labels,
            name=name,
        )
