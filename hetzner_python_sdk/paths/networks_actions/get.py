...
from hetzner_python_sdk.model.network_actions_get_all_actions_response import NetworkActionsGetAllActionsResponse as NetworkActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.network_actions_get_all_actions_response import NetworkActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_get_all_actions_response import NetworkActionsGetAllActionsResponse as NetworkActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NetworkActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworkActionsGetAllActionsResponse
    ...
    async def _aget_all_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return NetworkActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsGetAllActionsResponsePydantic, raw_response.body)
