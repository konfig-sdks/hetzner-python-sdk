...
from hetzner_python_sdk.model.floating_ip_actions_get_action_by_id200_response import FloatingIpActionsGetActionById200Response as FloatingIpActionsGetActionById200ResponseSchema

from hetzner_python_sdk.type.floating_ip_actions_get_action_by_id200_response import FloatingIpActionsGetActionById200Response

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_get_action_by_id200_response import FloatingIpActionsGetActionById200Response as FloatingIpActionsGetActionById200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIpActionsGetActionById200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIpActionsGetActionById200Response
...
class BaseApi(api_client.Api):
    ...
    def _get_action_by_id_0_mapped_args(
        self,
        id: int,
        action_id: int,
    ...
    async def _aget_action_by_id_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}/actions/{action_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_action_by_id_0(
        self,
        id: int,
        action_id: int,
        **kwargs,
        ...
        args = self._get_action_by_id_0_mapped_args(
            id=id,
            action_id=action_id,
        )
        return await self._aget_action_by_id_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_action_by_id_0(
        self,
        id: int,
        action_id: int,
    ) -> typing.Union[
        ...
        return self._get_action_by_id_0_oapg(
            path_params=args.path,
        )

class GetActionById0(BaseApi):
    ...
    async def aget_action_by_id_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsGetActionById200ResponsePydantic:
        raw_response = await self.raw.aget_action_by_id_0(
            id=id,
            action_id=action_id,
            **kwargs,
        )
        if validate:
            return FloatingIpActionsGetActionById200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsGetActionById200ResponsePydantic, raw_response.body)
    ...
    def get_action_by_id_0(
        ...
        raw_response = self.raw.get_action_by_id_0(
            id=id,
            action_id=action_id,
        )
        if validate:
