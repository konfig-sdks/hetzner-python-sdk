...
from hetzner_python_sdk.model.server_actions_create_image_request import ServerActionsCreateImageRequest as ServerActionsCreateImageRequestSchema
from hetzner_python_sdk.model.server_actions_create_image_request_labels import ServerActionsCreateImageRequestLabels as ServerActionsCreateImageRequestLabelsSchema
from hetzner_python_sdk.model.server_actions_create_image_response import ServerActionsCreateImageResponse as ServerActionsCreateImageResponseSchema

from hetzner_python_sdk.type.server_actions_create_image_request import ServerActionsCreateImageRequest
from hetzner_python_sdk.type.server_actions_create_image_response import ServerActionsCreateImageResponse
from hetzner_python_sdk.type.server_actions_create_image_request_labels import ServerActionsCreateImageRequestLabels

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_create_image_request import ServerActionsCreateImageRequest as ServerActionsCreateImageRequestPydantic
from hetzner_python_sdk.pydantic.server_actions_create_image_request_labels import ServerActionsCreateImageRequestLabels as ServerActionsCreateImageRequestLabelsPydantic
from hetzner_python_sdk.pydantic.server_actions_create_image_response import ServerActionsCreateImageResponse as ServerActionsCreateImageResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsCreateImageRequestSchema


request_body_server_actions_create_image_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsCreateImageResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsCreateImageResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_image_mapped_args(
        self,
        id: int,
        description: typing.Optional[str] = None,
        labels: typing.Optional[ServerActionsCreateImageRequestLabels] = None,
    ...
    async def _acreate_image_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/create_image',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_create_image_request.serialize(body, content_type)
...
class CreateImageRaw(BaseApi):
    ...
    async def acreate_image(
        ...
        **kwargs,
        ...
        args = self._create_image_mapped_args(
            id=id,
            description=description,
            labels=labels,
            type=type,
        )
        return await self._acreate_image_oapg(
            body=args.body,
...
class CreateImage(BaseApi):
    ...
    async def acreate_image(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsCreateImageResponsePydantic:
        raw_response = await self.raw.acreate_image(
            id=id,
            description=description,
            labels=labels,
            type=type,
        ...
        if validate:
            return ServerActionsCreateImageResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsCreateImageResponsePydantic, raw_response.body)
    ...
    def create_image(
        ...
        raw_response = self.raw.create_image(
            id=id,
            description=description,
            labels=labels,
            type=type,
