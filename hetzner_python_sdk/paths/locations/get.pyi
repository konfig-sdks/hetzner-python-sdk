...
from hetzner_python_sdk.model.locations_get_all_locations_response import LocationsGetAllLocationsResponse as LocationsGetAllLocationsResponseSchema

from hetzner_python_sdk.type.locations_get_all_locations_response import LocationsGetAllLocationsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.locations_get_all_locations_response import LocationsGetAllLocationsResponse as LocationsGetAllLocationsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LocationsGetAllLocationsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LocationsGetAllLocationsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_locations_mapped_args(
        self,
    ...
    async def _aget_all_locations_oapg(
        self,
...
class GetAllLocationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_locations(
        self,
        name: typing.Optional[str] = None,
        sort: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_locations_mapped_args(
            name=name,
            sort=sort,
            page=page,
            per_page=per_page,
        )
        return await self._aget_all_locations_oapg(
    ...
    def get_all_locations(
        ...
        return self._get_all_locations_oapg(
            query_params=args.query,
        )

class GetAllLocations(BaseApi):
    ...
    async def aget_all_locations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LocationsGetAllLocationsResponsePydantic:
        raw_response = await self.raw.aget_all_locations(
            name=name,
            sort=sort,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return LocationsGetAllLocationsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LocationsGetAllLocationsResponsePydantic, raw_response.body)
    ...
    def get_all_locations(
        ...
        raw_response = self.raw.get_all_locations(
            name=name,
            sort=sort,
            page=page,
            per_page=per_page,
