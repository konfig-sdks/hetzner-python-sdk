...
from hetzner_python_sdk.model.server_types_get_server_type_response import ServerTypesGetServerTypeResponse as ServerTypesGetServerTypeResponseSchema

from hetzner_python_sdk.type.server_types_get_server_type_response import ServerTypesGetServerTypeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_types_get_server_type_response import ServerTypesGetServerTypeResponse as ServerTypesGetServerTypeResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServerTypesGetServerTypeResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerTypesGetServerTypeResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_server_type_mapped_args(
        self,
        id: int,
    ...
    async def _aget_server_type_oapg(
        self,
...
class GetServerTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_server_type(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_server_type_mapped_args(
            id=id,
        )
        return await self._aget_server_type_oapg(
    ...
    def get_server_type(
        ...
        return self._get_server_type_oapg(
            path_params=args.path,
        )

class GetServerType(BaseApi):
    ...
    async def aget_server_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerTypesGetServerTypeResponsePydantic:
        raw_response = await self.raw.aget_server_type(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerTypesGetServerTypeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerTypesGetServerTypeResponsePydantic, raw_response.body)
    ...
    def get_server_type(
        ...
        raw_response = self.raw.get_server_type(
            id=id,
        )
        if validate:
            return ServerTypesGetServerTypeResponsePydantic(**raw_response.body)
