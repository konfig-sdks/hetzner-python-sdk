...
class BaseApi(api_client.Api):
    ...
    def _delete_certificate_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_certificate_oapg(
        self,
...
class DeleteCertificateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_certificate(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_certificate_mapped_args(
            id=id,
        )
        return await self._adelete_certificate_oapg(
...
class DeleteCertificate(BaseApi):
    ...
    async def adelete_certificate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_certificate(
            id=id,
            **kwargs,
        )
    ...
    def delete_certificate(
        ...
        raw_response = self.raw.delete_certificate(
            id=id,
        )
