...
from hetzner_python_sdk.model.certificates_update_by_id_response import CertificatesUpdateByIdResponse as CertificatesUpdateByIdResponseSchema
from hetzner_python_sdk.model.certificates_update_by_id_request import CertificatesUpdateByIdRequest as CertificatesUpdateByIdRequestSchema

from hetzner_python_sdk.type.certificates_update_by_id_request import CertificatesUpdateByIdRequest
from hetzner_python_sdk.type.certificates_update_by_id_response import CertificatesUpdateByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificates_update_by_id_response import CertificatesUpdateByIdResponse as CertificatesUpdateByIdResponsePydantic
from hetzner_python_sdk.pydantic.certificates_update_by_id_request import CertificatesUpdateByIdRequest as CertificatesUpdateByIdRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CertificatesUpdateByIdRequestSchema


request_body_certificates_update_by_id_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = CertificatesUpdateByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CertificatesUpdateByIdResponse
    ...
    async def _aupdate_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/certificates/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_certificates_update_by_id_request.serialize(body, content_type)
...
class UpdateById(BaseApi):
    ...
    async def aupdate_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesUpdateByIdResponsePydantic:
        ...
        if validate:
            return CertificatesUpdateByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificatesUpdateByIdResponsePydantic, raw_response.body)
