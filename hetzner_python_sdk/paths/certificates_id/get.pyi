...
from hetzner_python_sdk.model.certificates_get_by_id_response import CertificatesGetByIdResponse as CertificatesGetByIdResponseSchema

from hetzner_python_sdk.type.certificates_get_by_id_response import CertificatesGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificates_get_by_id_response import CertificatesGetByIdResponse as CertificatesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CertificatesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CertificatesGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return CertificatesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificatesGetByIdResponsePydantic, raw_response.body)
