...
from hetzner_python_sdk.model.load_balancer_actions_delete_service_request import LoadBalancerActionsDeleteServiceRequest as LoadBalancerActionsDeleteServiceRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_delete_service_response import LoadBalancerActionsDeleteServiceResponse as LoadBalancerActionsDeleteServiceResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_delete_service_response import LoadBalancerActionsDeleteServiceResponse
from hetzner_python_sdk.type.load_balancer_actions_delete_service_request import LoadBalancerActionsDeleteServiceRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_delete_service_request import LoadBalancerActionsDeleteServiceRequest as LoadBalancerActionsDeleteServiceRequestPydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_delete_service_response import LoadBalancerActionsDeleteServiceResponse as LoadBalancerActionsDeleteServiceResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsDeleteServiceRequestSchema


request_body_load_balancer_actions_delete_service_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsDeleteServiceResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsDeleteServiceResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_service_mapped_args(
        self,
        listen_port: int,
        id: int,
    ...
    async def _adelete_service_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/delete_service',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_delete_service_request.serialize(body, content_type)
...
class DeleteServiceRaw(BaseApi):
    ...
    async def adelete_service(
        ...
        **kwargs,
        ...
        args = self._delete_service_mapped_args(
            listen_port=listen_port,
            id=id,
        )
        return await self._adelete_service_oapg(
            body=args.body,
    ...
    def delete_service(
        ...
        return self._delete_service_oapg(
            body=args.body,
            path_params=args.path,
        )

class DeleteService(BaseApi):
    ...
    async def adelete_service(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsDeleteServiceResponsePydantic:
        raw_response = await self.raw.adelete_service(
            listen_port=listen_port,
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsDeleteServiceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsDeleteServiceResponsePydantic, raw_response.body)
    ...
    def delete_service(
        ...
        raw_response = self.raw.delete_service(
            listen_port=listen_port,
            id=id,
        )
        if validate:
