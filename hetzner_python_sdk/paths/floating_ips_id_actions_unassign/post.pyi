...
from hetzner_python_sdk.model.floating_ip_actions_unassign_ip_response import FloatingIpActionsUnassignIpResponse as FloatingIpActionsUnassignIpResponseSchema

from hetzner_python_sdk.type.floating_ip_actions_unassign_ip_response import FloatingIpActionsUnassignIpResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_unassign_ip_response import FloatingIpActionsUnassignIpResponse as FloatingIpActionsUnassignIpResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = FloatingIpActionsUnassignIpResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIpActionsUnassignIpResponse
    ...
    async def _aunassign_ip_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}/actions/unassign',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UnassignIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunassign_ip(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unassign_ip_mapped_args(
            id=id,
        )
        return await self._aunassign_ip_oapg(
    ...
    def unassign_ip(
        ...
        return self._unassign_ip_oapg(
            path_params=args.path,
        )

class UnassignIp(BaseApi):
    ...
    async def aunassign_ip(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsUnassignIpResponsePydantic:
        raw_response = await self.raw.aunassign_ip(
            id=id,
            **kwargs,
        )
        if validate:
            return FloatingIpActionsUnassignIpResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsUnassignIpResponsePydantic, raw_response.body)
    ...
    def unassign_ip(
        ...
        raw_response = self.raw.unassign_ip(
            id=id,
        )
        if validate:
            return FloatingIpActionsUnassignIpResponsePydantic(**raw_response.body)
