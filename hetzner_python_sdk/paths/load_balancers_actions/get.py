...
from hetzner_python_sdk.model.load_balancer_actions_get_all_actions_response import LoadBalancerActionsGetAllActionsResponse as LoadBalancerActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_get_all_actions_response import LoadBalancerActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_get_all_actions_response import LoadBalancerActionsGetAllActionsResponse as LoadBalancerActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerActionsGetAllActionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_actions_mapped_args(
        self,
    ...
    async def _aget_all_actions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_actions(
        self,
        id: typing.Optional[int] = None,
        sort: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_actions_mapped_args(
            id=id,
            sort=sort,
            status=status,
            page=page,
        ...
        return await self._aget_all_actions_oapg(
    ...
    def get_all_actions(
        ...
        return self._get_all_actions_oapg(
            query_params=args.query,
        )

class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsGetAllActionsResponsePydantic:
        raw_response = await self.raw.aget_all_actions(
            id=id,
            sort=sort,
            status=status,
            page=page,
        ...
        if validate:
            return LoadBalancerActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsGetAllActionsResponsePydantic, raw_response.body)
    ...
    def get_all_actions(
        ...
        raw_response = self.raw.get_all_actions(
            id=id,
            sort=sort,
            status=status,
            page=page,
