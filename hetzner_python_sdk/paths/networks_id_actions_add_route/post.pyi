...
from hetzner_python_sdk.model.network_actions_add_route_request import NetworkActionsAddRouteRequest as NetworkActionsAddRouteRequestSchema
from hetzner_python_sdk.model.network_actions_add_route_response import NetworkActionsAddRouteResponse as NetworkActionsAddRouteResponseSchema

from hetzner_python_sdk.type.network_actions_add_route_response import NetworkActionsAddRouteResponse
from hetzner_python_sdk.type.network_actions_add_route_request import NetworkActionsAddRouteRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_add_route_response import NetworkActionsAddRouteResponse as NetworkActionsAddRouteResponsePydantic
from hetzner_python_sdk.pydantic.network_actions_add_route_request import NetworkActionsAddRouteRequest as NetworkActionsAddRouteRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsAddRouteRequestSchema


request_body_network_actions_add_route_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = NetworkActionsAddRouteResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsAddRouteResponse
    ...
    async def _aadd_route_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/add_route',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_add_route_request.serialize(body, content_type)
...
class AddRouteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_route(
        self,
        destination: str,
        gateway: str,
        id: int,
        **kwargs,
        ...
        args = self._add_route_mapped_args(
            destination=destination,
            gateway=gateway,
            id=id,
        )
        return await self._aadd_route_oapg(
            body=args.body,
    ...
    def add_route(
        ...
        return self._add_route_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddRoute(BaseApi):
    ...
    async def aadd_route(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsAddRouteResponsePydantic:
        raw_response = await self.raw.aadd_route(
            destination=destination,
            gateway=gateway,
            id=id,
            **kwargs,
        ...
        if validate:
            return NetworkActionsAddRouteResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsAddRouteResponsePydantic, raw_response.body)
    ...
    def add_route(
        ...
        raw_response = self.raw.add_route(
            destination=destination,
            gateway=gateway,
            id=id,
        )
