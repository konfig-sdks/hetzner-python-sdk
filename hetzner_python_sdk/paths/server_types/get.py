...
from hetzner_python_sdk.model.server_types_list_all_server_types_response import ServerTypesListAllServerTypesResponse as ServerTypesListAllServerTypesResponseSchema

from hetzner_python_sdk.type.server_types_list_all_server_types_response import ServerTypesListAllServerTypesResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_types_list_all_server_types_response import ServerTypesListAllServerTypesResponse as ServerTypesListAllServerTypesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServerTypesListAllServerTypesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerTypesListAllServerTypesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_server_types_mapped_args(
        self,
    ...
    async def _alist_all_server_types_oapg(
        self,
    ...
    def _list_all_server_types_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAllServerTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_server_types(
        self,
        name: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        per_page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_all_server_types_mapped_args(
            name=name,
            page=page,
            per_page=per_page,
        )
        return await self._alist_all_server_types_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_all_server_types(
        self,
        name: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        per_page: typing.Optional[int] = None,
        ...
        return self._list_all_server_types_oapg(
            query_params=args.query,
        )

class ListAllServerTypes(BaseApi):
    ...
    async def alist_all_server_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerTypesListAllServerTypesResponsePydantic:
        raw_response = await self.raw.alist_all_server_types(
            name=name,
            page=page,
            per_page=per_page,
            **kwargs,
        ...
        if validate:
            return ServerTypesListAllServerTypesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerTypesListAllServerTypesResponsePydantic, raw_response.body)
    ...
    def list_all_server_types(
        ...
        raw_response = self.raw.list_all_server_types(
            name=name,
            page=page,
            per_page=per_page,
        )
