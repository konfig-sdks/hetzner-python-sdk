...
from hetzner_python_sdk.model.server_actions_attach_to_network_response import ServerActionsAttachToNetworkResponse as ServerActionsAttachToNetworkResponseSchema
from hetzner_python_sdk.model.server_actions_attach_to_network_request import ServerActionsAttachToNetworkRequest as ServerActionsAttachToNetworkRequestSchema
from hetzner_python_sdk.model.server_actions_attach_to_network_request_alias_ips import ServerActionsAttachToNetworkRequestAliasIps as ServerActionsAttachToNetworkRequestAliasIpsSchema

from hetzner_python_sdk.type.server_actions_attach_to_network_request import ServerActionsAttachToNetworkRequest
from hetzner_python_sdk.type.server_actions_attach_to_network_request_alias_ips import ServerActionsAttachToNetworkRequestAliasIps
from hetzner_python_sdk.type.server_actions_attach_to_network_response import ServerActionsAttachToNetworkResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_attach_to_network_response import ServerActionsAttachToNetworkResponse as ServerActionsAttachToNetworkResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_attach_to_network_request_alias_ips import ServerActionsAttachToNetworkRequestAliasIps as ServerActionsAttachToNetworkRequestAliasIpsPydantic
from hetzner_python_sdk.pydantic.server_actions_attach_to_network_request import ServerActionsAttachToNetworkRequest as ServerActionsAttachToNetworkRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsAttachToNetworkRequestSchema


request_body_server_actions_attach_to_network_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsAttachToNetworkResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsAttachToNetworkResponse
...
class BaseApi(api_client.Api):
    ...
    def _attach_to_network_mapped_args(
        self,
        network: int,
        id: int,
        alias_ips: typing.Optional[ServerActionsAttachToNetworkRequestAliasIps] = None,
    ...
    async def _aattach_to_network_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/attach_to_network',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_attach_to_network_request.serialize(body, content_type)
...
class AttachToNetworkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattach_to_network(
        self,
        network: int,
        id: int,
        alias_ips: typing.Optional[ServerActionsAttachToNetworkRequestAliasIps] = None,
        ...
        **kwargs,
        ...
        args = self._attach_to_network_mapped_args(
            network=network,
            id=id,
            alias_ips=alias_ips,
            ip=ip,
        )
        return await self._aattach_to_network_oapg(
            body=args.body,
    ...
    def attach_to_network(
        ...
        return self._attach_to_network_oapg(
            body=args.body,
            path_params=args.path,
        )

class AttachToNetwork(BaseApi):
    ...
    async def aattach_to_network(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsAttachToNetworkResponsePydantic:
        raw_response = await self.raw.aattach_to_network(
            network=network,
            id=id,
            alias_ips=alias_ips,
            ip=ip,
        ...
        if validate:
            return ServerActionsAttachToNetworkResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsAttachToNetworkResponsePydantic, raw_response.body)
    ...
    def attach_to_network(
        ...
        raw_response = self.raw.attach_to_network(
            network=network,
            id=id,
            alias_ips=alias_ips,
            ip=ip,
