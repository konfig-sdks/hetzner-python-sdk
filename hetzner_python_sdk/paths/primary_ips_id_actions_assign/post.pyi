...
from hetzner_python_sdk.model.primary_ip_actions_assign_primary_ip_to_resource_request import PrimaryIpActionsAssignPrimaryIpToResourceRequest as PrimaryIpActionsAssignPrimaryIpToResourceRequestSchema
from hetzner_python_sdk.model.primary_ip_actions_assign_primary_ip_to_resource_response import PrimaryIpActionsAssignPrimaryIpToResourceResponse as PrimaryIpActionsAssignPrimaryIpToResourceResponseSchema

from hetzner_python_sdk.type.primary_ip_actions_assign_primary_ip_to_resource_response import PrimaryIpActionsAssignPrimaryIpToResourceResponse
from hetzner_python_sdk.type.primary_ip_actions_assign_primary_ip_to_resource_request import PrimaryIpActionsAssignPrimaryIpToResourceRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_assign_primary_ip_to_resource_response import PrimaryIpActionsAssignPrimaryIpToResourceResponse as PrimaryIpActionsAssignPrimaryIpToResourceResponsePydantic
from hetzner_python_sdk.pydantic.primary_ip_actions_assign_primary_ip_to_resource_request import PrimaryIpActionsAssignPrimaryIpToResourceRequest as PrimaryIpActionsAssignPrimaryIpToResourceRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PrimaryIpActionsAssignPrimaryIpToResourceRequestSchema


request_body_primary_ip_actions_assign_primary_ip_to_resource_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PrimaryIpActionsAssignPrimaryIpToResourceResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PrimaryIpActionsAssignPrimaryIpToResourceResponse
...
class BaseApi(api_client.Api):
    ...
    def _assign_primary_ip_to_resource_mapped_args(
        self,
        assignee_id: int,
        assignee_type: str,
        id: int,
        ...
        if assignee_type is not None:
            _body["assignee_type"] = assignee_type
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aassign_primary_ip_to_resource_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/{id}/actions/assign',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_primary_ip_actions_assign_primary_ip_to_resource_request.serialize(body, content_type)
    ...
    def _assign_primary_ip_to_resource_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AssignPrimaryIpToResourceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_primary_ip_to_resource(
        self,
        assignee_id: int,
        assignee_type: str,
        id: int,
        **kwargs,
        ...
        args = self._assign_primary_ip_to_resource_mapped_args(
            assignee_id=assignee_id,
            assignee_type=assignee_type,
            id=id,
        )
        return await self._aassign_primary_ip_to_resource_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def assign_primary_ip_to_resource(
        self,
        assignee_id: int,
        assignee_type: str,
        id: int,
        ...
        return self._assign_primary_ip_to_resource_oapg(
            body=args.body,
            path_params=args.path,
        )

class AssignPrimaryIpToResource(BaseApi):
    ...
    async def aassign_primary_ip_to_resource(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsAssignPrimaryIpToResourceResponsePydantic:
        raw_response = await self.raw.aassign_primary_ip_to_resource(
            assignee_id=assignee_id,
            assignee_type=assignee_type,
            id=id,
            **kwargs,
        ...
        if validate:
            return PrimaryIpActionsAssignPrimaryIpToResourceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsAssignPrimaryIpToResourceResponsePydantic, raw_response.body)
    ...
    def assign_primary_ip_to_resource(
        ...
        raw_response = self.raw.assign_primary_ip_to_resource(
            assignee_id=assignee_id,
            assignee_type=assignee_type,
            id=id,
        )
