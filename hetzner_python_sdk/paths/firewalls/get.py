...
from hetzner_python_sdk.model.firewalls_list_all_response import FirewallsListAllResponse as FirewallsListAllResponseSchema

from hetzner_python_sdk.type.firewalls_list_all_response import FirewallsListAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.firewalls_list_all_response import FirewallsListAllResponse as FirewallsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallsListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FirewallsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsListAllResponsePydantic:
        ...
        if validate:
            return FirewallsListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsListAllResponsePydantic, raw_response.body)
