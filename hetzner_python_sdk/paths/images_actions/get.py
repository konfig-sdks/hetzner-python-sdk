...
from hetzner_python_sdk.model.image_actions_get_all_actions_response import ImageActionsGetAllActionsResponse as ImageActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.image_actions_get_all_actions_response import ImageActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.image_actions_get_all_actions_response import ImageActionsGetAllActionsResponse as ImageActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImageActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImageActionsGetAllActionsResponse
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImageActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return ImageActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImageActionsGetAllActionsResponsePydantic, raw_response.body)
