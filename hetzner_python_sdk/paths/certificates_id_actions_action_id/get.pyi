...
from hetzner_python_sdk.model.certificate_actions_get_action_by_id_response import CertificateActionsGetActionByIdResponse as CertificateActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.certificate_actions_get_action_by_id_response import CertificateActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificate_actions_get_action_by_id_response import CertificateActionsGetActionByIdResponse as CertificateActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CertificateActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CertificateActionsGetActionByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_action_by_id_mapped_args(
        self,
        id: int,
        action_id: int,
    ...
    async def _aget_action_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/certificates/{id}/actions/{action_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_action_by_id(
        self,
        id: int,
        action_id: int,
        **kwargs,
        ...
        args = self._get_action_by_id_mapped_args(
            id=id,
            action_id=action_id,
        )
        return await self._aget_action_by_id_oapg(
    ...
    def get_action_by_id(
        ...
        return self._get_action_by_id_oapg(
            path_params=args.path,
        )

class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificateActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            action_id=action_id,
            **kwargs,
        )
        if validate:
            return CertificateActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificateActionsGetActionByIdResponsePydantic, raw_response.body)
    ...
    def get_action_by_id(
        ...
        raw_response = self.raw.get_action_by_id(
            id=id,
            action_id=action_id,
        )
        if validate:
