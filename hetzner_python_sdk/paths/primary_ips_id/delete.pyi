...
class BaseApi(api_client.Api):
    ...
    def _delete_primary_ip_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_primary_ip_oapg(
        self,
...
class DeletePrimaryIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_primary_ip(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_primary_ip_mapped_args(
            id=id,
        )
        return await self._adelete_primary_ip_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_primary_ip(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_primary_ip_oapg(
            path_params=args.path,
        )

class DeletePrimaryIp(BaseApi):
    ...
    async def adelete_primary_ip(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_primary_ip(
            id=id,
            **kwargs,
        )
    ...
    def delete_primary_ip(
        ...
        raw_response = self.raw.delete_primary_ip(
            id=id,
        )
