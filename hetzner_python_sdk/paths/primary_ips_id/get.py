...
from hetzner_python_sdk.model.primary_ips_get_by_id_response import PrimaryIPsGetByIdResponse as PrimaryIPsGetByIdResponseSchema

from hetzner_python_sdk.type.primary_ips_get_by_id_response import PrimaryIPsGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ips_get_by_id_response import PrimaryIPsGetByIdResponse as PrimaryIPsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PrimaryIPsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrimaryIPsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIPsGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return PrimaryIPsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIPsGetByIdResponsePydantic, raw_response.body)
