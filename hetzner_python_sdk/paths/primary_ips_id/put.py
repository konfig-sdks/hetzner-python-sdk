...
from hetzner_python_sdk.model.primary_ips_update_ip_labels_response import PrimaryIPsUpdateIpLabelsResponse as PrimaryIPsUpdateIpLabelsResponseSchema
from hetzner_python_sdk.model.primary_ips_update_ip_labels_request import PrimaryIPsUpdateIpLabelsRequest as PrimaryIPsUpdateIpLabelsRequestSchema

from hetzner_python_sdk.type.primary_ips_update_ip_labels_request import PrimaryIPsUpdateIpLabelsRequest
from hetzner_python_sdk.type.primary_ips_update_ip_labels_response import PrimaryIPsUpdateIpLabelsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ips_update_ip_labels_request import PrimaryIPsUpdateIpLabelsRequest as PrimaryIPsUpdateIpLabelsRequestPydantic
from hetzner_python_sdk.pydantic.primary_ips_update_ip_labels_response import PrimaryIPsUpdateIpLabelsResponse as PrimaryIPsUpdateIpLabelsResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PrimaryIPsUpdateIpLabelsRequestSchema


request_body_primary_ips_update_ip_labels_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PrimaryIPsUpdateIpLabelsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrimaryIPsUpdateIpLabelsResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_ip_labels_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_ip_labels_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_primary_ips_update_ip_labels_request.serialize(body, content_type)
...
class UpdateIpLabelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_ip_labels(
        self,
        id: int,
        auto_delete: typing.Optional[bool] = None,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._update_ip_labels_mapped_args(
            id=id,
            auto_delete=auto_delete,
            labels=labels,
            name=name,
        )
        return await self._aupdate_ip_labels_oapg(
            body=args.body,
    ...
    def update_ip_labels(
        ...
        return self._update_ip_labels_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateIpLabels(BaseApi):
    ...
    async def aupdate_ip_labels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIPsUpdateIpLabelsResponsePydantic:
        raw_response = await self.raw.aupdate_ip_labels(
            id=id,
            auto_delete=auto_delete,
            labels=labels,
            name=name,
        ...
        if validate:
            return PrimaryIPsUpdateIpLabelsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIPsUpdateIpLabelsResponsePydantic, raw_response.body)
    ...
    def update_ip_labels(
        ...
        raw_response = self.raw.update_ip_labels(
            id=id,
            auto_delete=auto_delete,
            labels=labels,
            name=name,
