...
from hetzner_python_sdk.model.pricing_get_all_prices_response import PricingGetAllPricesResponse as PricingGetAllPricesResponseSchema

from hetzner_python_sdk.type.pricing_get_all_prices_response import PricingGetAllPricesResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.pricing_get_all_prices_response import PricingGetAllPricesResponse as PricingGetAllPricesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PricingGetAllPricesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PricingGetAllPricesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_prices_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_prices_oapg(
        self,
...
class GetAllPricesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_prices(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_prices_mapped_args(
        )
        return await self._aget_all_prices_oapg(
            **kwargs,
        )
    ...
    def get_all_prices(
        ...
        return self._get_all_prices_oapg(
        )

class GetAllPrices(BaseApi):

    async def aget_all_prices(
        self,
        validate: bool = False,
        **kwargs,
    ) -> PricingGetAllPricesResponsePydantic:
        raw_response = await self.raw.aget_all_prices(
            **kwargs,
        )
        if validate:
            return PricingGetAllPricesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PricingGetAllPricesResponsePydantic, raw_response.body)
    ...
    def get_all_prices(
        ...
        raw_response = self.raw.get_all_prices(
        )
        if validate:
            return PricingGetAllPricesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PricingGetAllPricesResponsePydantic, raw_response.body)
