...
from hetzner_python_sdk.model.server_actions_detach_iso_from_server_response import ServerActionsDetachIsoFromServerResponse as ServerActionsDetachIsoFromServerResponseSchema

from hetzner_python_sdk.type.server_actions_detach_iso_from_server_response import ServerActionsDetachIsoFromServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_detach_iso_from_server_response import ServerActionsDetachIsoFromServerResponse as ServerActionsDetachIsoFromServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsDetachIsoFromServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsDetachIsoFromServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _detach_iso_from_server_mapped_args(
        self,
        id: int,
    ...
    async def _adetach_iso_from_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/detach_iso',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _detach_iso_from_server_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DetachIsoFromServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetach_iso_from_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._detach_iso_from_server_mapped_args(
            id=id,
        )
        return await self._adetach_iso_from_server_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def detach_iso_from_server(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._detach_iso_from_server_oapg(
            path_params=args.path,
        )

class DetachIsoFromServer(BaseApi):
    ...
    async def adetach_iso_from_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsDetachIsoFromServerResponsePydantic:
        raw_response = await self.raw.adetach_iso_from_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsDetachIsoFromServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsDetachIsoFromServerResponsePydantic, raw_response.body)
    ...
    def detach_iso_from_server(
        ...
        raw_response = self.raw.detach_iso_from_server(
            id=id,
        )
        if validate:
            return ServerActionsDetachIsoFromServerResponsePydantic(**raw_response.body)
