...
from hetzner_python_sdk.model.network_actions_change_ip_range_response import NetworkActionsChangeIpRangeResponse as NetworkActionsChangeIpRangeResponseSchema
from hetzner_python_sdk.model.network_actions_change_ip_range_request import NetworkActionsChangeIpRangeRequest as NetworkActionsChangeIpRangeRequestSchema

from hetzner_python_sdk.type.network_actions_change_ip_range_response import NetworkActionsChangeIpRangeResponse
from hetzner_python_sdk.type.network_actions_change_ip_range_request import NetworkActionsChangeIpRangeRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_change_ip_range_response import NetworkActionsChangeIpRangeResponse as NetworkActionsChangeIpRangeResponsePydantic
from hetzner_python_sdk.pydantic.network_actions_change_ip_range_request import NetworkActionsChangeIpRangeRequest as NetworkActionsChangeIpRangeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsChangeIpRangeRequestSchema


request_body_network_actions_change_ip_range_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = NetworkActionsChangeIpRangeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsChangeIpRangeResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_ip_range_mapped_args(
        self,
        ip_range: str,
        id: int,
    ...
    async def _achange_ip_range_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/change_ip_range',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_change_ip_range_request.serialize(body, content_type)
...
class ChangeIpRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_ip_range(
        self,
        ip_range: str,
        id: int,
        **kwargs,
        ...
        args = self._change_ip_range_mapped_args(
            ip_range=ip_range,
            id=id,
        )
        return await self._achange_ip_range_oapg(
            body=args.body,
    ...
    def change_ip_range(
        ...
        return self._change_ip_range_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeIpRange(BaseApi):
    ...
    async def achange_ip_range(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsChangeIpRangeResponsePydantic:
        raw_response = await self.raw.achange_ip_range(
            ip_range=ip_range,
            id=id,
            **kwargs,
        )
        if validate:
            return NetworkActionsChangeIpRangeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsChangeIpRangeResponsePydantic, raw_response.body)
    ...
    def change_ip_range(
        ...
        raw_response = self.raw.change_ip_range(
            ip_range=ip_range,
            id=id,
        )
        if validate:
