...
from hetzner_python_sdk.model.server_actions_disable_backup_response import ServerActionsDisableBackupResponse as ServerActionsDisableBackupResponseSchema

from hetzner_python_sdk.type.server_actions_disable_backup_response import ServerActionsDisableBackupResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_disable_backup_response import ServerActionsDisableBackupResponse as ServerActionsDisableBackupResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsDisableBackupResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsDisableBackupResponse
...
class BaseApi(api_client.Api):
    ...
    def _disable_backup_mapped_args(
        self,
        id: int,
    ...
    async def _adisable_backup_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/disable_backup',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DisableBackupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisable_backup(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._disable_backup_mapped_args(
            id=id,
        )
        return await self._adisable_backup_oapg(
    ...
    def disable_backup(
        ...
        return self._disable_backup_oapg(
            path_params=args.path,
        )

class DisableBackup(BaseApi):
    ...
    async def adisable_backup(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsDisableBackupResponsePydantic:
        raw_response = await self.raw.adisable_backup(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsDisableBackupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsDisableBackupResponsePydantic, raw_response.body)
    ...
    def disable_backup(
        ...
        raw_response = self.raw.disable_backup(
            id=id,
        )
        if validate:
            return ServerActionsDisableBackupResponsePydantic(**raw_response.body)
