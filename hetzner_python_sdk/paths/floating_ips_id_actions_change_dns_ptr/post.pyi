...
from hetzner_python_sdk.model.floating_ip_actions_change_dns_ptr_response import FloatingIpActionsChangeDnsPtrResponse as FloatingIpActionsChangeDnsPtrResponseSchema
from hetzner_python_sdk.model.floating_ip_actions_change_dns_ptr_request import FloatingIpActionsChangeDnsPtrRequest as FloatingIpActionsChangeDnsPtrRequestSchema

from hetzner_python_sdk.type.floating_ip_actions_change_dns_ptr_request import FloatingIpActionsChangeDnsPtrRequest
from hetzner_python_sdk.type.floating_ip_actions_change_dns_ptr_response import FloatingIpActionsChangeDnsPtrResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_change_dns_ptr_request import FloatingIpActionsChangeDnsPtrRequest as FloatingIpActionsChangeDnsPtrRequestPydantic
from hetzner_python_sdk.pydantic.floating_ip_actions_change_dns_ptr_response import FloatingIpActionsChangeDnsPtrResponse as FloatingIpActionsChangeDnsPtrResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FloatingIpActionsChangeDnsPtrRequestSchema


request_body_floating_ip_actions_change_dns_ptr_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = FloatingIpActionsChangeDnsPtrResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIpActionsChangeDnsPtrResponse
    ...
    async def _achange_dns_ptr_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}/actions/change_dns_ptr',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_floating_ip_actions_change_dns_ptr_request.serialize(body, content_type)
...
class ChangeDnsPtr(BaseApi):
    ...
    async def achange_dns_ptr(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsChangeDnsPtrResponsePydantic:
        ...
        if validate:
            return FloatingIpActionsChangeDnsPtrResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsChangeDnsPtrResponsePydantic, raw_response.body)
