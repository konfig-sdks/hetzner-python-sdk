...
from hetzner_python_sdk.model.servers_delete_server_response import ServersDeleteServerResponse as ServersDeleteServerResponseSchema

from hetzner_python_sdk.type.servers_delete_server_response import ServersDeleteServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.servers_delete_server_response import ServersDeleteServerResponse as ServersDeleteServerResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServersDeleteServerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServersDeleteServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_server_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_server_oapg(
        self,
...
class DeleteServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_server_mapped_args(
            id=id,
        )
        return await self._adelete_server_oapg(
...
class DeleteServer(BaseApi):
    ...
    async def adelete_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServersDeleteServerResponsePydantic:
        raw_response = await self.raw.adelete_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServersDeleteServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServersDeleteServerResponsePydantic, raw_response.body)
    ...
    def delete_server(
        ...
        raw_response = self.raw.delete_server(
            id=id,
        )
        if validate:
            return ServersDeleteServerResponsePydantic(**raw_response.body)
