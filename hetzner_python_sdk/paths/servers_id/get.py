...
from hetzner_python_sdk.model.servers_get_server_response import ServersGetServerResponse as ServersGetServerResponseSchema

from hetzner_python_sdk.type.servers_get_server_response import ServersGetServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.servers_get_server_response import ServersGetServerResponse as ServersGetServerResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServersGetServerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServersGetServerResponse
...
class GetServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_server_mapped_args(
            id=id,
        )
        return await self._aget_server_oapg(
...
class GetServer(BaseApi):
    ...
    async def aget_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServersGetServerResponsePydantic:
        raw_response = await self.raw.aget_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServersGetServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServersGetServerResponsePydantic, raw_response.body)
    ...
    def get_server(
        ...
        raw_response = self.raw.get_server(
            id=id,
        )
        if validate:
            return ServersGetServerResponsePydantic(**raw_response.body)
