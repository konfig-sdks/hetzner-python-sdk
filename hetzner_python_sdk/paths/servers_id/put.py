...
from hetzner_python_sdk.model.servers_update_server_response import ServersUpdateServerResponse as ServersUpdateServerResponseSchema
from hetzner_python_sdk.model.servers_update_server_request import ServersUpdateServerRequest as ServersUpdateServerRequestSchema

from hetzner_python_sdk.type.servers_update_server_request import ServersUpdateServerRequest
from hetzner_python_sdk.type.servers_update_server_response import ServersUpdateServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.servers_update_server_request import ServersUpdateServerRequest as ServersUpdateServerRequestPydantic
from hetzner_python_sdk.pydantic.servers_update_server_response import ServersUpdateServerResponse as ServersUpdateServerResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServersUpdateServerRequestSchema


request_body_servers_update_server_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ServersUpdateServerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServersUpdateServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_server_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_servers_update_server_request.serialize(body, content_type)
...
class UpdateServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_server(
        self,
        id: int,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_server_mapped_args(
            id=id,
            labels=labels,
            name=name,
        )
        return await self._aupdate_server_oapg(
            body=args.body,
...
class UpdateServer(BaseApi):
    ...
    async def aupdate_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServersUpdateServerResponsePydantic:
        raw_response = await self.raw.aupdate_server(
            id=id,
            labels=labels,
            name=name,
            **kwargs,
        ...
        if validate:
            return ServersUpdateServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServersUpdateServerResponsePydantic, raw_response.body)
    ...
    def update_server(
        ...
        raw_response = self.raw.update_server(
            id=id,
            labels=labels,
            name=name,
        )
