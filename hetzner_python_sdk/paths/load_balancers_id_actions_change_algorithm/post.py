...
from hetzner_python_sdk.model.load_balancer_actions_change_algorithm_request import LoadBalancerActionsChangeAlgorithmRequest as LoadBalancerActionsChangeAlgorithmRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_change_algorithm_response import LoadBalancerActionsChangeAlgorithmResponse as LoadBalancerActionsChangeAlgorithmResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_change_algorithm_response import LoadBalancerActionsChangeAlgorithmResponse
from hetzner_python_sdk.type.load_balancer_actions_change_algorithm_request import LoadBalancerActionsChangeAlgorithmRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_change_algorithm_response import LoadBalancerActionsChangeAlgorithmResponse as LoadBalancerActionsChangeAlgorithmResponsePydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_change_algorithm_request import LoadBalancerActionsChangeAlgorithmRequest as LoadBalancerActionsChangeAlgorithmRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsChangeAlgorithmRequestSchema


request_body_load_balancer_actions_change_algorithm_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsChangeAlgorithmResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsChangeAlgorithmResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_algorithm_mapped_args(
        self,
        type: str,
        id: int,
    ...
    async def _achange_algorithm_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/change_algorithm',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_change_algorithm_request.serialize(body, content_type)
...
class ChangeAlgorithmRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_algorithm(
        self,
        type: str,
        id: int,
        **kwargs,
        ...
        args = self._change_algorithm_mapped_args(
            type=type,
            id=id,
        )
        return await self._achange_algorithm_oapg(
            body=args.body,
    ...
    def change_algorithm(
        ...
        return self._change_algorithm_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeAlgorithm(BaseApi):
    ...
    async def achange_algorithm(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsChangeAlgorithmResponsePydantic:
        raw_response = await self.raw.achange_algorithm(
            type=type,
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsChangeAlgorithmResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsChangeAlgorithmResponsePydantic, raw_response.body)
    ...
    def change_algorithm(
        ...
        raw_response = self.raw.change_algorithm(
            type=type,
            id=id,
        )
        if validate:
