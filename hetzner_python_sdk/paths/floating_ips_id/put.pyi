...
from hetzner_python_sdk.model.floating_ips_update_description_labels_request import FloatingIPsUpdateDescriptionLabelsRequest as FloatingIPsUpdateDescriptionLabelsRequestSchema
from hetzner_python_sdk.model.floating_ips_update_description_labels_response import FloatingIPsUpdateDescriptionLabelsResponse as FloatingIPsUpdateDescriptionLabelsResponseSchema

from hetzner_python_sdk.type.floating_ips_update_description_labels_request import FloatingIPsUpdateDescriptionLabelsRequest
from hetzner_python_sdk.type.floating_ips_update_description_labels_response import FloatingIPsUpdateDescriptionLabelsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ips_update_description_labels_request import FloatingIPsUpdateDescriptionLabelsRequest as FloatingIPsUpdateDescriptionLabelsRequestPydantic
from hetzner_python_sdk.pydantic.floating_ips_update_description_labels_response import FloatingIPsUpdateDescriptionLabelsResponse as FloatingIPsUpdateDescriptionLabelsResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FloatingIPsUpdateDescriptionLabelsRequestSchema


request_body_floating_ips_update_description_labels_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = FloatingIPsUpdateDescriptionLabelsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIPsUpdateDescriptionLabelsResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_description_labels_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_description_labels_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_floating_ips_update_description_labels_request.serialize(body, content_type)
    ...
    def _update_description_labels_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDescriptionLabelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_description_labels(
        self,
        id: int,
        description: typing.Optional[str] = None,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._update_description_labels_mapped_args(
            id=id,
            description=description,
            labels=labels,
            name=name,
        )
        return await self._aupdate_description_labels_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_description_labels(
        self,
        id: int,
        description: typing.Optional[str] = None,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        return self._update_description_labels_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDescriptionLabels(BaseApi):
    ...
    async def aupdate_description_labels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsUpdateDescriptionLabelsResponsePydantic:
        raw_response = await self.raw.aupdate_description_labels(
            id=id,
            description=description,
            labels=labels,
            name=name,
        ...
        if validate:
            return FloatingIPsUpdateDescriptionLabelsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsUpdateDescriptionLabelsResponsePydantic, raw_response.body)
    ...
    def update_description_labels(
        ...
        raw_response = self.raw.update_description_labels(
            id=id,
            description=description,
            labels=labels,
            name=name,
