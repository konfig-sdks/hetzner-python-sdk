...
class DeleteIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_ip(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_ip_mapped_args(
            id=id,
        )
        return await self._adelete_ip_oapg(
    ...
    def delete_ip(
        ...
        return self._delete_ip_oapg(
            path_params=args.path,
        )

class DeleteIp(BaseApi):
    ...
    async def adelete_ip(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_ip(
            id=id,
            **kwargs,
        )
    ...
    def delete_ip(
        ...
        raw_response = self.raw.delete_ip(
            id=id,
        )
