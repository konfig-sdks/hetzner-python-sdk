...
from hetzner_python_sdk.model.floating_ips_get_response import FloatingIPsGetResponse as FloatingIPsGetResponseSchema

from hetzner_python_sdk.type.floating_ips_get_response import FloatingIPsGetResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ips_get_response import FloatingIPsGetResponse as FloatingIPsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIPsGetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIPsGetResponse
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsGetResponsePydantic:
        raw_response = await self.raw.aget(
            id=id,
            **kwargs,
        )
        if validate:
            return FloatingIPsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsGetResponsePydantic, raw_response.body)
