...
from hetzner_python_sdk.model.volume_actions_get_action_by_id_response import VolumeActionsGetActionByIdResponse as VolumeActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.volume_actions_get_action_by_id_response import VolumeActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_get_action_by_id_response import VolumeActionsGetActionByIdResponse as VolumeActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumeActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumeActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return VolumeActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsGetActionByIdResponsePydantic, raw_response.body)
