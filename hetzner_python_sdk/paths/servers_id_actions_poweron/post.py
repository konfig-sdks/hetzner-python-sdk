...
from hetzner_python_sdk.model.server_actions_power_on_server_response import ServerActionsPowerOnServerResponse as ServerActionsPowerOnServerResponseSchema

from hetzner_python_sdk.type.server_actions_power_on_server_response import ServerActionsPowerOnServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_power_on_server_response import ServerActionsPowerOnServerResponse as ServerActionsPowerOnServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsPowerOnServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsPowerOnServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _power_on_server_mapped_args(
        self,
        id: int,
    ...
    async def _apower_on_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/poweron',
            auth_settings=_auth,
            headers=_headers,
        )
...
class PowerOnServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apower_on_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._power_on_server_mapped_args(
            id=id,
        )
        return await self._apower_on_server_oapg(
    ...
    def power_on_server(
        ...
        return self._power_on_server_oapg(
            path_params=args.path,
        )

class PowerOnServer(BaseApi):
    ...
    async def apower_on_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsPowerOnServerResponsePydantic:
        raw_response = await self.raw.apower_on_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsPowerOnServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsPowerOnServerResponsePydantic, raw_response.body)
    ...
    def power_on_server(
        ...
        raw_response = self.raw.power_on_server(
            id=id,
        )
        if validate:
            return ServerActionsPowerOnServerResponsePydantic(**raw_response.body)
