...
from hetzner_python_sdk.model.load_balancer_actions_enable_public_interface_response import LoadBalancerActionsEnablePublicInterfaceResponse as LoadBalancerActionsEnablePublicInterfaceResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_enable_public_interface_response import LoadBalancerActionsEnablePublicInterfaceResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_enable_public_interface_response import LoadBalancerActionsEnablePublicInterfaceResponse as LoadBalancerActionsEnablePublicInterfaceResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsEnablePublicInterfaceResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsEnablePublicInterfaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _enable_public_interface_mapped_args(
        self,
        id: int,
    ...
    async def _aenable_public_interface_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/enable_public_interface',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _enable_public_interface_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class EnablePublicInterfaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aenable_public_interface(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._enable_public_interface_mapped_args(
            id=id,
        )
        return await self._aenable_public_interface_oapg(
    ...
    def enable_public_interface(
        ...
        return self._enable_public_interface_oapg(
            path_params=args.path,
        )

class EnablePublicInterface(BaseApi):
    ...
    async def aenable_public_interface(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsEnablePublicInterfaceResponsePydantic:
        raw_response = await self.raw.aenable_public_interface(
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsEnablePublicInterfaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsEnablePublicInterfaceResponsePydantic, raw_response.body)
    ...
    def enable_public_interface(
        ...
        raw_response = self.raw.enable_public_interface(
            id=id,
        )
        if validate:
            return LoadBalancerActionsEnablePublicInterfaceResponsePydantic(**raw_response.body)
