...
from hetzner_python_sdk.model.volume_actions_change_size_request import VolumeActionsChangeSizeRequest as VolumeActionsChangeSizeRequestSchema
from hetzner_python_sdk.model.volume_actions_change_size_response import VolumeActionsChangeSizeResponse as VolumeActionsChangeSizeResponseSchema

from hetzner_python_sdk.type.volume_actions_change_size_request import VolumeActionsChangeSizeRequest
from hetzner_python_sdk.type.volume_actions_change_size_response import VolumeActionsChangeSizeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_change_size_response import VolumeActionsChangeSizeResponse as VolumeActionsChangeSizeResponsePydantic
from hetzner_python_sdk.pydantic.volume_actions_change_size_request import VolumeActionsChangeSizeRequest as VolumeActionsChangeSizeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VolumeActionsChangeSizeRequestSchema


request_body_volume_actions_change_size_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VolumeActionsChangeSizeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: VolumeActionsChangeSizeResponse
    ...
    async def _achange_size_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/{id}/actions/resize',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_volume_actions_change_size_request.serialize(body, content_type)
...
class ChangeSizeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_size(
        self,
        size: typing.Union[int, float],
        id: int,
        **kwargs,
        ...
        args = self._change_size_mapped_args(
            size=size,
            id=id,
        )
        return await self._achange_size_oapg(
            body=args.body,
    ...
    def change_size(
        ...
        return self._change_size_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeSize(BaseApi):
    ...
    async def achange_size(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsChangeSizeResponsePydantic:
        raw_response = await self.raw.achange_size(
            size=size,
            id=id,
            **kwargs,
        )
        if validate:
            return VolumeActionsChangeSizeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsChangeSizeResponsePydantic, raw_response.body)
    ...
    def change_size(
        ...
        raw_response = self.raw.change_size(
            size=size,
            id=id,
        )
        if validate:
