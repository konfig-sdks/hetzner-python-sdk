...
from hetzner_python_sdk.model.network_actions_change_protection_request import NetworkActionsChangeProtectionRequest as NetworkActionsChangeProtectionRequestSchema
from hetzner_python_sdk.model.network_actions_change_protection_response import NetworkActionsChangeProtectionResponse as NetworkActionsChangeProtectionResponseSchema

from hetzner_python_sdk.type.network_actions_change_protection_request import NetworkActionsChangeProtectionRequest
from hetzner_python_sdk.type.network_actions_change_protection_response import NetworkActionsChangeProtectionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_change_protection_request import NetworkActionsChangeProtectionRequest as NetworkActionsChangeProtectionRequestPydantic
from hetzner_python_sdk.pydantic.network_actions_change_protection_response import NetworkActionsChangeProtectionResponse as NetworkActionsChangeProtectionResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsChangeProtectionRequestSchema


request_body_network_actions_change_protection_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = NetworkActionsChangeProtectionResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsChangeProtectionResponse
    ...
    async def _achange_protection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_change_protection_request.serialize(body, content_type)
...
class ChangeProtection(BaseApi):
    ...
    async def achange_protection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsChangeProtectionResponsePydantic:
        ...
        if validate:
            return NetworkActionsChangeProtectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsChangeProtectionResponsePydantic, raw_response.body)
