...
from hetzner_python_sdk.model.load_balancers_update_balancer_response import LoadBalancersUpdateBalancerResponse as LoadBalancersUpdateBalancerResponseSchema
from hetzner_python_sdk.model.load_balancers_update_balancer_request import LoadBalancersUpdateBalancerRequest as LoadBalancersUpdateBalancerRequestSchema

from hetzner_python_sdk.type.load_balancers_update_balancer_request import LoadBalancersUpdateBalancerRequest
from hetzner_python_sdk.type.load_balancers_update_balancer_response import LoadBalancersUpdateBalancerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancers_update_balancer_response import LoadBalancersUpdateBalancerResponse as LoadBalancersUpdateBalancerResponsePydantic
from hetzner_python_sdk.pydantic.load_balancers_update_balancer_request import LoadBalancersUpdateBalancerRequest as LoadBalancersUpdateBalancerRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancersUpdateBalancerRequestSchema


request_body_load_balancers_update_balancer_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = LoadBalancersUpdateBalancerResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancersUpdateBalancerResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_balancer_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_balancer_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancers_update_balancer_request.serialize(body, content_type)
...
class UpdateBalancerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_balancer(
        self,
        id: int,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_balancer_mapped_args(
            id=id,
            labels=labels,
            name=name,
        )
        return await self._aupdate_balancer_oapg(
            body=args.body,
...
class UpdateBalancer(BaseApi):
    ...
    async def aupdate_balancer(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersUpdateBalancerResponsePydantic:
        raw_response = await self.raw.aupdate_balancer(
            id=id,
            labels=labels,
            name=name,
            **kwargs,
        ...
        if validate:
            return LoadBalancersUpdateBalancerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancersUpdateBalancerResponsePydantic, raw_response.body)
    ...
    def update_balancer(
        ...
        raw_response = self.raw.update_balancer(
            id=id,
            labels=labels,
            name=name,
        )
