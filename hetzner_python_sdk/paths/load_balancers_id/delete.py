...
class BaseApi(api_client.Api):
    ...
    def _delete_load_balancer_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_load_balancer_oapg(
        self,
    ...
    def _delete_load_balancer_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteLoadBalancerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_load_balancer(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_load_balancer_mapped_args(
            id=id,
        )
        return await self._adelete_load_balancer_oapg(
    ...
    def delete_load_balancer(
        ...
        return self._delete_load_balancer_oapg(
            path_params=args.path,
        )

class DeleteLoadBalancer(BaseApi):
    ...
    async def adelete_load_balancer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_load_balancer(
            id=id,
            **kwargs,
        )
    ...
    def delete_load_balancer(
        ...
        raw_response = self.raw.delete_load_balancer(
            id=id,
        )
