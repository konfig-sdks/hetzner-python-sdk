...
from hetzner_python_sdk.model.load_balancers_get_by_id_response import LoadBalancersGetByIdResponse as LoadBalancersGetByIdResponseSchema

from hetzner_python_sdk.type.load_balancers_get_by_id_response import LoadBalancersGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancers_get_by_id_response import LoadBalancersGetByIdResponse as LoadBalancersGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancersGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancersGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancersGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancersGetByIdResponsePydantic, raw_response.body)
