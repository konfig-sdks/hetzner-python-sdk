...
from hetzner_python_sdk.model.is_os_get_response import IsOsGetResponse as IsOsGetResponseSchema

from hetzner_python_sdk.type.is_os_get_response import IsOsGetResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.is_os_get_response import IsOsGetResponse as IsOsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = IsOsGetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: IsOsGetResponse
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IsOsGetResponsePydantic:
        raw_response = await self.raw.aget(
            id=id,
            **kwargs,
        )
        if validate:
            return IsOsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(IsOsGetResponsePydantic, raw_response.body)
