...
from hetzner_python_sdk.model.certificate_actions_retry_issuance_or_renewal_response import CertificateActionsRetryIssuanceOrRenewalResponse as CertificateActionsRetryIssuanceOrRenewalResponseSchema

from hetzner_python_sdk.type.certificate_actions_retry_issuance_or_renewal_response import CertificateActionsRetryIssuanceOrRenewalResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificate_actions_retry_issuance_or_renewal_response import CertificateActionsRetryIssuanceOrRenewalResponse as CertificateActionsRetryIssuanceOrRenewalResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = CertificateActionsRetryIssuanceOrRenewalResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: CertificateActionsRetryIssuanceOrRenewalResponse
...
class BaseApi(api_client.Api):
    ...
    def _retry_issuance_or_renewal_mapped_args(
        self,
        id: int,
    ...
    async def _aretry_issuance_or_renewal_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/certificates/{id}/actions/retry',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _retry_issuance_or_renewal_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RetryIssuanceOrRenewalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretry_issuance_or_renewal(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._retry_issuance_or_renewal_mapped_args(
            id=id,
        )
        return await self._aretry_issuance_or_renewal_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def retry_issuance_or_renewal(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._retry_issuance_or_renewal_oapg(
            path_params=args.path,
        )

class RetryIssuanceOrRenewal(BaseApi):
    ...
    async def aretry_issuance_or_renewal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificateActionsRetryIssuanceOrRenewalResponsePydantic:
        raw_response = await self.raw.aretry_issuance_or_renewal(
            id=id,
            **kwargs,
        )
        if validate:
            return CertificateActionsRetryIssuanceOrRenewalResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificateActionsRetryIssuanceOrRenewalResponsePydantic, raw_response.body)
    ...
    def retry_issuance_or_renewal(
        ...
        raw_response = self.raw.retry_issuance_or_renewal(
            id=id,
        )
        if validate:
            return CertificateActionsRetryIssuanceOrRenewalResponsePydantic(**raw_response.body)
