...
from hetzner_python_sdk.model.volume_actions_detach_volume_from_server_response import VolumeActionsDetachVolumeFromServerResponse as VolumeActionsDetachVolumeFromServerResponseSchema

from hetzner_python_sdk.type.volume_actions_detach_volume_from_server_response import VolumeActionsDetachVolumeFromServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_detach_volume_from_server_response import VolumeActionsDetachVolumeFromServerResponse as VolumeActionsDetachVolumeFromServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = VolumeActionsDetachVolumeFromServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: VolumeActionsDetachVolumeFromServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _detach_volume_from_server_mapped_args(
        self,
        id: int,
    ...
    async def _adetach_volume_from_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/{id}/actions/detach',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _detach_volume_from_server_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DetachVolumeFromServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetach_volume_from_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._detach_volume_from_server_mapped_args(
            id=id,
        )
        return await self._adetach_volume_from_server_oapg(
    ...
    def detach_volume_from_server(
        ...
        return self._detach_volume_from_server_oapg(
            path_params=args.path,
        )

class DetachVolumeFromServer(BaseApi):
    ...
    async def adetach_volume_from_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsDetachVolumeFromServerResponsePydantic:
        raw_response = await self.raw.adetach_volume_from_server(
            id=id,
            **kwargs,
        )
        if validate:
            return VolumeActionsDetachVolumeFromServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsDetachVolumeFromServerResponsePydantic, raw_response.body)
    ...
    def detach_volume_from_server(
        ...
        raw_response = self.raw.detach_volume_from_server(
            id=id,
        )
        if validate:
            return VolumeActionsDetachVolumeFromServerResponsePydantic(**raw_response.body)
