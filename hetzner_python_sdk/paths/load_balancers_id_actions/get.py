...
from hetzner_python_sdk.model.load_balancer_actions_get_all_actions200_response import LoadBalancerActionsGetAllActions200Response as LoadBalancerActionsGetAllActions200ResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_get_all_actions200_response import LoadBalancerActionsGetAllActions200Response

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_get_all_actions200_response import LoadBalancerActionsGetAllActions200Response as LoadBalancerActionsGetAllActions200ResponsePydantic
...
class SortSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            ...
            "id:desc": "IDDESC",
            "command": "COMMAND",
            "command:asc": "COMMANDASC",
            "command:desc": "COMMANDDESC",
            "status": "STATUS",
            "status:asc": "STATUSASC",
            "status:desc": "STATUSDESC",
            "started": "STARTED",
            "started:asc": "STARTEDASC",
            "started:desc": "STARTEDDESC",
            "finished": "FINISHED",
            "finished:asc": "FINISHEDASC",
            "finished:desc": "FINISHEDDESC",
        }
    ...
    @schemas.classproperty
    def COMMANDASC(cls):
        return cls("command:asc")
    
    @schemas.classproperty
    def COMMANDDESC(cls):
        return cls("command:desc")
    ...
    @schemas.classproperty
    def STATUSASC(cls):
        return cls("status:asc")
    
    @schemas.classproperty
    def STATUSDESC(cls):
        return cls("status:desc")
    ...
    @schemas.classproperty
    def STARTEDASC(cls):
        return cls("started:asc")
    
    @schemas.classproperty
    def STARTEDDESC(cls):
        return cls("started:desc")
    ...
    @schemas.classproperty
    def FINISHEDASC(cls):
        return cls("finished:asc")
    
    @schemas.classproperty
    def FINISHEDDESC(cls):
        return cls("finished:desc")
...
PerPageSchema = schemas.Int64Schema
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerActionsGetAllActions200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerActionsGetAllActions200Response
...
class BaseApi(api_client.Api):
    ...
    def _get_all_actions_0_mapped_args(
        self,
        id: int,
    ...
    async def _aget_all_actions_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_actions_0(
        self,
        id: int,
        sort: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_actions_0_mapped_args(
            id=id,
            sort=sort,
            status=status,
            page=page,
        ...
        return await self._aget_all_actions_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_actions_0(
        self,
        id: int,
        sort: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        return self._get_all_actions_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllActions0(BaseApi):
    ...
    async def aget_all_actions_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsGetAllActions200ResponsePydantic:
        raw_response = await self.raw.aget_all_actions_0(
            id=id,
            sort=sort,
            status=status,
            page=page,
        ...
        if validate:
            return LoadBalancerActionsGetAllActions200ResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsGetAllActions200ResponsePydantic, raw_response.body)
    ...
    def get_all_actions_0(
        ...
        raw_response = self.raw.get_all_actions_0(
            id=id,
            sort=sort,
            status=status,
            page=page,
