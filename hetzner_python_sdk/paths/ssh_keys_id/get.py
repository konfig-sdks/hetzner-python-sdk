...
from hetzner_python_sdk.model.ssh_keys_get_by_id_response import SshKeysGetByIdResponse as SshKeysGetByIdResponseSchema

from hetzner_python_sdk.type.ssh_keys_get_by_id_response import SshKeysGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.ssh_keys_get_by_id_response import SshKeysGetByIdResponse as SshKeysGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SshKeysGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SshKeysGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SshKeysGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return SshKeysGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SshKeysGetByIdResponsePydantic, raw_response.body)
