...
from hetzner_python_sdk.model.ssh_keys_update_key_response import SshKeysUpdateKeyResponse as SshKeysUpdateKeyResponseSchema
from hetzner_python_sdk.model.ssh_keys_update_key_request import SshKeysUpdateKeyRequest as SshKeysUpdateKeyRequestSchema

from hetzner_python_sdk.type.ssh_keys_update_key_response import SshKeysUpdateKeyResponse
from hetzner_python_sdk.type.ssh_keys_update_key_request import SshKeysUpdateKeyRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.ssh_keys_update_key_response import SshKeysUpdateKeyResponse as SshKeysUpdateKeyResponsePydantic
from hetzner_python_sdk.pydantic.ssh_keys_update_key_request import SshKeysUpdateKeyRequest as SshKeysUpdateKeyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SshKeysUpdateKeyRequestSchema


request_body_ssh_keys_update_key_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SshKeysUpdateKeyResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SshKeysUpdateKeyResponse
    ...
    async def _aupdate_key_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/ssh_keys/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_ssh_keys_update_key_request.serialize(body, content_type)
...
class UpdateKey(BaseApi):
    ...
    async def aupdate_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SshKeysUpdateKeyResponsePydantic:
        ...
        if validate:
            return SshKeysUpdateKeyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SshKeysUpdateKeyResponsePydantic, raw_response.body)
