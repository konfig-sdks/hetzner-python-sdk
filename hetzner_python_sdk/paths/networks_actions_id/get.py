...
from hetzner_python_sdk.model.network_actions_get_action_response import NetworkActionsGetActionResponse as NetworkActionsGetActionResponseSchema

from hetzner_python_sdk.type.network_actions_get_action_response import NetworkActionsGetActionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_get_action_response import NetworkActionsGetActionResponse as NetworkActionsGetActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NetworkActionsGetActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworkActionsGetActionResponse
    ...
    async def _aget_action_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAction(BaseApi):
    ...
    async def aget_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsGetActionResponsePydantic:
        raw_response = await self.raw.aget_action(
            id=id,
            **kwargs,
        )
        if validate:
            return NetworkActionsGetActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsGetActionResponsePydantic, raw_response.body)
