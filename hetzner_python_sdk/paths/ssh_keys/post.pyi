...
from hetzner_python_sdk.model.ssh_keys_create_key_request import SshKeysCreateKeyRequest as SshKeysCreateKeyRequestSchema
from hetzner_python_sdk.model.ssh_keys_create_key_response import SshKeysCreateKeyResponse as SshKeysCreateKeyResponseSchema

from hetzner_python_sdk.type.ssh_keys_create_key_response import SshKeysCreateKeyResponse
from hetzner_python_sdk.type.ssh_keys_create_key_request import SshKeysCreateKeyRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.ssh_keys_create_key_request import SshKeysCreateKeyRequest as SshKeysCreateKeyRequestPydantic
from hetzner_python_sdk.pydantic.ssh_keys_create_key_response import SshKeysCreateKeyResponse as SshKeysCreateKeyResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = SshKeysCreateKeyRequestSchema


request_body_ssh_keys_create_key_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = SshKeysCreateKeyResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: SshKeysCreateKeyResponse
    ...
    async def _acreate_key_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_ssh_keys_create_key_request.serialize(body, content_type)
...
class CreateKey(BaseApi):
    ...
    async def acreate_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SshKeysCreateKeyResponsePydantic:
        ...
        if validate:
            return SshKeysCreateKeyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SshKeysCreateKeyResponsePydantic, raw_response.body)
