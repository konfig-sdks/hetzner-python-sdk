...
from hetzner_python_sdk.model.ssh_keys_get_all_ssh_keys_response import SshKeysGetAllSshKeysResponse as SshKeysGetAllSshKeysResponseSchema

from hetzner_python_sdk.type.ssh_keys_get_all_ssh_keys_response import SshKeysGetAllSshKeysResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.ssh_keys_get_all_ssh_keys_response import SshKeysGetAllSshKeysResponse as SshKeysGetAllSshKeysResponsePydantic
...
FingerprintSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'fingerprint': typing.Union[FingerprintSchema, str, ],
        'label_selector': typing.Union[LabelSelectorSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = SshKeysGetAllSshKeysResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SshKeysGetAllSshKeysResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_ssh_keys_mapped_args(
        self,
        ...
        if fingerprint is not None:
            _query_params["fingerprint"] = fingerprint
        if label_selector is not None:
            _query_params["label_selector"] = label_selector
        if page is not None:
    ...
    async def _aget_all_ssh_keys_oapg(
        self,
...
class GetAllSshKeysRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_ssh_keys(
        self,
        sort: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        fingerprint: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_ssh_keys_mapped_args(
            sort=sort,
            name=name,
        ...
        return await self._aget_all_ssh_keys_oapg(
    ...
    def get_all_ssh_keys(
        ...
        return self._get_all_ssh_keys_oapg(
            query_params=args.query,
        )

class GetAllSshKeys(BaseApi):
    ...
    async def aget_all_ssh_keys(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SshKeysGetAllSshKeysResponsePydantic:
        raw_response = await self.raw.aget_all_ssh_keys(
            sort=sort,
            name=name,
            fingerprint=fingerprint,
            label_selector=label_selector,
        ...
        if validate:
            return SshKeysGetAllSshKeysResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SshKeysGetAllSshKeysResponsePydantic, raw_response.body)
    ...
    def get_all_ssh_keys(
        ...
        raw_response = self.raw.get_all_ssh_keys(
            sort=sort,
            name=name,
            fingerprint=fingerprint,
            label_selector=label_selector,
