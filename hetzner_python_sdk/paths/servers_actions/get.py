...
from hetzner_python_sdk.model.server_actions_get_all_response import ServerActionsGetAllResponse as ServerActionsGetAllResponseSchema

from hetzner_python_sdk.type.server_actions_get_all_response import ServerActionsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_get_all_response import ServerActionsGetAllResponse as ServerActionsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServerActionsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerActionsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsGetAllResponsePydantic:
        ...
        if validate:
            return ServerActionsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsGetAllResponsePydantic, raw_response.body)
