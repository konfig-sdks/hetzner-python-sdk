...
from hetzner_python_sdk.model.load_balancer_actions_change_type_response import LoadBalancerActionsChangeTypeResponse as LoadBalancerActionsChangeTypeResponseSchema
from hetzner_python_sdk.model.load_balancer_actions_change_type_request import LoadBalancerActionsChangeTypeRequest as LoadBalancerActionsChangeTypeRequestSchema

from hetzner_python_sdk.type.load_balancer_actions_change_type_response import LoadBalancerActionsChangeTypeResponse
from hetzner_python_sdk.type.load_balancer_actions_change_type_request import LoadBalancerActionsChangeTypeRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_change_type_response import LoadBalancerActionsChangeTypeResponse as LoadBalancerActionsChangeTypeResponsePydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_change_type_request import LoadBalancerActionsChangeTypeRequest as LoadBalancerActionsChangeTypeRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsChangeTypeRequestSchema


request_body_load_balancer_actions_change_type_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsChangeTypeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsChangeTypeResponse
    ...
    async def _achange_type_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/change_type',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_change_type_request.serialize(body, content_type)
...
class ChangeTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_type(
        self,
        load_balancer_type: str,
        id: int,
        **kwargs,
        ...
        args = self._change_type_mapped_args(
            load_balancer_type=load_balancer_type,
            id=id,
        )
        return await self._achange_type_oapg(
            body=args.body,
    ...
    def change_type(
        ...
        return self._change_type_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeType(BaseApi):
    ...
    async def achange_type(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsChangeTypeResponsePydantic:
        raw_response = await self.raw.achange_type(
            load_balancer_type=load_balancer_type,
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsChangeTypeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsChangeTypeResponsePydantic, raw_response.body)
    ...
    def change_type(
        ...
        raw_response = self.raw.change_type(
            load_balancer_type=load_balancer_type,
            id=id,
        )
        if validate:
