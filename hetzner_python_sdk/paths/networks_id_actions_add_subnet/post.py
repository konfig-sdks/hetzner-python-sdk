...
from hetzner_python_sdk.model.network_actions_add_subnet_response import NetworkActionsAddSubnetResponse as NetworkActionsAddSubnetResponseSchema
from hetzner_python_sdk.model.network_actions_add_subnet_request import NetworkActionsAddSubnetRequest as NetworkActionsAddSubnetRequestSchema

from hetzner_python_sdk.type.network_actions_add_subnet_response import NetworkActionsAddSubnetResponse
from hetzner_python_sdk.type.network_actions_add_subnet_request import NetworkActionsAddSubnetRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_add_subnet_response import NetworkActionsAddSubnetResponse as NetworkActionsAddSubnetResponsePydantic
from hetzner_python_sdk.pydantic.network_actions_add_subnet_request import NetworkActionsAddSubnetRequest as NetworkActionsAddSubnetRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsAddSubnetRequestSchema


request_body_network_actions_add_subnet_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = NetworkActionsAddSubnetResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsAddSubnetResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_subnet_mapped_args(
        self,
        network_zone: str,
        type: str,
        id: int,
        ip_range: typing.Optional[str] = None,
        vswitch_id: typing.Optional[int] = None,
    ...
    async def _aadd_subnet_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/add_subnet',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_add_subnet_request.serialize(body, content_type)
...
class AddSubnetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_subnet(
        self,
        network_zone: str,
        type: str,
        id: int,
        ...
        **kwargs,
        ...
        args = self._add_subnet_mapped_args(
        ...
        return await self._aadd_subnet_oapg(
            body=args.body,
    ...
    def add_subnet(
        ...
        return self._add_subnet_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddSubnet(BaseApi):
    ...
    async def aadd_subnet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsAddSubnetResponsePydantic:
        raw_response = await self.raw.aadd_subnet(
            network_zone=network_zone,
            type=type,
            id=id,
            ip_range=ip_range,
        ...
        if validate:
            return NetworkActionsAddSubnetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsAddSubnetResponsePydantic, raw_response.body)
    ...
    def add_subnet(
        ...
        raw_response = self.raw.add_subnet(
            network_zone=network_zone,
            type=type,
            id=id,
            ip_range=ip_range,
