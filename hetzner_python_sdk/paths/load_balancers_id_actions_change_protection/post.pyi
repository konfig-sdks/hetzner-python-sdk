...
from hetzner_python_sdk.model.load_balancer_actions_change_protection_request import LoadBalancerActionsChangeProtectionRequest as LoadBalancerActionsChangeProtectionRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_change_protection_response import LoadBalancerActionsChangeProtectionResponse as LoadBalancerActionsChangeProtectionResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_change_protection_request import LoadBalancerActionsChangeProtectionRequest
from hetzner_python_sdk.type.load_balancer_actions_change_protection_response import LoadBalancerActionsChangeProtectionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_change_protection_response import LoadBalancerActionsChangeProtectionResponse as LoadBalancerActionsChangeProtectionResponsePydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_change_protection_request import LoadBalancerActionsChangeProtectionRequest as LoadBalancerActionsChangeProtectionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsChangeProtectionRequestSchema


request_body_load_balancer_actions_change_protection_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsChangeProtectionResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsChangeProtectionResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_protection_mapped_args(
        self,
        id: int,
    ...
    async def _achange_protection_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_change_protection_request.serialize(body, content_type)
...
class ChangeProtectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_protection(
        self,
        id: int,
        delete: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._change_protection_mapped_args(
            id=id,
            delete=delete,
        )
        return await self._achange_protection_oapg(
            body=args.body,
    ...
    def change_protection(
        ...
        return self._change_protection_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeProtection(BaseApi):
    ...
    async def achange_protection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsChangeProtectionResponsePydantic:
        raw_response = await self.raw.achange_protection(
            id=id,
            delete=delete,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsChangeProtectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsChangeProtectionResponsePydantic, raw_response.body)
    ...
    def change_protection(
        ...
        raw_response = self.raw.change_protection(
            id=id,
            delete=delete,
        )
        if validate:
