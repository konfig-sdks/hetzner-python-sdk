...
from hetzner_python_sdk.model.server_actions_detach_from_network_response import ServerActionsDetachFromNetworkResponse as ServerActionsDetachFromNetworkResponseSchema
from hetzner_python_sdk.model.server_actions_detach_from_network_request import ServerActionsDetachFromNetworkRequest as ServerActionsDetachFromNetworkRequestSchema

from hetzner_python_sdk.type.server_actions_detach_from_network_response import ServerActionsDetachFromNetworkResponse
from hetzner_python_sdk.type.server_actions_detach_from_network_request import ServerActionsDetachFromNetworkRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_detach_from_network_response import ServerActionsDetachFromNetworkResponse as ServerActionsDetachFromNetworkResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_detach_from_network_request import ServerActionsDetachFromNetworkRequest as ServerActionsDetachFromNetworkRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsDetachFromNetworkRequestSchema


request_body_server_actions_detach_from_network_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsDetachFromNetworkResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsDetachFromNetworkResponse
    ...
    async def _adetach_from_network_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/detach_from_network',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_detach_from_network_request.serialize(body, content_type)
...
class DetachFromNetwork(BaseApi):
    ...
    async def adetach_from_network(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsDetachFromNetworkResponsePydantic:
        ...
        if validate:
            return ServerActionsDetachFromNetworkResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsDetachFromNetworkResponsePydantic, raw_response.body)
