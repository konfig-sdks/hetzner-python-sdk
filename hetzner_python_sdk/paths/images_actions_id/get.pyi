...
from hetzner_python_sdk.model.image_actions_get_action_by_id_response import ImageActionsGetActionByIdResponse as ImageActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.image_actions_get_action_by_id_response import ImageActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.image_actions_get_action_by_id_response import ImageActionsGetActionByIdResponse as ImageActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImageActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImageActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/images/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImageActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return ImageActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImageActionsGetActionByIdResponsePydantic, raw_response.body)
