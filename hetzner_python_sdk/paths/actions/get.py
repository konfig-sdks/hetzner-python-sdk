...
from hetzner_python_sdk.model.actions_get_all_response import ActionsGetAllResponse as ActionsGetAllResponseSchema

from hetzner_python_sdk.type.actions_get_all_response import ActionsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.actions_get_all_response import ActionsGetAllResponse as ActionsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ActionsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActionsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return ActionsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ActionsGetAllResponsePydantic, raw_response.body)
