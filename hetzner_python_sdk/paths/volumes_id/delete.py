...
class BaseApi(api_client.Api):
    ...
    def _delete_volume_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_volume_oapg(
        self,
...
class DeleteVolumeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_volume(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_volume_mapped_args(
            id=id,
        )
        return await self._adelete_volume_oapg(
    ...
    def delete_volume(
        ...
        return self._delete_volume_oapg(
            path_params=args.path,
        )

class DeleteVolume(BaseApi):
    ...
    async def adelete_volume(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_volume(
            id=id,
            **kwargs,
        )
    ...
    def delete_volume(
        ...
        raw_response = self.raw.delete_volume(
            id=id,
        )
