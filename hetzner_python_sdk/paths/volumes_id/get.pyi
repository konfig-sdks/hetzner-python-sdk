...
from hetzner_python_sdk.model.volumes_get_by_id_response import VolumesGetByIdResponse as VolumesGetByIdResponseSchema

from hetzner_python_sdk.type.volumes_get_by_id_response import VolumesGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volumes_get_by_id_response import VolumesGetByIdResponse as VolumesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumesGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumesGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return VolumesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumesGetByIdResponsePydantic, raw_response.body)
