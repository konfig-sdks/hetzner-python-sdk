...
from hetzner_python_sdk.model.images_get_by_id_response import ImagesGetByIdResponse as ImagesGetByIdResponseSchema

from hetzner_python_sdk.type.images_get_by_id_response import ImagesGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.images_get_by_id_response import ImagesGetByIdResponse as ImagesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImagesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImagesGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImagesGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return ImagesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagesGetByIdResponsePydantic, raw_response.body)
