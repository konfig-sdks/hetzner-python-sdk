...
from hetzner_python_sdk.model.images_update_image_by_id_response import ImagesUpdateImageByIdResponse as ImagesUpdateImageByIdResponseSchema
from hetzner_python_sdk.model.images_update_image_by_id_request import ImagesUpdateImageByIdRequest as ImagesUpdateImageByIdRequestSchema

from hetzner_python_sdk.type.images_update_image_by_id_request import ImagesUpdateImageByIdRequest
from hetzner_python_sdk.type.images_update_image_by_id_response import ImagesUpdateImageByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.images_update_image_by_id_response import ImagesUpdateImageByIdResponse as ImagesUpdateImageByIdResponsePydantic
from hetzner_python_sdk.pydantic.images_update_image_by_id_request import ImagesUpdateImageByIdRequest as ImagesUpdateImageByIdRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ImagesUpdateImageByIdRequestSchema


request_body_images_update_image_by_id_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = ImagesUpdateImageByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ImagesUpdateImageByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_image_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _aupdate_image_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_images_update_image_by_id_request.serialize(body, content_type)
...
class UpdateImageByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_image_by_id(
        self,
        id: int,
        description: typing.Optional[str] = None,
        labels: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._update_image_by_id_mapped_args(
            id=id,
            description=description,
            labels=labels,
            type=type,
        )
        return await self._aupdate_image_by_id_oapg(
            body=args.body,
    ...
    def update_image_by_id(
        ...
        return self._update_image_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateImageById(BaseApi):
    ...
    async def aupdate_image_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImagesUpdateImageByIdResponsePydantic:
        raw_response = await self.raw.aupdate_image_by_id(
            id=id,
            description=description,
            labels=labels,
            type=type,
        ...
        if validate:
            return ImagesUpdateImageByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagesUpdateImageByIdResponsePydantic, raw_response.body)
    ...
    def update_image_by_id(
        ...
        raw_response = self.raw.update_image_by_id(
            id=id,
            description=description,
            labels=labels,
            type=type,
