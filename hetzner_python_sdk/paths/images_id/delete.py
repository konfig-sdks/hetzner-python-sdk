...
class DeleteImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_image(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_image_mapped_args(
            id=id,
        )
        return await self._adelete_image_oapg(
...
class DeleteImage(BaseApi):
    ...
    async def adelete_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_image(
            id=id,
            **kwargs,
        )
    ...
    def delete_image(
        ...
        raw_response = self.raw.delete_image(
            id=id,
        )
