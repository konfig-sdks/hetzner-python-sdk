...
from hetzner_python_sdk.model.servers_get_all_response import ServersGetAllResponse as ServersGetAllResponseSchema

from hetzner_python_sdk.type.servers_get_all_response import ServersGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.servers_get_all_response import ServersGetAllResponse as ServersGetAllResponsePydantic
...
XNextSchema = schemas.StrSchema
x_next_parameter = api_client.HeaderParameter(
    name="x-next",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XNextSchema,
)
SchemaFor200ResponseBodyApplicationJson = ServersGetAllResponseSchema
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return ServersGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServersGetAllResponsePydantic, raw_response.body)
