...
from hetzner_python_sdk.model.actions_get_by_id_response import ActionsGetByIdResponse as ActionsGetByIdResponseSchema

from hetzner_python_sdk.type.actions_get_by_id_response import ActionsGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.actions_get_by_id_response import ActionsGetByIdResponse as ActionsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ActionsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActionsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionsGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return ActionsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ActionsGetByIdResponsePydantic, raw_response.body)
