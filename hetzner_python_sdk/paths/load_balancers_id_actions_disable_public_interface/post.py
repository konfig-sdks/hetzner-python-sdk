...
from hetzner_python_sdk.model.load_balancer_actions_disable_public_interface_response import LoadBalancerActionsDisablePublicInterfaceResponse as LoadBalancerActionsDisablePublicInterfaceResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_disable_public_interface_response import LoadBalancerActionsDisablePublicInterfaceResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_disable_public_interface_response import LoadBalancerActionsDisablePublicInterfaceResponse as LoadBalancerActionsDisablePublicInterfaceResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsDisablePublicInterfaceResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsDisablePublicInterfaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _disable_public_interface_mapped_args(
        self,
        id: int,
    ...
    async def _adisable_public_interface_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/disable_public_interface',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _disable_public_interface_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DisablePublicInterfaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisable_public_interface(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._disable_public_interface_mapped_args(
            id=id,
        )
        return await self._adisable_public_interface_oapg(
    ...
    def disable_public_interface(
        ...
        return self._disable_public_interface_oapg(
            path_params=args.path,
        )

class DisablePublicInterface(BaseApi):
    ...
    async def adisable_public_interface(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsDisablePublicInterfaceResponsePydantic:
        raw_response = await self.raw.adisable_public_interface(
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsDisablePublicInterfaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsDisablePublicInterfaceResponsePydantic, raw_response.body)
    ...
    def disable_public_interface(
        ...
        raw_response = self.raw.disable_public_interface(
            id=id,
        )
        if validate:
            return LoadBalancerActionsDisablePublicInterfaceResponsePydantic(**raw_response.body)
