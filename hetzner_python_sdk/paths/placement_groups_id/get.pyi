...
from hetzner_python_sdk.model.placement_groups_get_by_id_response import PlacementGroupsGetByIdResponse as PlacementGroupsGetByIdResponseSchema

from hetzner_python_sdk.type.placement_groups_get_by_id_response import PlacementGroupsGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.placement_groups_get_by_id_response import PlacementGroupsGetByIdResponse as PlacementGroupsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PlacementGroupsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PlacementGroupsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlacementGroupsGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return PlacementGroupsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlacementGroupsGetByIdResponsePydantic, raw_response.body)
