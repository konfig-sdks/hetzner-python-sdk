...
from hetzner_python_sdk.model.placement_groups_update_properties_request import PlacementGroupsUpdatePropertiesRequest as PlacementGroupsUpdatePropertiesRequestSchema
from hetzner_python_sdk.model.placement_groups_update_properties_response import PlacementGroupsUpdatePropertiesResponse as PlacementGroupsUpdatePropertiesResponseSchema

from hetzner_python_sdk.type.placement_groups_update_properties_request import PlacementGroupsUpdatePropertiesRequest
from hetzner_python_sdk.type.placement_groups_update_properties_response import PlacementGroupsUpdatePropertiesResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.placement_groups_update_properties_request import PlacementGroupsUpdatePropertiesRequest as PlacementGroupsUpdatePropertiesRequestPydantic
from hetzner_python_sdk.pydantic.placement_groups_update_properties_response import PlacementGroupsUpdatePropertiesResponse as PlacementGroupsUpdatePropertiesResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PlacementGroupsUpdatePropertiesRequestSchema


request_body_placement_groups_update_properties_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PlacementGroupsUpdatePropertiesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PlacementGroupsUpdatePropertiesResponse
    ...
    async def _aupdate_properties_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/placement_groups/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_placement_groups_update_properties_request.serialize(body, content_type)
...
class UpdateProperties(BaseApi):
    ...
    async def aupdate_properties(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlacementGroupsUpdatePropertiesResponsePydantic:
        ...
        if validate:
            return PlacementGroupsUpdatePropertiesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlacementGroupsUpdatePropertiesResponsePydantic, raw_response.body)
