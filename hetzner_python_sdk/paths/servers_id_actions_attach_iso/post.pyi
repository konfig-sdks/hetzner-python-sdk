...
from hetzner_python_sdk.model.server_actions_attach_iso_to_server_request import ServerActionsAttachIsoToServerRequest as ServerActionsAttachIsoToServerRequestSchema
from hetzner_python_sdk.model.server_actions_attach_iso_to_server_response import ServerActionsAttachIsoToServerResponse as ServerActionsAttachIsoToServerResponseSchema

from hetzner_python_sdk.type.server_actions_attach_iso_to_server_response import ServerActionsAttachIsoToServerResponse
from hetzner_python_sdk.type.server_actions_attach_iso_to_server_request import ServerActionsAttachIsoToServerRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_attach_iso_to_server_request import ServerActionsAttachIsoToServerRequest as ServerActionsAttachIsoToServerRequestPydantic
from hetzner_python_sdk.pydantic.server_actions_attach_iso_to_server_response import ServerActionsAttachIsoToServerResponse as ServerActionsAttachIsoToServerResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsAttachIsoToServerRequestSchema


request_body_server_actions_attach_iso_to_server_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsAttachIsoToServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsAttachIsoToServerResponse
...
class BaseApi(api_client.Api):
    ...
    def _attach_iso_to_server_mapped_args(
        self,
        iso: str,
        id: int,
    ...
    async def _aattach_iso_to_server_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/attach_iso',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_attach_iso_to_server_request.serialize(body, content_type)
    ...
    def _attach_iso_to_server_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AttachIsoToServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aattach_iso_to_server(
        self,
        iso: str,
        id: int,
        **kwargs,
        ...
        args = self._attach_iso_to_server_mapped_args(
            iso=iso,
            id=id,
        )
        return await self._aattach_iso_to_server_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def attach_iso_to_server(
        self,
        iso: str,
        id: int,
    ) -> typing.Union[
        ...
        return self._attach_iso_to_server_oapg(
            body=args.body,
            path_params=args.path,
        )

class AttachIsoToServer(BaseApi):
    ...
    async def aattach_iso_to_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsAttachIsoToServerResponsePydantic:
        raw_response = await self.raw.aattach_iso_to_server(
            iso=iso,
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsAttachIsoToServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsAttachIsoToServerResponsePydantic, raw_response.body)
    ...
    def attach_iso_to_server(
        ...
        raw_response = self.raw.attach_iso_to_server(
            iso=iso,
            id=id,
        )
        if validate:
