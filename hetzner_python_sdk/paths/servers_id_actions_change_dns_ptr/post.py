...
from hetzner_python_sdk.model.server_actions_change_dns_ptr_response import ServerActionsChangeDnsPtrResponse as ServerActionsChangeDnsPtrResponseSchema
from hetzner_python_sdk.model.server_actions_change_dns_ptr_request import ServerActionsChangeDnsPtrRequest as ServerActionsChangeDnsPtrRequestSchema

from hetzner_python_sdk.type.server_actions_change_dns_ptr_response import ServerActionsChangeDnsPtrResponse
from hetzner_python_sdk.type.server_actions_change_dns_ptr_request import ServerActionsChangeDnsPtrRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_change_dns_ptr_request import ServerActionsChangeDnsPtrRequest as ServerActionsChangeDnsPtrRequestPydantic
from hetzner_python_sdk.pydantic.server_actions_change_dns_ptr_response import ServerActionsChangeDnsPtrResponse as ServerActionsChangeDnsPtrResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsChangeDnsPtrRequestSchema


request_body_server_actions_change_dns_ptr_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsChangeDnsPtrResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsChangeDnsPtrResponse
    ...
    async def _achange_dns_ptr_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/change_dns_ptr',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_change_dns_ptr_request.serialize(body, content_type)
...
class ChangeDnsPtr(BaseApi):
    ...
    async def achange_dns_ptr(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsChangeDnsPtrResponsePydantic:
        ...
        if validate:
            return ServerActionsChangeDnsPtrResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsChangeDnsPtrResponsePydantic, raw_response.body)
