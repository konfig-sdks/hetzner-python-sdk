...
from hetzner_python_sdk.model.image_actions_change_protection_response import ImageActionsChangeProtectionResponse as ImageActionsChangeProtectionResponseSchema
from hetzner_python_sdk.model.image_actions_change_protection_request import ImageActionsChangeProtectionRequest as ImageActionsChangeProtectionRequestSchema

from hetzner_python_sdk.type.image_actions_change_protection_response import ImageActionsChangeProtectionResponse
from hetzner_python_sdk.type.image_actions_change_protection_request import ImageActionsChangeProtectionRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.image_actions_change_protection_response import ImageActionsChangeProtectionResponse as ImageActionsChangeProtectionResponsePydantic
from hetzner_python_sdk.pydantic.image_actions_change_protection_request import ImageActionsChangeProtectionRequest as ImageActionsChangeProtectionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ImageActionsChangeProtectionRequestSchema


request_body_image_actions_change_protection_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ImageActionsChangeProtectionResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ImageActionsChangeProtectionResponse
    ...
    async def _achange_protection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/images/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_image_actions_change_protection_request.serialize(body, content_type)
...
class ChangeProtection(BaseApi):
    ...
    async def achange_protection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImageActionsChangeProtectionResponsePydantic:
        ...
        if validate:
            return ImageActionsChangeProtectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImageActionsChangeProtectionResponsePydantic, raw_response.body)
