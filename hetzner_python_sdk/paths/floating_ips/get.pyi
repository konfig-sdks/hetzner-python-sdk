...
from hetzner_python_sdk.model.floating_ips_get_all_response import FloatingIPsGetAllResponse as FloatingIPsGetAllResponseSchema

from hetzner_python_sdk.type.floating_ips_get_all_response import FloatingIPsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ips_get_all_response import FloatingIPsGetAllResponse as FloatingIPsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIPsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIPsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsGetAllResponsePydantic:
        ...
        if validate:
            return FloatingIPsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsGetAllResponsePydantic, raw_response.body)
