...
from hetzner_python_sdk.model.floating_ips_create_new_ip_request import FloatingIPsCreateNewIpRequest as FloatingIPsCreateNewIpRequestSchema
from hetzner_python_sdk.model.floating_ips_create_new_ip_response import FloatingIPsCreateNewIpResponse as FloatingIPsCreateNewIpResponseSchema

from hetzner_python_sdk.type.floating_ips_create_new_ip_response import FloatingIPsCreateNewIpResponse
from hetzner_python_sdk.type.floating_ips_create_new_ip_request import FloatingIPsCreateNewIpRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ips_create_new_ip_response import FloatingIPsCreateNewIpResponse as FloatingIPsCreateNewIpResponsePydantic
from hetzner_python_sdk.pydantic.floating_ips_create_new_ip_request import FloatingIPsCreateNewIpRequest as FloatingIPsCreateNewIpRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = FloatingIPsCreateNewIpRequestSchema


request_body_floating_ips_create_new_ip_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = FloatingIPsCreateNewIpResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIPsCreateNewIpResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_ip_mapped_args(
        self,
        type: str,
        description: typing.Optional[str] = None,
        home_location: typing.Optional[str] = None,
        ...
        if home_location is not None:
            _body["home_location"] = home_location
    ...
    async def _acreate_new_ip_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_floating_ips_create_new_ip_request.serialize(body, content_type)
...
class CreateNewIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_ip(
        self,
        type: str,
        description: typing.Optional[str] = None,
        home_location: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_ip_mapped_args(
            type=type,
        ...
        return await self._acreate_new_ip_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_ip(
        ...
        return self._create_new_ip_oapg(
            body=args.body,
        )

class CreateNewIp(BaseApi):
    ...
    async def acreate_new_ip(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsCreateNewIpResponsePydantic:
        raw_response = await self.raw.acreate_new_ip(
            type=type,
            description=description,
            home_location=home_location,
            labels=labels,
        ...
        if validate:
            return FloatingIPsCreateNewIpResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsCreateNewIpResponsePydantic, raw_response.body)
    ...
    def create_new_ip(
        ...
        raw_response = self.raw.create_new_ip(
            type=type,
            description=description,
            home_location=home_location,
            labels=labels,
