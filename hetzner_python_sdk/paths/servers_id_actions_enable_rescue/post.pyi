...
from hetzner_python_sdk.model.server_actions_enable_rescue_mode_request import ServerActionsEnableRescueModeRequest as ServerActionsEnableRescueModeRequestSchema
from hetzner_python_sdk.model.server_actions_enable_rescue_mode_response import ServerActionsEnableRescueModeResponse as ServerActionsEnableRescueModeResponseSchema
from hetzner_python_sdk.model.server_actions_enable_rescue_mode_request_ssh_keys import ServerActionsEnableRescueModeRequestSshKeys as ServerActionsEnableRescueModeRequestSshKeysSchema

from hetzner_python_sdk.type.server_actions_enable_rescue_mode_response import ServerActionsEnableRescueModeResponse
from hetzner_python_sdk.type.server_actions_enable_rescue_mode_request import ServerActionsEnableRescueModeRequest
from hetzner_python_sdk.type.server_actions_enable_rescue_mode_request_ssh_keys import ServerActionsEnableRescueModeRequestSshKeys

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_enable_rescue_mode_request import ServerActionsEnableRescueModeRequest as ServerActionsEnableRescueModeRequestPydantic
from hetzner_python_sdk.pydantic.server_actions_enable_rescue_mode_response import ServerActionsEnableRescueModeResponse as ServerActionsEnableRescueModeResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_enable_rescue_mode_request_ssh_keys import ServerActionsEnableRescueModeRequestSshKeys as ServerActionsEnableRescueModeRequestSshKeysPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsEnableRescueModeRequestSchema


request_body_server_actions_enable_rescue_mode_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsEnableRescueModeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsEnableRescueModeResponse
...
class BaseApi(api_client.Api):
    ...
    def _enable_rescue_mode_mapped_args(
        self,
        id: int,
        ssh_keys: typing.Optional[ServerActionsEnableRescueModeRequestSshKeys] = None,
    ...
    async def _aenable_rescue_mode_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/enable_rescue',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_enable_rescue_mode_request.serialize(body, content_type)
...
class EnableRescueModeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aenable_rescue_mode(
        self,
        id: int,
        ssh_keys: typing.Optional[ServerActionsEnableRescueModeRequestSshKeys] = None,
        type: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._enable_rescue_mode_mapped_args(
            id=id,
            ssh_keys=ssh_keys,
            type=type,
        )
        return await self._aenable_rescue_mode_oapg(
            body=args.body,
    ...
    def enable_rescue_mode(
        ...
        return self._enable_rescue_mode_oapg(
            body=args.body,
            path_params=args.path,
        )

class EnableRescueMode(BaseApi):
    ...
    async def aenable_rescue_mode(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsEnableRescueModeResponsePydantic:
        raw_response = await self.raw.aenable_rescue_mode(
            id=id,
            ssh_keys=ssh_keys,
            type=type,
            **kwargs,
        ...
        if validate:
            return ServerActionsEnableRescueModeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsEnableRescueModeResponsePydantic, raw_response.body)
    ...
    def enable_rescue_mode(
        ...
        raw_response = self.raw.enable_rescue_mode(
            id=id,
            ssh_keys=ssh_keys,
            type=type,
        )
