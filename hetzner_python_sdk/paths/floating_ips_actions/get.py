...
from hetzner_python_sdk.model.floating_ip_actions_get_all_actions_response import FloatingIpActionsGetAllActionsResponse as FloatingIpActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.floating_ip_actions_get_all_actions_response import FloatingIpActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_get_all_actions_response import FloatingIpActionsGetAllActionsResponse as FloatingIpActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIpActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIpActionsGetAllActionsResponse
    ...
    async def _aget_all_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return FloatingIpActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsGetAllActionsResponsePydantic, raw_response.body)
