...
from hetzner_python_sdk.model.server_actions_rebuild_server_from_image_response import ServerActionsRebuildServerFromImageResponse as ServerActionsRebuildServerFromImageResponseSchema
from hetzner_python_sdk.model.server_actions_rebuild_server_from_image_request import ServerActionsRebuildServerFromImageRequest as ServerActionsRebuildServerFromImageRequestSchema

from hetzner_python_sdk.type.server_actions_rebuild_server_from_image_response import ServerActionsRebuildServerFromImageResponse
from hetzner_python_sdk.type.server_actions_rebuild_server_from_image_request import ServerActionsRebuildServerFromImageRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_rebuild_server_from_image_response import ServerActionsRebuildServerFromImageResponse as ServerActionsRebuildServerFromImageResponsePydantic
from hetzner_python_sdk.pydantic.server_actions_rebuild_server_from_image_request import ServerActionsRebuildServerFromImageRequest as ServerActionsRebuildServerFromImageRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerActionsRebuildServerFromImageRequestSchema


request_body_server_actions_rebuild_server_from_image_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = ServerActionsRebuildServerFromImageResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsRebuildServerFromImageResponse
...
class BaseApi(api_client.Api):
    ...
    def _rebuild_server_from_image_mapped_args(
        self,
        image: str,
        id: int,
    ...
    async def _arebuild_server_from_image_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/rebuild',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_server_actions_rebuild_server_from_image_request.serialize(body, content_type)
    ...
    def _rebuild_server_from_image_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RebuildServerFromImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arebuild_server_from_image(
        self,
        image: str,
        id: int,
        **kwargs,
        ...
        args = self._rebuild_server_from_image_mapped_args(
            image=image,
            id=id,
        )
        return await self._arebuild_server_from_image_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def rebuild_server_from_image(
        self,
        image: str,
        id: int,
    ) -> typing.Union[
        ...
        return self._rebuild_server_from_image_oapg(
            body=args.body,
            path_params=args.path,
        )

class RebuildServerFromImage(BaseApi):
    ...
    async def arebuild_server_from_image(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsRebuildServerFromImageResponsePydantic:
        raw_response = await self.raw.arebuild_server_from_image(
            image=image,
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsRebuildServerFromImageResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsRebuildServerFromImageResponsePydantic, raw_response.body)
    ...
    def rebuild_server_from_image(
        ...
        raw_response = self.raw.rebuild_server_from_image(
            image=image,
            id=id,
        )
        if validate:
