...
from hetzner_python_sdk.model.primary_ips_get_all_response import PrimaryIPsGetAllResponse as PrimaryIPsGetAllResponseSchema

from hetzner_python_sdk.type.primary_ips_get_all_response import PrimaryIPsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ips_get_all_response import PrimaryIPsGetAllResponse as PrimaryIPsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PrimaryIPsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrimaryIPsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIPsGetAllResponsePydantic:
        ...
        if validate:
            return PrimaryIPsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIPsGetAllResponsePydantic, raw_response.body)
