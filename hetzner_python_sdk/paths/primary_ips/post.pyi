...
from hetzner_python_sdk.model.primary_ips_create_or_update_request import PrimaryIPsCreateOrUpdateRequest as PrimaryIPsCreateOrUpdateRequestSchema
from hetzner_python_sdk.model.primary_ips_create_or_update_response import PrimaryIPsCreateOrUpdateResponse as PrimaryIPsCreateOrUpdateResponseSchema

from hetzner_python_sdk.type.primary_ips_create_or_update_request import PrimaryIPsCreateOrUpdateRequest
from hetzner_python_sdk.type.primary_ips_create_or_update_response import PrimaryIPsCreateOrUpdateResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ips_create_or_update_request import PrimaryIPsCreateOrUpdateRequest as PrimaryIPsCreateOrUpdateRequestPydantic
from hetzner_python_sdk.pydantic.primary_ips_create_or_update_response import PrimaryIPsCreateOrUpdateResponse as PrimaryIPsCreateOrUpdateResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = PrimaryIPsCreateOrUpdateRequestSchema


request_body_primary_ips_create_or_update_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PrimaryIPsCreateOrUpdateResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PrimaryIPsCreateOrUpdateResponse
    ...
    async def _acreate_or_update_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_primary_ips_create_or_update_request.serialize(body, content_type)
...
class CreateOrUpdate(BaseApi):
    ...
    async def acreate_or_update(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIPsCreateOrUpdateResponsePydantic:
        ...
        if validate:
            return PrimaryIPsCreateOrUpdateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIPsCreateOrUpdateResponsePydantic, raw_response.body)
