...
from hetzner_python_sdk.model.server_actions_reset_server_response import ServerActionsResetServerResponse as ServerActionsResetServerResponseSchema

from hetzner_python_sdk.type.server_actions_reset_server_response import ServerActionsResetServerResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_reset_server_response import ServerActionsResetServerResponse as ServerActionsResetServerResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsResetServerResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsResetServerResponse
    ...
    async def _areset_server_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/reset',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ResetServerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_server(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._reset_server_mapped_args(
            id=id,
        )
        return await self._areset_server_oapg(
    ...
    def reset_server(
        ...
        return self._reset_server_oapg(
            path_params=args.path,
        )

class ResetServer(BaseApi):
    ...
    async def areset_server(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsResetServerResponsePydantic:
        raw_response = await self.raw.areset_server(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsResetServerResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsResetServerResponsePydantic, raw_response.body)
    ...
    def reset_server(
        ...
        raw_response = self.raw.reset_server(
            id=id,
        )
        if validate:
            return ServerActionsResetServerResponsePydantic(**raw_response.body)
