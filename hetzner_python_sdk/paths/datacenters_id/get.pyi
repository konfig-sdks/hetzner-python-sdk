...
from hetzner_python_sdk.model.datacenters_get_by_id_response import DatacentersGetByIdResponse as DatacentersGetByIdResponseSchema

from hetzner_python_sdk.type.datacenters_get_by_id_response import DatacentersGetByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.datacenters_get_by_id_response import DatacentersGetByIdResponse as DatacentersGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatacentersGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DatacentersGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatacentersGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return DatacentersGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatacentersGetByIdResponsePydantic, raw_response.body)
