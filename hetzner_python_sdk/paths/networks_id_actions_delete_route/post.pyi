...
from hetzner_python_sdk.model.network_actions_delete_route_request import NetworkActionsDeleteRouteRequest as NetworkActionsDeleteRouteRequestSchema
from hetzner_python_sdk.model.network_actions_delete_route_response import NetworkActionsDeleteRouteResponse as NetworkActionsDeleteRouteResponseSchema

from hetzner_python_sdk.type.network_actions_delete_route_request import NetworkActionsDeleteRouteRequest
from hetzner_python_sdk.type.network_actions_delete_route_response import NetworkActionsDeleteRouteResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.network_actions_delete_route_response import NetworkActionsDeleteRouteResponse as NetworkActionsDeleteRouteResponsePydantic
from hetzner_python_sdk.pydantic.network_actions_delete_route_request import NetworkActionsDeleteRouteRequest as NetworkActionsDeleteRouteRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = NetworkActionsDeleteRouteRequestSchema


request_body_network_actions_delete_route_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = NetworkActionsDeleteRouteResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: NetworkActionsDeleteRouteResponse
    ...
    async def _adelete_route_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/networks/{id}/actions/delete_route',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_network_actions_delete_route_request.serialize(body, content_type)
...
class DeleteRouteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_route(
        self,
        destination: str,
        gateway: str,
        id: int,
        **kwargs,
        ...
        args = self._delete_route_mapped_args(
            destination=destination,
            gateway=gateway,
            id=id,
        )
        return await self._adelete_route_oapg(
            body=args.body,
    ...
    def delete_route(
        ...
        return self._delete_route_oapg(
            body=args.body,
            path_params=args.path,
        )

class DeleteRoute(BaseApi):
    ...
    async def adelete_route(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkActionsDeleteRouteResponsePydantic:
        raw_response = await self.raw.adelete_route(
            destination=destination,
            gateway=gateway,
            id=id,
            **kwargs,
        ...
        if validate:
            return NetworkActionsDeleteRouteResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworkActionsDeleteRouteResponsePydantic, raw_response.body)
    ...
    def delete_route(
        ...
        raw_response = self.raw.delete_route(
            destination=destination,
            gateway=gateway,
            id=id,
        )
