...
from hetzner_python_sdk.model.load_balancer_actions_get_specific_action_response import LoadBalancerActionsGetSpecificActionResponse as LoadBalancerActionsGetSpecificActionResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_get_specific_action_response import LoadBalancerActionsGetSpecificActionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_get_specific_action_response import LoadBalancerActionsGetSpecificActionResponse as LoadBalancerActionsGetSpecificActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancerActionsGetSpecificActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancerActionsGetSpecificActionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_specific_action_mapped_args(
        self,
        id: int,
    ...
    async def _aget_specific_action_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSpecificActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_action(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_action_mapped_args(
            id=id,
        )
        return await self._aget_specific_action_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_action(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_action_oapg(
            path_params=args.path,
        )

class GetSpecificAction(BaseApi):
    ...
    async def aget_specific_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsGetSpecificActionResponsePydantic:
        raw_response = await self.raw.aget_specific_action(
            id=id,
            **kwargs,
        )
        if validate:
            return LoadBalancerActionsGetSpecificActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsGetSpecificActionResponsePydantic, raw_response.body)
    ...
    def get_specific_action(
        ...
        raw_response = self.raw.get_specific_action(
            id=id,
        )
        if validate:
            return LoadBalancerActionsGetSpecificActionResponsePydantic(**raw_response.body)
