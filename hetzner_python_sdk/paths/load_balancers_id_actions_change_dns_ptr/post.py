...
from hetzner_python_sdk.model.load_balancer_actions_change_dns_ptr_request import LoadBalancerActionsChangeDnsPtrRequest as LoadBalancerActionsChangeDnsPtrRequestSchema
from hetzner_python_sdk.model.load_balancer_actions_change_dns_ptr_response import LoadBalancerActionsChangeDnsPtrResponse as LoadBalancerActionsChangeDnsPtrResponseSchema

from hetzner_python_sdk.type.load_balancer_actions_change_dns_ptr_response import LoadBalancerActionsChangeDnsPtrResponse
from hetzner_python_sdk.type.load_balancer_actions_change_dns_ptr_request import LoadBalancerActionsChangeDnsPtrRequest

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.load_balancer_actions_change_dns_ptr_response import LoadBalancerActionsChangeDnsPtrResponse as LoadBalancerActionsChangeDnsPtrResponsePydantic
from hetzner_python_sdk.pydantic.load_balancer_actions_change_dns_ptr_request import LoadBalancerActionsChangeDnsPtrRequest as LoadBalancerActionsChangeDnsPtrRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancerActionsChangeDnsPtrRequestSchema


request_body_load_balancer_actions_change_dns_ptr_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = LoadBalancerActionsChangeDnsPtrResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: LoadBalancerActionsChangeDnsPtrResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_dns_ptr_mapped_args(
        self,
        dns_ptr: typing.Optional[str],
        ip: str,
        id: int,
    ...
    async def _achange_dns_ptr_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/load_balancers/{id}/actions/change_dns_ptr',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_load_balancer_actions_change_dns_ptr_request.serialize(body, content_type)
...
class ChangeDnsPtrRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_dns_ptr(
        self,
        dns_ptr: typing.Optional[str],
        ip: str,
        id: int,
        **kwargs,
        ...
        args = self._change_dns_ptr_mapped_args(
            dns_ptr=dns_ptr,
            ip=ip,
            id=id,
        )
        return await self._achange_dns_ptr_oapg(
            body=args.body,
    ...
    def change_dns_ptr(
        ...
        return self._change_dns_ptr_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeDnsPtr(BaseApi):
    ...
    async def achange_dns_ptr(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancerActionsChangeDnsPtrResponsePydantic:
        raw_response = await self.raw.achange_dns_ptr(
            dns_ptr=dns_ptr,
            ip=ip,
            id=id,
            **kwargs,
        ...
        if validate:
            return LoadBalancerActionsChangeDnsPtrResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancerActionsChangeDnsPtrResponsePydantic, raw_response.body)
    ...
    def change_dns_ptr(
        ...
        raw_response = self.raw.change_dns_ptr(
            dns_ptr=dns_ptr,
            ip=ip,
            id=id,
        )
