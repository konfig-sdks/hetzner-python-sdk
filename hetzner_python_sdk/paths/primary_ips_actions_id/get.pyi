...
from hetzner_python_sdk.model.primary_ip_actions_get_action_by_id_response import PrimaryIpActionsGetActionByIdResponse as PrimaryIpActionsGetActionByIdResponseSchema

from hetzner_python_sdk.type.primary_ip_actions_get_action_by_id_response import PrimaryIpActionsGetActionByIdResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_get_action_by_id_response import PrimaryIpActionsGetActionByIdResponse as PrimaryIpActionsGetActionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PrimaryIpActionsGetActionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrimaryIpActionsGetActionByIdResponse
    ...
    async def _aget_action_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionById(BaseApi):
    ...
    async def aget_action_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsGetActionByIdResponsePydantic:
        raw_response = await self.raw.aget_action_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return PrimaryIpActionsGetActionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsGetActionByIdResponsePydantic, raw_response.body)
