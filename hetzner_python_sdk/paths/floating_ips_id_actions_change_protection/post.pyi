...
from hetzner_python_sdk.model.floating_ip_actions_change_protection_response import FloatingIpActionsChangeProtectionResponse as FloatingIpActionsChangeProtectionResponseSchema
from hetzner_python_sdk.model.floating_ip_actions_change_protection_request import FloatingIpActionsChangeProtectionRequest as FloatingIpActionsChangeProtectionRequestSchema

from hetzner_python_sdk.type.floating_ip_actions_change_protection_request import FloatingIpActionsChangeProtectionRequest
from hetzner_python_sdk.type.floating_ip_actions_change_protection_response import FloatingIpActionsChangeProtectionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.floating_ip_actions_change_protection_request import FloatingIpActionsChangeProtectionRequest as FloatingIpActionsChangeProtectionRequestPydantic
from hetzner_python_sdk.pydantic.floating_ip_actions_change_protection_response import FloatingIpActionsChangeProtectionResponse as FloatingIpActionsChangeProtectionResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FloatingIpActionsChangeProtectionRequestSchema


request_body_floating_ip_actions_change_protection_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = FloatingIpActionsChangeProtectionResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIpActionsChangeProtectionResponse
    ...
    async def _achange_protection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/floating_ips/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_floating_ip_actions_change_protection_request.serialize(body, content_type)
...
class ChangeProtection(BaseApi):
    ...
    async def achange_protection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIpActionsChangeProtectionResponsePydantic:
        ...
        if validate:
            return FloatingIpActionsChangeProtectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIpActionsChangeProtectionResponsePydantic, raw_response.body)
