...
from hetzner_python_sdk.model.networks_get_all_response import NetworksGetAllResponse as NetworksGetAllResponseSchema

from hetzner_python_sdk.type.networks_get_all_response import NetworksGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.networks_get_all_response import NetworksGetAllResponse as NetworksGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NetworksGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NetworksGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworksGetAllResponsePydantic:
        ...
        if validate:
            return NetworksGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NetworksGetAllResponsePydantic, raw_response.body)
