...
from hetzner_python_sdk.model.is_os_get_all_response import IsOsGetAllResponse as IsOsGetAllResponseSchema

from hetzner_python_sdk.type.is_os_get_all_response import IsOsGetAllResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.is_os_get_all_response import IsOsGetAllResponse as IsOsGetAllResponsePydantic
...
IncludeArchitectureWildcardSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'include_architecture_wildcard': typing.Union[IncludeArchitectureWildcardSchema, bool, ],
...
request_query_include_architecture_wildcard = api_client.QueryParameter(
    name="include_architecture_wildcard",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeArchitectureWildcardSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = IsOsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: IsOsGetAllResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        ...
        include_architecture_wildcard: typing.Optional[bool] = None,
        ...
        if include_architecture_wildcard is not None:
            _query_params["include_architecture_wildcard"] = include_architecture_wildcard
        if page is not None:
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_include_architecture_wildcard,
            request_query_page,
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return IsOsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(IsOsGetAllResponsePydantic, raw_response.body)
