...
from hetzner_python_sdk.model.volume_actions_change_protection_volume_request import VolumeActionsChangeProtectionVolumeRequest as VolumeActionsChangeProtectionVolumeRequestSchema
from hetzner_python_sdk.model.volume_actions_change_protection_volume_response import VolumeActionsChangeProtectionVolumeResponse as VolumeActionsChangeProtectionVolumeResponseSchema

from hetzner_python_sdk.type.volume_actions_change_protection_volume_request import VolumeActionsChangeProtectionVolumeRequest
from hetzner_python_sdk.type.volume_actions_change_protection_volume_response import VolumeActionsChangeProtectionVolumeResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.volume_actions_change_protection_volume_request import VolumeActionsChangeProtectionVolumeRequest as VolumeActionsChangeProtectionVolumeRequestPydantic
from hetzner_python_sdk.pydantic.volume_actions_change_protection_volume_response import VolumeActionsChangeProtectionVolumeResponse as VolumeActionsChangeProtectionVolumeResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = VolumeActionsChangeProtectionVolumeRequestSchema


request_body_volume_actions_change_protection_volume_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = VolumeActionsChangeProtectionVolumeResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: VolumeActionsChangeProtectionVolumeResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_protection_volume_mapped_args(
        self,
        id: int,
    ...
    async def _achange_protection_volume_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/volumes/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_volume_actions_change_protection_volume_request.serialize(body, content_type)
    ...
    def _change_protection_volume_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ChangeProtectionVolumeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_protection_volume(
        self,
        id: int,
        delete: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._change_protection_volume_mapped_args(
            id=id,
            delete=delete,
        )
        return await self._achange_protection_volume_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def change_protection_volume(
        self,
        id: int,
        delete: typing.Optional[bool] = None,
    ) -> typing.Union[
        ...
        return self._change_protection_volume_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeProtectionVolume(BaseApi):
    ...
    async def achange_protection_volume(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsChangeProtectionVolumeResponsePydantic:
        raw_response = await self.raw.achange_protection_volume(
            id=id,
            delete=delete,
            **kwargs,
        )
        if validate:
            return VolumeActionsChangeProtectionVolumeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumeActionsChangeProtectionVolumeResponsePydantic, raw_response.body)
    ...
    def change_protection_volume(
        ...
        raw_response = self.raw.change_protection_volume(
            id=id,
            delete=delete,
        )
        if validate:
