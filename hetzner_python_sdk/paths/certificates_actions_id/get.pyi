...
from hetzner_python_sdk.model.certificate_actions_get_action_response import CertificateActionsGetActionResponse as CertificateActionsGetActionResponseSchema

from hetzner_python_sdk.type.certificate_actions_get_action_response import CertificateActionsGetActionResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.certificate_actions_get_action_response import CertificateActionsGetActionResponse as CertificateActionsGetActionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CertificateActionsGetActionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CertificateActionsGetActionResponse
    ...
    async def _aget_action_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/certificates/actions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAction(BaseApi):
    ...
    async def aget_action(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificateActionsGetActionResponsePydantic:
        raw_response = await self.raw.aget_action(
            id=id,
            **kwargs,
        )
        if validate:
            return CertificateActionsGetActionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificateActionsGetActionResponsePydantic, raw_response.body)
