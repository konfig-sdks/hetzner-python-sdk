...
from hetzner_python_sdk.model.primary_ip_actions_change_protection_primary_ip_response import PrimaryIpActionsChangeProtectionPrimaryIpResponse as PrimaryIpActionsChangeProtectionPrimaryIpResponseSchema
from hetzner_python_sdk.model.primary_ip_actions_change_protection_primary_ip_request import PrimaryIpActionsChangeProtectionPrimaryIpRequest as PrimaryIpActionsChangeProtectionPrimaryIpRequestSchema

from hetzner_python_sdk.type.primary_ip_actions_change_protection_primary_ip_request import PrimaryIpActionsChangeProtectionPrimaryIpRequest
from hetzner_python_sdk.type.primary_ip_actions_change_protection_primary_ip_response import PrimaryIpActionsChangeProtectionPrimaryIpResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.primary_ip_actions_change_protection_primary_ip_response import PrimaryIpActionsChangeProtectionPrimaryIpResponse as PrimaryIpActionsChangeProtectionPrimaryIpResponsePydantic
from hetzner_python_sdk.pydantic.primary_ip_actions_change_protection_primary_ip_request import PrimaryIpActionsChangeProtectionPrimaryIpRequest as PrimaryIpActionsChangeProtectionPrimaryIpRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PrimaryIpActionsChangeProtectionPrimaryIpRequestSchema


request_body_primary_ip_actions_change_protection_primary_ip_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PrimaryIpActionsChangeProtectionPrimaryIpResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: PrimaryIpActionsChangeProtectionPrimaryIpResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_protection_primary_ip_mapped_args(
        self,
        id: int,
    ...
    async def _achange_protection_primary_ip_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/primary_ips/{id}/actions/change_protection',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_primary_ip_actions_change_protection_primary_ip_request.serialize(body, content_type)
    ...
    def _change_protection_primary_ip_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ChangeProtectionPrimaryIpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achange_protection_primary_ip(
        self,
        id: int,
        delete: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._change_protection_primary_ip_mapped_args(
            id=id,
            delete=delete,
        )
        return await self._achange_protection_primary_ip_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def change_protection_primary_ip(
        self,
        id: int,
        delete: typing.Optional[bool] = None,
    ) -> typing.Union[
        ...
        return self._change_protection_primary_ip_oapg(
            body=args.body,
            path_params=args.path,
        )

class ChangeProtectionPrimaryIp(BaseApi):
    ...
    async def achange_protection_primary_ip(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PrimaryIpActionsChangeProtectionPrimaryIpResponsePydantic:
        raw_response = await self.raw.achange_protection_primary_ip(
            id=id,
            delete=delete,
            **kwargs,
        )
        if validate:
            return PrimaryIpActionsChangeProtectionPrimaryIpResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PrimaryIpActionsChangeProtectionPrimaryIpResponsePydantic, raw_response.body)
    ...
    def change_protection_primary_ip(
        ...
        raw_response = self.raw.change_protection_primary_ip(
            id=id,
            delete=delete,
        )
        if validate:
