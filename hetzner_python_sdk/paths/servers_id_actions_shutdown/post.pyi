...
from hetzner_python_sdk.model.server_actions_graceful_shutdown_response import ServerActionsGracefulShutdownResponse as ServerActionsGracefulShutdownResponseSchema

from hetzner_python_sdk.type.server_actions_graceful_shutdown_response import ServerActionsGracefulShutdownResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_graceful_shutdown_response import ServerActionsGracefulShutdownResponse as ServerActionsGracefulShutdownResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = ServerActionsGracefulShutdownResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ServerActionsGracefulShutdownResponse
...
class BaseApi(api_client.Api):
    ...
    def _graceful_shutdown_mapped_args(
        self,
        id: int,
    ...
    async def _agraceful_shutdown_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions/shutdown',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GracefulShutdownRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agraceful_shutdown(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._graceful_shutdown_mapped_args(
            id=id,
        )
        return await self._agraceful_shutdown_oapg(
    ...
    def graceful_shutdown(
        ...
        return self._graceful_shutdown_oapg(
            path_params=args.path,
        )

class GracefulShutdown(BaseApi):
    ...
    async def agraceful_shutdown(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsGracefulShutdownResponsePydantic:
        raw_response = await self.raw.agraceful_shutdown(
            id=id,
            **kwargs,
        )
        if validate:
            return ServerActionsGracefulShutdownResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsGracefulShutdownResponsePydantic, raw_response.body)
    ...
    def graceful_shutdown(
        ...
        raw_response = self.raw.graceful_shutdown(
            id=id,
        )
        if validate:
            return ServerActionsGracefulShutdownResponsePydantic(**raw_response.body)
