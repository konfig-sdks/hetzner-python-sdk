...
from hetzner_python_sdk.model.server_actions_get_all_actions_response import ServerActionsGetAllActionsResponse as ServerActionsGetAllActionsResponseSchema

from hetzner_python_sdk.type.server_actions_get_all_actions_response import ServerActionsGetAllActionsResponse

from ...api_client import Dictionary
from hetzner_python_sdk.pydantic.server_actions_get_all_actions_response import ServerActionsGetAllActionsResponse as ServerActionsGetAllActionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ServerActionsGetAllActionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerActionsGetAllActionsResponse
    ...
    async def _aget_all_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/servers/{id}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllActions(BaseApi):
    ...
    async def aget_all_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerActionsGetAllActionsResponsePydantic:
        ...
        if validate:
            return ServerActionsGetAllActionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerActionsGetAllActionsResponsePydantic, raw_response.body)
