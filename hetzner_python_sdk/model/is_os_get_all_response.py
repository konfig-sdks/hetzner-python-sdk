...
class IsOsGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def isos() -> typing.Type['IsOsGetAllResponseIsos']:
                return IsOsGetAllResponseIsos
        
            @staticmethod
            def meta() -> typing.Type['IsOsGetAllResponseMeta']:
                return IsOsGetAllResponseMeta
            __annotations__ = {
                "isos": isos,
                "meta": meta,
            }
    
    isos: 'IsOsGetAllResponseIsos'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["isos"]) -> 'IsOsGetAllResponseIsos': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'IsOsGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isos", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["isos"]) -> 'IsOsGetAllResponseIsos': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['IsOsGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isos", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        isos: 'IsOsGetAllResponseIsos',
        meta: typing.Union['IsOsGetAllResponseMeta', schemas.Unset] = schemas.unset,
