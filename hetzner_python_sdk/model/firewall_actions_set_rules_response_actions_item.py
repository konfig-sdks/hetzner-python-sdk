...
class FirewallActionsSetRulesResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['FirewallActionsSetRulesResponseActionsItemError']:
                return FirewallActionsSetRulesResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['FirewallActionsSetRulesResponseActionsItemResources']:
                return FirewallActionsSetRulesResponseActionsItemResources
    ...
    resources: 'FirewallActionsSetRulesResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'FirewallActionsSetRulesResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsSetRulesResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsSetRulesResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsSetRulesResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsSetRulesResponseActionsItemResources': ...
    ...
    ) -> 'FirewallActionsSetRulesResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
