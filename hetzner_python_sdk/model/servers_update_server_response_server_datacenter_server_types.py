...
class ServersUpdateServerResponseServerDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['ServersUpdateServerResponseServerDatacenterServerTypesAvailable']:
                return ServersUpdateServerResponseServerDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['ServersUpdateServerResponseServerDatacenterServerTypesAvailableForMigration']:
                return ServersUpdateServerResponseServerDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['ServersUpdateServerResponseServerDatacenterServerTypesSupported']:
                return ServersUpdateServerResponseServerDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'ServersUpdateServerResponseServerDatacenterServerTypesAvailableForMigration'
    available: 'ServersUpdateServerResponseServerDatacenterServerTypesAvailable'
    supported: 'ServersUpdateServerResponseServerDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'ServersUpdateServerResponseServerDatacenterServerTypesSupported': ...
    ...
    ) -> 'ServersUpdateServerResponseServerDatacenterServerTypes':
