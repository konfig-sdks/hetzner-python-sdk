...
class LoadBalancerActionsGetAllActions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['LoadBalancerActionsGetAllActions200ResponseActions']:
                return LoadBalancerActionsGetAllActions200ResponseActions
        
            @staticmethod
            def meta() -> typing.Type['LoadBalancerActionsGetAllActions200ResponseMeta']:
                return LoadBalancerActionsGetAllActions200ResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'LoadBalancerActionsGetAllActions200ResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'LoadBalancerActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'LoadBalancerActionsGetAllActions200ResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["actions", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'LoadBalancerActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['LoadBalancerActionsGetAllActions200ResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["actions", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'LoadBalancerActionsGetAllActions200ResponseActions',
        meta: typing.Union['LoadBalancerActionsGetAllActions200ResponseMeta', schemas.Unset] = schemas.unset,
