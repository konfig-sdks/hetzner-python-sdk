...
class PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly']:
                return PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceMonthly']:
                return PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceMonthly': ...
    ...
    ) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItem':
