...
class ServersGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def servers() -> typing.Type['ServersGetAllResponseServers']:
                return ServersGetAllResponseServers
        
            @staticmethod
            def meta() -> typing.Type['ServersGetAllResponseMeta']:
                return ServersGetAllResponseMeta
            __annotations__ = {
                "servers": servers,
                "meta": meta,
            }
    
    servers: 'ServersGetAllResponseServers'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["servers"]) -> 'ServersGetAllResponseServers': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'ServersGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["servers", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["servers"]) -> 'ServersGetAllResponseServers': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['ServersGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["servers", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        servers: 'ServersGetAllResponseServers',
        meta: typing.Union['ServersGetAllResponseMeta', schemas.Unset] = schemas.unset,
