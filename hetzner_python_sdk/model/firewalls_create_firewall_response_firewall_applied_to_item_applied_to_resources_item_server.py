...
class FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResourcesItemServer(
    schemas.DictSchema
):
    """
    ...
    ) -> 'FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResourcesItemServer':
