...
class PrimaryIpActionsGetAllActionsResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['PrimaryIpActionsGetAllActionsResponseActionsItemError']:
                return PrimaryIpActionsGetAllActionsResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['PrimaryIpActionsGetAllActionsResponseActionsItemResources']:
                return PrimaryIpActionsGetAllActionsResponseActionsItemResources
    ...
    resources: 'PrimaryIpActionsGetAllActionsResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'PrimaryIpActionsGetAllActionsResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'PrimaryIpActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'PrimaryIpActionsGetAllActionsResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'PrimaryIpActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'PrimaryIpActionsGetAllActionsResponseActionsItemResources': ...
    ...
    ) -> 'PrimaryIpActionsGetAllActionsResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
