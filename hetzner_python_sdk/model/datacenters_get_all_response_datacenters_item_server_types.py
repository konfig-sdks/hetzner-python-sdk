...
class DatacentersGetAllResponseDatacentersItemServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['DatacentersGetAllResponseDatacentersItemServerTypesAvailable']:
                return DatacentersGetAllResponseDatacentersItemServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['DatacentersGetAllResponseDatacentersItemServerTypesAvailableForMigration']:
                return DatacentersGetAllResponseDatacentersItemServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['DatacentersGetAllResponseDatacentersItemServerTypesSupported']:
                return DatacentersGetAllResponseDatacentersItemServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'DatacentersGetAllResponseDatacentersItemServerTypesAvailableForMigration'
    available: 'DatacentersGetAllResponseDatacentersItemServerTypesAvailable'
    supported: 'DatacentersGetAllResponseDatacentersItemServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'DatacentersGetAllResponseDatacentersItemServerTypesSupported': ...
    ...
    ) -> 'DatacentersGetAllResponseDatacentersItemServerTypes':
