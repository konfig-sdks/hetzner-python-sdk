...
class SshKeysCreateKeyResponseSshKey(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def labels() -> typing.Type['SshKeysCreateKeyResponseSshKeyLabels']:
                return SshKeysCreateKeyResponseSshKeyLabels
    ...
    labels: 'SshKeysCreateKeyResponseSshKeyLabels'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysCreateKeyResponseSshKeyLabels': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysCreateKeyResponseSshKeyLabels': ...
    ...
    ) -> 'SshKeysCreateKeyResponseSshKey':
