...
class CertificateActionsGetAllActionsResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['CertificateActionsGetAllActionsResponseActionsItemError']:
                return CertificateActionsGetAllActionsResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['CertificateActionsGetAllActionsResponseActionsItemResources']:
                return CertificateActionsGetAllActionsResponseActionsItemResources
    ...
    resources: 'CertificateActionsGetAllActionsResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'CertificateActionsGetAllActionsResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'CertificateActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'CertificateActionsGetAllActionsResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'CertificateActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'CertificateActionsGetAllActionsResponseActionsItemResources': ...
    ...
    ) -> 'CertificateActionsGetAllActionsResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
