...
class ServersGetServerResponseServerIso(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def deprecation() -> typing.Type['ServersGetServerResponseServerIsoDeprecation']:
                return ServersGetServerResponseServerIsoDeprecation
    ...
    deprecation: 'ServersGetServerResponseServerIsoDeprecation'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deprecation"]) -> 'ServersGetServerResponseServerIsoDeprecation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deprecation"]) -> 'ServersGetServerResponseServerIsoDeprecation': ...
