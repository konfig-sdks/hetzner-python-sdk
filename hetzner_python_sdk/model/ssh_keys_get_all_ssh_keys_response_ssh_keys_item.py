...
class SshKeysGetAllSshKeysResponseSshKeysItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def labels() -> typing.Type['SshKeysGetAllSshKeysResponseSshKeysItemLabels']:
                return SshKeysGetAllSshKeysResponseSshKeysItemLabels
    ...
    labels: 'SshKeysGetAllSshKeysResponseSshKeysItemLabels'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysGetAllSshKeysResponseSshKeysItemLabels': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "fingerprint", "id", "labels", "name", "public_key", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysGetAllSshKeysResponseSshKeysItemLabels': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "fingerprint", "id", "labels", "name", "public_key", ], str]):
    ...
    ) -> 'SshKeysGetAllSshKeysResponseSshKeysItem':
