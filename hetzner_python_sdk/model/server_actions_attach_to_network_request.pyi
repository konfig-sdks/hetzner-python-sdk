...
class ServerActionsAttachToNetworkRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def alias_ips() -> typing.Type['ServerActionsAttachToNetworkRequestAliasIps']:
                return ServerActionsAttachToNetworkRequestAliasIps
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["alias_ips"]) -> 'ServerActionsAttachToNetworkRequestAliasIps': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["network", "alias_ips", "ip", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["alias_ips"]) -> typing.Union['ServerActionsAttachToNetworkRequestAliasIps', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["network", "alias_ips", "ip", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        alias_ips: typing.Union['ServerActionsAttachToNetworkRequestAliasIps', schemas.Unset] = schemas.unset,
