...
class LoadBalancersCreateLoadBalancerRequestTargetsItemTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersCreateLoadBalancerRequestTargetsItemTargetsItemHealthStatusItem':
