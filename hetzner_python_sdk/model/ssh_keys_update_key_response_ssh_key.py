...
class SshKeysUpdateKeyResponseSshKey(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def labels() -> typing.Type['SshKeysUpdateKeyResponseSshKeyLabels']:
                return SshKeysUpdateKeyResponseSshKeyLabels
    ...
    labels: 'SshKeysUpdateKeyResponseSshKeyLabels'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysUpdateKeyResponseSshKeyLabels': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysUpdateKeyResponseSshKeyLabels': ...
