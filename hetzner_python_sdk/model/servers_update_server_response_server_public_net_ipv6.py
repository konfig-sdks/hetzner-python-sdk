...
class ServersUpdateServerResponseServerPublicNetIpv6(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def dns_ptr() -> typing.Type['ServersUpdateServerResponseServerPublicNetIpv6DnsPtr']:
                return ServersUpdateServerResponseServerPublicNetIpv6DnsPtr
    ...
    dns_ptr: 'ServersUpdateServerResponseServerPublicNetIpv6DnsPtr'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocked"]) -> MetaOapg.properties.blocked: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dns_ptr"]) -> 'ServersUpdateServerResponseServerPublicNetIpv6DnsPtr': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dns_ptr"]) -> 'ServersUpdateServerResponseServerPublicNetIpv6DnsPtr': ...
