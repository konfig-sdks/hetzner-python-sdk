...
class LoadBalancersGetMetricsResponseMetrics(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def time_series() -> typing.Type['LoadBalancersGetMetricsResponseMetricsTimeSeries']:
                return LoadBalancersGetMetricsResponseMetricsTimeSeries
            __annotations__ = {
                "end": end,
                "start": start,
                "step": step,
    ...
    time_series: 'LoadBalancersGetMetricsResponseMetricsTimeSeries'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time_series"]) -> 'LoadBalancersGetMetricsResponseMetricsTimeSeries': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time_series"]) -> 'LoadBalancersGetMetricsResponseMetricsTimeSeries': ...
