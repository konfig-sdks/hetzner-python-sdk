...
class VolumesGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def volumes() -> typing.Type['VolumesGetAllResponseVolumes']:
                return VolumesGetAllResponseVolumes
        
            @staticmethod
            def meta() -> typing.Type['VolumesGetAllResponseMeta']:
                return VolumesGetAllResponseMeta
            __annotations__ = {
                "volumes": volumes,
                "meta": meta,
            }
    
    volumes: 'VolumesGetAllResponseVolumes'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["volumes"]) -> 'VolumesGetAllResponseVolumes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'VolumesGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["volumes", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["volumes"]) -> 'VolumesGetAllResponseVolumes': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['VolumesGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["volumes", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        volumes: 'VolumesGetAllResponseVolumes',
        meta: typing.Union['VolumesGetAllResponseMeta', schemas.Unset] = schemas.unset,
