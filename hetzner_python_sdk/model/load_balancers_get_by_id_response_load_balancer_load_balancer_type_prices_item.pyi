...
class LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly']:
                return LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly']:
                return LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    ) -> 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesItem':
