...
class LoadBalancersCreateLoadBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["listen_port", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["listen_port", "status", ], str]):
    ...
    ) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem':
