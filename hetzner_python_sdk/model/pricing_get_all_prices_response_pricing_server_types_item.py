...
class PricingGetAllPricesResponsePricingServerTypesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prices() -> typing.Type['PricingGetAllPricesResponsePricingServerTypesItemPrices']:
                return PricingGetAllPricesResponsePricingServerTypesItemPrices
            __annotations__ = {
                "id": id,
                "name": name,
                "prices": prices,
    ...
    prices: 'PricingGetAllPricesResponsePricingServerTypesItemPrices'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prices"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPrices': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prices"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPrices': ...
    ...
    ) -> 'PricingGetAllPricesResponsePricingServerTypesItem':
