...
class LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly']:
                return LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly']:
                return LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItem':
