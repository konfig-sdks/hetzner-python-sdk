...
class LoadBalancerActionsGetAllActions200ResponseMetaPagination(
    schemas.DictSchema
):
    """
    ...
    previous_page: MetaOapg.properties.previous_page
    total_entries: MetaOapg.properties.total_entries
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["total_entries"]) -> MetaOapg.properties.total_entries: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["last_page", "next_page", "page", "per_page", "previous_page", "total_entries", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["previous_page"]) -> MetaOapg.properties.previous_page: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["total_entries"]) -> MetaOapg.properties.total_entries: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["last_page", "next_page", "page", "per_page", "previous_page", "total_entries", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        next_page: typing.Union[MetaOapg.properties.next_page, None, decimal.Decimal, int, ],
        per_page: typing.Union[MetaOapg.properties.per_page, decimal.Decimal, int, ],
        last_page: typing.Union[MetaOapg.properties.last_page, None, decimal.Decimal, int, ],
        page: typing.Union[MetaOapg.properties.page, decimal.Decimal, int, ],
        previous_page: typing.Union[MetaOapg.properties.previous_page, None, decimal.Decimal, int, ],
        total_entries: typing.Union[MetaOapg.properties.total_entries, None, decimal.Decimal, int, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LoadBalancerActionsGetAllActions200ResponseMetaPagination':
        return super().__new__(
            cls,
            *args,
            next_page=next_page,
