...
class PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailable']:
                return PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailableForMigration']:
                return PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesSupported']:
                return PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailableForMigration'
    available: 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailable'
    supported: 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypesSupported': ...
    ...
    ) -> 'PrimaryIPsGetAllResponsePrimaryIpsItemDatacenterServerTypes':
