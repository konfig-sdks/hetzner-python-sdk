...
class ServersUpdateServerResponseServerPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def floating_ips() -> typing.Type['ServersUpdateServerResponseServerPublicNetFloatingIps']:
                return ServersUpdateServerResponseServerPublicNetFloatingIps
        
            @staticmethod
            def ipv4() -> typing.Type['ServersUpdateServerResponseServerPublicNetIpv4']:
                return ServersUpdateServerResponseServerPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['ServersUpdateServerResponseServerPublicNetIpv6']:
                return ServersUpdateServerResponseServerPublicNetIpv6
        
            @staticmethod
            def firewalls() -> typing.Type['ServersUpdateServerResponseServerPublicNetFirewalls']:
                return ServersUpdateServerResponseServerPublicNetFirewalls
            __annotations__ = {
    ...
    ipv4: 'ServersUpdateServerResponseServerPublicNetIpv4'
    ipv6: 'ServersUpdateServerResponseServerPublicNetIpv6'
    floating_ips: 'ServersUpdateServerResponseServerPublicNetFloatingIps'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersUpdateServerResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersUpdateServerResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersUpdateServerResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firewalls"]) -> 'ServersUpdateServerResponseServerPublicNetFirewalls': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersUpdateServerResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersUpdateServerResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersUpdateServerResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firewalls"]) -> typing.Union['ServersUpdateServerResponseServerPublicNetFirewalls', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ipv6: 'ServersUpdateServerResponseServerPublicNetIpv6',
        floating_ips: 'ServersUpdateServerResponseServerPublicNetFloatingIps',
        firewalls: typing.Union['ServersUpdateServerResponseServerPublicNetFirewalls', schemas.Unset] = schemas.unset,
