...
class LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            max_assigned_certificates = schemas.Int64Schema
            max_connections = schemas.Int64Schema
            max_services = schemas.Int64Schema
            max_targets = schemas.Int64Schema
            name = schemas.StrSchema
        
            @staticmethod
            def prices() -> typing.Type['LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices']:
                return LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices
            __annotations__ = {
    ...
    max_targets: MetaOapg.properties.max_targets
    max_connections: MetaOapg.properties.max_connections
    max_assigned_certificates: MetaOapg.properties.max_assigned_certificates
    deprecated: MetaOapg.properties.deprecated
    name: MetaOapg.properties.name
    description: MetaOapg.properties.description
    id: MetaOapg.properties.id
    max_services: MetaOapg.properties.max_services
    prices: 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["max_assigned_certificates"]) -> MetaOapg.properties.max_assigned_certificates: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["max_connections"]) -> MetaOapg.properties.max_connections: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["max_services"]) -> MetaOapg.properties.max_services: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["max_targets"]) -> MetaOapg.properties.max_targets: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> MetaOapg.properties.name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "deprecated", "id", "max_assigned_certificates", "max_connections", "max_services", "max_targets", "name", "prices", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_assigned_certificates"]) -> MetaOapg.properties.max_assigned_certificates: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_connections"]) -> MetaOapg.properties.max_connections: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_services"]) -> MetaOapg.properties.max_services: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_targets"]) -> MetaOapg.properties.max_targets: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> MetaOapg.properties.name: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "deprecated", "id", "max_assigned_certificates", "max_connections", "max_services", "max_targets", "name", "prices", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        max_targets: typing.Union[MetaOapg.properties.max_targets, decimal.Decimal, int, ],
        max_connections: typing.Union[MetaOapg.properties.max_connections, decimal.Decimal, int, ],
        max_assigned_certificates: typing.Union[MetaOapg.properties.max_assigned_certificates, decimal.Decimal, int, ],
        deprecated: typing.Union[MetaOapg.properties.deprecated, None, str, ],
        name: typing.Union[MetaOapg.properties.name, str, ],
        description: typing.Union[MetaOapg.properties.description, str, ],
        id: typing.Union[MetaOapg.properties.id, decimal.Decimal, int, ],
        max_services: typing.Union[MetaOapg.properties.max_services, decimal.Decimal, int, ],
        prices: 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePrices',
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType':
        return super().__new__(
            cls,
            *args,
            max_targets=max_targets,
