...
class NetworkActionsGetAllActions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['NetworkActionsGetAllActions200ResponseActions']:
                return NetworkActionsGetAllActions200ResponseActions
        
            @staticmethod
            def meta() -> typing.Type['NetworkActionsGetAllActions200ResponseMeta']:
                return NetworkActionsGetAllActions200ResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'NetworkActionsGetAllActions200ResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'NetworkActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'NetworkActionsGetAllActions200ResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'NetworkActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['NetworkActionsGetAllActions200ResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'NetworkActionsGetAllActions200ResponseActions',
        meta: typing.Union['NetworkActionsGetAllActions200ResponseMeta', schemas.Unset] = schemas.unset,
