...
class ServersCreateServerActionResponseAction(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ServersCreateServerActionResponseActionError']:
                return ServersCreateServerActionResponseActionError
            ...
            @staticmethod
            def resources() -> typing.Type['ServersCreateServerActionResponseActionResources']:
                return ServersCreateServerActionResponseActionResources
    ...
    resources: 'ServersCreateServerActionResponseActionResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'ServersCreateServerActionResponseActionError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ServersCreateServerActionResponseActionError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'ServersCreateServerActionResponseActionResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'ServersCreateServerActionResponseActionError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'ServersCreateServerActionResponseActionResources': ...
    ...
    ) -> 'ServersCreateServerActionResponseAction':
        return super().__new__(
            cls,
            *args,
            progress=progress,
