...
class ServersCreateServerActionResponseServerPublicNetIpv6(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def dns_ptr() -> typing.Type['ServersCreateServerActionResponseServerPublicNetIpv6DnsPtr']:
                return ServersCreateServerActionResponseServerPublicNetIpv6DnsPtr
    ...
    dns_ptr: 'ServersCreateServerActionResponseServerPublicNetIpv6DnsPtr'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocked"]) -> MetaOapg.properties.blocked: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dns_ptr"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv6DnsPtr': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blocked", "dns_ptr", "ip", "id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dns_ptr"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv6DnsPtr': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blocked", "dns_ptr", "ip", "id", ], str]):
