...
class FirewallsGetFirewallByIdResponseFirewallAppliedToItemAppliedToResourcesItemServer(
    schemas.DictSchema
):
    """
    ...
    ) -> 'FirewallsGetFirewallByIdResponseFirewallAppliedToItemAppliedToResourcesItemServer':
