...
class ImageActionsGetAllActionsResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ImageActionsGetAllActionsResponseActionsItemError']:
                return ImageActionsGetAllActionsResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['ImageActionsGetAllActionsResponseActionsItemResources']:
                return ImageActionsGetAllActionsResponseActionsItemResources
    ...
    resources: 'ImageActionsGetAllActionsResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'ImageActionsGetAllActionsResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ImageActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'ImageActionsGetAllActionsResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'ImageActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'ImageActionsGetAllActionsResponseActionsItemResources': ...
    ...
    ) -> 'ImageActionsGetAllActionsResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
