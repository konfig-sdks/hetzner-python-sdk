...
class ImageActionsGetAllActions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['ImageActionsGetAllActions200ResponseActions']:
                return ImageActionsGetAllActions200ResponseActions
        
            @staticmethod
            def meta() -> typing.Type['ImageActionsGetAllActions200ResponseMeta']:
                return ImageActionsGetAllActions200ResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'ImageActionsGetAllActions200ResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'ImageActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'ImageActionsGetAllActions200ResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'ImageActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['ImageActionsGetAllActions200ResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'ImageActionsGetAllActions200ResponseActions',
        meta: typing.Union['ImageActionsGetAllActions200ResponseMeta', schemas.Unset] = schemas.unset,
