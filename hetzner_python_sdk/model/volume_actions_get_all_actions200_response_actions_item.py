...
class VolumeActionsGetAllActions200ResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['VolumeActionsGetAllActions200ResponseActionsItemError']:
                return VolumeActionsGetAllActions200ResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['VolumeActionsGetAllActions200ResponseActionsItemResources']:
                return VolumeActionsGetAllActions200ResponseActionsItemResources
    ...
    resources: 'VolumeActionsGetAllActions200ResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'VolumeActionsGetAllActions200ResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'VolumeActionsGetAllActions200ResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'VolumeActionsGetAllActions200ResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'VolumeActionsGetAllActions200ResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'VolumeActionsGetAllActions200ResponseActionsItemResources': ...
    ...
    ) -> 'VolumeActionsGetAllActions200ResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
