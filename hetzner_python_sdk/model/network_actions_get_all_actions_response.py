...
class NetworkActionsGetAllActionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['NetworkActionsGetAllActionsResponseActions']:
                return NetworkActionsGetAllActionsResponseActions
        
            @staticmethod
            def meta() -> typing.Type['NetworkActionsGetAllActionsResponseMeta']:
                return NetworkActionsGetAllActionsResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'NetworkActionsGetAllActionsResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'NetworkActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'NetworkActionsGetAllActionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'NetworkActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['NetworkActionsGetAllActionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'NetworkActionsGetAllActionsResponseActions',
        meta: typing.Union['NetworkActionsGetAllActionsResponseMeta', schemas.Unset] = schemas.unset,
