...
class NetworkActionsGetAllActionsResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['NetworkActionsGetAllActionsResponseActionsItemError']:
                return NetworkActionsGetAllActionsResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['NetworkActionsGetAllActionsResponseActionsItemResources']:
                return NetworkActionsGetAllActionsResponseActionsItemResources
    ...
    resources: 'NetworkActionsGetAllActionsResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'NetworkActionsGetAllActionsResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'NetworkActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'NetworkActionsGetAllActionsResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'NetworkActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'NetworkActionsGetAllActionsResponseActionsItemResources': ...
    ...
    ) -> 'NetworkActionsGetAllActionsResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
