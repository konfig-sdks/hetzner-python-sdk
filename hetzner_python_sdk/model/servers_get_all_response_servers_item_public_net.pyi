...
class ServersGetAllResponseServersItemPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def floating_ips() -> typing.Type['ServersGetAllResponseServersItemPublicNetFloatingIps']:
                return ServersGetAllResponseServersItemPublicNetFloatingIps
        
            @staticmethod
            def ipv4() -> typing.Type['ServersGetAllResponseServersItemPublicNetIpv4']:
                return ServersGetAllResponseServersItemPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['ServersGetAllResponseServersItemPublicNetIpv6']:
                return ServersGetAllResponseServersItemPublicNetIpv6
        
            @staticmethod
            def firewalls() -> typing.Type['ServersGetAllResponseServersItemPublicNetFirewalls']:
                return ServersGetAllResponseServersItemPublicNetFirewalls
            __annotations__ = {
    ...
    ipv4: 'ServersGetAllResponseServersItemPublicNetIpv4'
    ipv6: 'ServersGetAllResponseServersItemPublicNetIpv6'
    floating_ips: 'ServersGetAllResponseServersItemPublicNetFloatingIps'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersGetAllResponseServersItemPublicNetFloatingIps': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersGetAllResponseServersItemPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersGetAllResponseServersItemPublicNetIpv6': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firewalls"]) -> 'ServersGetAllResponseServersItemPublicNetFirewalls': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersGetAllResponseServersItemPublicNetFloatingIps': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersGetAllResponseServersItemPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersGetAllResponseServersItemPublicNetIpv6': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firewalls"]) -> typing.Union['ServersGetAllResponseServersItemPublicNetFirewalls', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ipv6: 'ServersGetAllResponseServersItemPublicNetIpv6',
        floating_ips: 'ServersGetAllResponseServersItemPublicNetFloatingIps',
        firewalls: typing.Union['ServersGetAllResponseServersItemPublicNetFirewalls', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ServersGetAllResponseServersItemPublicNet':
