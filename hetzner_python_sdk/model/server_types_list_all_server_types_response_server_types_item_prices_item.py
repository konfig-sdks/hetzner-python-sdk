...
class ServerTypesListAllServerTypesResponseServerTypesItemPricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceHourly']:
                return ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceMonthly']:
                return ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItemPriceMonthly': ...
    ...
    ) -> 'ServerTypesListAllServerTypesResponseServerTypesItemPricesItem':
