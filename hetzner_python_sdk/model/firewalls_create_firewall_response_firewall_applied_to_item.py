...
class FirewallsCreateFirewallResponseFirewallAppliedToItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def applied_to_resources() -> typing.Type['FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResources']:
                return FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResources
        
            @staticmethod
            def label_selector() -> typing.Type['FirewallsCreateFirewallResponseFirewallAppliedToItemLabelSelector']:
                return FirewallsCreateFirewallResponseFirewallAppliedToItemLabelSelector
        
            @staticmethod
            def server() -> typing.Type['FirewallsCreateFirewallResponseFirewallAppliedToItemServer']:
                return FirewallsCreateFirewallResponseFirewallAppliedToItemServer
            __annotations__ = {
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["applied_to_resources"]) -> 'FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResources': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["label_selector"]) -> 'FirewallsCreateFirewallResponseFirewallAppliedToItemLabelSelector': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["server"]) -> 'FirewallsCreateFirewallResponseFirewallAppliedToItemServer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["applied_to_resources"]) -> typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResources', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["label_selector"]) -> typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemLabelSelector', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["server"]) -> typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemServer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        applied_to_resources: typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemAppliedToResources', schemas.Unset] = schemas.unset,
        label_selector: typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemLabelSelector', schemas.Unset] = schemas.unset,
        server: typing.Union['FirewallsCreateFirewallResponseFirewallAppliedToItemServer', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FirewallsCreateFirewallResponseFirewallAppliedToItem':
