...
class FloatingIPsCreateNewIpRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            home_location = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "description", "home_location", "labels", "name", "server", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "description", "home_location", "labels", "name", "server", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        home_location: typing.Union[MetaOapg.properties.home_location, str, schemas.Unset] = schemas.unset,
