...
class VolumeActionsGetAllActionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['VolumeActionsGetAllActionsResponseActions']:
                return VolumeActionsGetAllActionsResponseActions
        
            @staticmethod
            def meta() -> typing.Type['VolumeActionsGetAllActionsResponseMeta']:
                return VolumeActionsGetAllActionsResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'VolumeActionsGetAllActionsResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'VolumeActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'VolumeActionsGetAllActionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'VolumeActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['VolumeActionsGetAllActionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'VolumeActionsGetAllActionsResponseActions',
        meta: typing.Union['VolumeActionsGetAllActionsResponseMeta', schemas.Unset] = schemas.unset,
