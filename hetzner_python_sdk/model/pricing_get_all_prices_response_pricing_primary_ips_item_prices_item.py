...
class PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceHourly']:
                return PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceMonthly']:
                return PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItemPriceMonthly': ...
    ...
    ) -> 'PricingGetAllPricesResponsePricingPrimaryIpsItemPricesItem':
