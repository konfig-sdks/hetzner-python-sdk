...
class IsOsGetAllResponseIsosItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def deprecation() -> typing.Type['IsOsGetAllResponseIsosItemDeprecation']:
                return IsOsGetAllResponseIsosItemDeprecation
    ...
    deprecation: 'IsOsGetAllResponseIsosItemDeprecation'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deprecation"]) -> 'IsOsGetAllResponseIsosItemDeprecation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deprecation"]) -> 'IsOsGetAllResponseIsosItemDeprecation': ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        architecture: typing.Union[MetaOapg.properties.architecture, None, str, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'IsOsGetAllResponseIsosItem':
        return super().__new__(
            cls,
            *args,
            name=name,
