...
class FirewallActionsSetRulesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['FirewallActionsSetRulesResponseActions']:
                return FirewallActionsSetRulesResponseActions
        
            @staticmethod
            def meta() -> typing.Type['FirewallActionsSetRulesResponseMeta']:
                return FirewallActionsSetRulesResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'FirewallActionsSetRulesResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'FirewallActionsSetRulesResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'FirewallActionsSetRulesResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'FirewallActionsSetRulesResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['FirewallActionsSetRulesResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'FirewallActionsSetRulesResponseActions',
        meta: typing.Union['FirewallActionsSetRulesResponseMeta', schemas.Unset] = schemas.unset,
