...
class FirewallActionsGetActionById200ResponseAction(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['FirewallActionsGetActionById200ResponseActionError']:
                return FirewallActionsGetActionById200ResponseActionError
            ...
            @staticmethod
            def resources() -> typing.Type['FirewallActionsGetActionById200ResponseActionResources']:
                return FirewallActionsGetActionById200ResponseActionResources
    ...
    resources: 'FirewallActionsGetActionById200ResponseActionResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'FirewallActionsGetActionById200ResponseActionError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsGetActionById200ResponseActionError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsGetActionById200ResponseActionResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsGetActionById200ResponseActionError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsGetActionById200ResponseActionResources': ...
    ...
    ) -> 'FirewallActionsGetActionById200ResponseAction':
        return super().__new__(
            cls,
            *args,
            progress=progress,
