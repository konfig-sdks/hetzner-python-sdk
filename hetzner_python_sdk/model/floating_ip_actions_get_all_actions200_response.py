...
class FloatingIpActionsGetAllActions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['FloatingIpActionsGetAllActions200ResponseActions']:
                return FloatingIpActionsGetAllActions200ResponseActions
        
            @staticmethod
            def meta() -> typing.Type['FloatingIpActionsGetAllActions200ResponseMeta']:
                return FloatingIpActionsGetAllActions200ResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'FloatingIpActionsGetAllActions200ResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'FloatingIpActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'FloatingIpActionsGetAllActions200ResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'FloatingIpActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['FloatingIpActionsGetAllActions200ResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'FloatingIpActionsGetAllActions200ResponseActions',
        meta: typing.Union['FloatingIpActionsGetAllActions200ResponseMeta', schemas.Unset] = schemas.unset,
