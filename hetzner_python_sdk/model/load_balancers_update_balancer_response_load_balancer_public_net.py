...
class LoadBalancersUpdateBalancerResponseLoadBalancerPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ipv4() -> typing.Type['LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4']:
                return LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6']:
                return LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6
            __annotations__ = {
                "enabled": enabled,
                "ipv4": ipv4,
                "ipv6": ipv6,
    ...
    ipv4: 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4'
    ipv6: 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerPublicNetIpv6': ...
