...
class ServerActionsGetAllActionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['ServerActionsGetAllActionsResponseActions']:
                return ServerActionsGetAllActionsResponseActions
        
            @staticmethod
            def meta() -> typing.Type['ServerActionsGetAllActionsResponseMeta']:
                return ServerActionsGetAllActionsResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'ServerActionsGetAllActionsResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'ServerActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'ServerActionsGetAllActionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'ServerActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['ServerActionsGetAllActionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'ServerActionsGetAllActionsResponseActions',
        meta: typing.Union['ServerActionsGetAllActionsResponseMeta', schemas.Unset] = schemas.unset,
