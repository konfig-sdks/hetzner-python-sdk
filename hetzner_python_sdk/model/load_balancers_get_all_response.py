...
class LoadBalancersGetAllResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def load_balancers() -> typing.Type['LoadBalancersGetAllResponseLoadBalancers']:
                return LoadBalancersGetAllResponseLoadBalancers
        
            @staticmethod
            def meta() -> typing.Type['LoadBalancersGetAllResponseMeta']:
                return LoadBalancersGetAllResponseMeta
            __annotations__ = {
                "load_balancers": load_balancers,
                "meta": meta,
            }
    
    load_balancers: 'LoadBalancersGetAllResponseLoadBalancers'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["load_balancers"]) -> 'LoadBalancersGetAllResponseLoadBalancers': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'LoadBalancersGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["load_balancers", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["load_balancers"]) -> 'LoadBalancersGetAllResponseLoadBalancers': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['LoadBalancersGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["load_balancers", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        load_balancers: 'LoadBalancersGetAllResponseLoadBalancers',
        meta: typing.Union['LoadBalancersGetAllResponseMeta', schemas.Unset] = schemas.unset,
