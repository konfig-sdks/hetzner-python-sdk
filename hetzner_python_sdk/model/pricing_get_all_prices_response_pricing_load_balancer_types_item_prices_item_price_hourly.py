...
class PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly(
    schemas.DictSchema
):
    """
    ...
    ) -> 'PricingGetAllPricesResponsePricingLoadBalancerTypesItemPricesItemPriceHourly':
