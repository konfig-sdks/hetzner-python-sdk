...
class LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceMonthly':
