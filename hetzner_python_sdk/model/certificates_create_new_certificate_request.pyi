...
class CertificatesCreateNewCertificateRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def domain_names() -> typing.Type['CertificatesCreateNewCertificateRequestDomainNames']:
                return CertificatesCreateNewCertificateRequestDomainNames
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["domain_names"]) -> 'CertificatesCreateNewCertificateRequestDomainNames': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "certificate", "domain_names", "labels", "private_key", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["domain_names"]) -> typing.Union['CertificatesCreateNewCertificateRequestDomainNames', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "certificate", "domain_names", "labels", "private_key", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        domain_names: typing.Union['CertificatesCreateNewCertificateRequestDomainNames', schemas.Unset] = schemas.unset,
