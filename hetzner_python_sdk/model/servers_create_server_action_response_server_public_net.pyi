...
class ServersCreateServerActionResponseServerPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def floating_ips() -> typing.Type['ServersCreateServerActionResponseServerPublicNetFloatingIps']:
                return ServersCreateServerActionResponseServerPublicNetFloatingIps
        
            @staticmethod
            def ipv4() -> typing.Type['ServersCreateServerActionResponseServerPublicNetIpv4']:
                return ServersCreateServerActionResponseServerPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['ServersCreateServerActionResponseServerPublicNetIpv6']:
                return ServersCreateServerActionResponseServerPublicNetIpv6
        
            @staticmethod
            def firewalls() -> typing.Type['ServersCreateServerActionResponseServerPublicNetFirewalls']:
                return ServersCreateServerActionResponseServerPublicNetFirewalls
            __annotations__ = {
    ...
    ipv4: 'ServersCreateServerActionResponseServerPublicNetIpv4'
    ipv6: 'ServersCreateServerActionResponseServerPublicNetIpv6'
    floating_ips: 'ServersCreateServerActionResponseServerPublicNetFloatingIps'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersCreateServerActionResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firewalls"]) -> 'ServersCreateServerActionResponseServerPublicNetFirewalls': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["floating_ips", "ipv4", "ipv6", "firewalls", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersCreateServerActionResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersCreateServerActionResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firewalls"]) -> typing.Union['ServersCreateServerActionResponseServerPublicNetFirewalls', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["floating_ips", "ipv4", "ipv6", "firewalls", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ipv6: 'ServersCreateServerActionResponseServerPublicNetIpv6',
        floating_ips: 'ServersCreateServerActionResponseServerPublicNetFloatingIps',
        firewalls: typing.Union['ServersCreateServerActionResponseServerPublicNetFirewalls', schemas.Unset] = schemas.unset,
