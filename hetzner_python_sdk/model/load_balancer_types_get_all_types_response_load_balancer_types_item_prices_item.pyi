...
class LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceHourly']:
                return LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceMonthly']:
                return LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItemPriceMonthly': ...
    ...
    ) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPricesItem':
