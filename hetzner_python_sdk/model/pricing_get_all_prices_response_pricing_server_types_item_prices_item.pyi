...
class PricingGetAllPricesResponsePricingServerTypesItemPricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceHourly']:
                return PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceMonthly']:
                return PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'PricingGetAllPricesResponsePricingServerTypesItemPricesItemPriceMonthly': ...
    ...
    ) -> 'PricingGetAllPricesResponsePricingServerTypesItemPricesItem':
