...
class FloatingIPsUpdateDescriptionLabelsResponseFloatingIp(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def dns_ptr() -> typing.Type['FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtr']:
                return FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtr
        
            @staticmethod
            def home_location() -> typing.Type['FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation']:
                return FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation
            ...
            @staticmethod
            def labels() -> typing.Type['FloatingIPsUpdateDescriptionLabelsResponseFloatingIpLabels']:
                return FloatingIPsUpdateDescriptionLabelsResponseFloatingIpLabels
            name = schemas.StrSchema
        
            @staticmethod
            def protection() -> typing.Type['FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection']:
                return FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection
    ...
    home_location: 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation'
    protection: 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection'
    id: MetaOapg.properties.id
    type: MetaOapg.properties.type
    dns_ptr: 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtr'
    labels: 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpLabels'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dns_ptr"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtr': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["home_location"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpLabels': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> MetaOapg.properties.name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["protection"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "blocked", "created", "dns_ptr", "home_location", "id", "ip", "labels", "name", "protection", "server", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dns_ptr"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpDnsPtr': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["home_location"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpHomeLocation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpLabels': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> MetaOapg.properties.name: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["protection"]) -> 'FloatingIPsUpdateDescriptionLabelsResponseFloatingIpProtection': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "blocked", "created", "dns_ptr", "home_location", "id", "ip", "labels", "name", "protection", "server", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        server: typing.Union[MetaOapg.properties.server, None, decimal.Decimal, int, ],
