...
class LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prices() -> typing.Type['LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPrices']:
                return LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPrices
            __annotations__ = {
    ...
    prices: 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPrices'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPrices': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItemPrices': ...
    ...
    ) -> 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesItem':
        return super().__new__(
            cls,
            *args,
            max_targets=max_targets,
