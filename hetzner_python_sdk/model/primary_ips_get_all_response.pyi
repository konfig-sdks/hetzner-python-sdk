...
class PrimaryIPsGetAllResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def primary_ips() -> typing.Type['PrimaryIPsGetAllResponsePrimaryIps']:
                return PrimaryIPsGetAllResponsePrimaryIps
        
            @staticmethod
            def meta() -> typing.Type['PrimaryIPsGetAllResponseMeta']:
                return PrimaryIPsGetAllResponseMeta
            __annotations__ = {
                "primary_ips": primary_ips,
                "meta": meta,
            }
    
    primary_ips: 'PrimaryIPsGetAllResponsePrimaryIps'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primary_ips"]) -> 'PrimaryIPsGetAllResponsePrimaryIps': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'PrimaryIPsGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["primary_ips", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primary_ips"]) -> 'PrimaryIPsGetAllResponsePrimaryIps': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['PrimaryIPsGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["primary_ips", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        primary_ips: 'PrimaryIPsGetAllResponsePrimaryIps',
        meta: typing.Union['PrimaryIPsGetAllResponseMeta', schemas.Unset] = schemas.unset,
