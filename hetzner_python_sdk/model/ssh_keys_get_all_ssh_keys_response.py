...
class SshKeysGetAllSshKeysResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ssh_keys() -> typing.Type['SshKeysGetAllSshKeysResponseSshKeys']:
                return SshKeysGetAllSshKeysResponseSshKeys
        
            @staticmethod
            def meta() -> typing.Type['SshKeysGetAllSshKeysResponseMeta']:
                return SshKeysGetAllSshKeysResponseMeta
            __annotations__ = {
                "ssh_keys": ssh_keys,
                "meta": meta,
            }
    
    ssh_keys: 'SshKeysGetAllSshKeysResponseSshKeys'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ssh_keys"]) -> 'SshKeysGetAllSshKeysResponseSshKeys': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'SshKeysGetAllSshKeysResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ssh_keys", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ssh_keys"]) -> 'SshKeysGetAllSshKeysResponseSshKeys': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['SshKeysGetAllSshKeysResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ssh_keys", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ssh_keys: 'SshKeysGetAllSshKeysResponseSshKeys',
        meta: typing.Union['SshKeysGetAllSshKeysResponseMeta', schemas.Unset] = schemas.unset,
