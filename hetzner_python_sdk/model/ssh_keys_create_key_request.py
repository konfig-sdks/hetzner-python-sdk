...
class SshKeysCreateKeyRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "public_key", "labels", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "public_key", "labels", ], str]):
