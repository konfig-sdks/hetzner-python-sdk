...
class SshKeysGetByIdResponseSshKey(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def labels() -> typing.Type['SshKeysGetByIdResponseSshKeyLabels']:
                return SshKeysGetByIdResponseSshKeyLabels
    ...
    labels: 'SshKeysGetByIdResponseSshKeyLabels'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysGetByIdResponseSshKeyLabels': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> 'SshKeysGetByIdResponseSshKeyLabels': ...
