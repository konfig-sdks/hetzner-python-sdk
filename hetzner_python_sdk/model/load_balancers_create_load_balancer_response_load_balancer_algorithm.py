...
class LoadBalancersCreateLoadBalancerResponseLoadBalancerAlgorithm(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                @schemas.classproperty
                def LEAST_CONNECTIONS(cls):
                    return cls("least_connections")
            __annotations__ = {
                "type": type,
            }
    ...
    ) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerAlgorithm':
