...
class ServersCreateServerActionRequestPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            enable_ipv4 = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enable_ipv4"]) -> MetaOapg.properties.enable_ipv4: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable_ipv4", "enable_ipv6", "ipv4", "ipv6", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enable_ipv4"]) -> typing.Union[MetaOapg.properties.enable_ipv4, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable_ipv4", "enable_ipv6", "ipv4", "ipv6", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        enable_ipv4: typing.Union[MetaOapg.properties.enable_ipv4, bool, schemas.Unset] = schemas.unset,
        enable_ipv6: typing.Union[MetaOapg.properties.enable_ipv6, bool, schemas.Unset] = schemas.unset,
        ipv4: typing.Union[MetaOapg.properties.ipv4, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ipv6: typing.Union[MetaOapg.properties.ipv6, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
