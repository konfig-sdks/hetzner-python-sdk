...
class LoadBalancersGetByIdResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersGetByIdResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem':
