...
class PrimaryIpActionsAssignPrimaryIpToResourceRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["assignee_id", "assignee_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assignee_id", "assignee_type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        assignee_id: typing.Union[MetaOapg.properties.assignee_id, decimal.Decimal, int, ],
