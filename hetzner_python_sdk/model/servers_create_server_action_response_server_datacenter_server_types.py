...
class ServersCreateServerActionResponseServerDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['ServersCreateServerActionResponseServerDatacenterServerTypesAvailable']:
                return ServersCreateServerActionResponseServerDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['ServersCreateServerActionResponseServerDatacenterServerTypesAvailableForMigration']:
                return ServersCreateServerActionResponseServerDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['ServersCreateServerActionResponseServerDatacenterServerTypesSupported']:
                return ServersCreateServerActionResponseServerDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailableForMigration'
    available: 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailable'
    supported: 'ServersCreateServerActionResponseServerDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'ServersCreateServerActionResponseServerDatacenterServerTypesSupported': ...
    ...
    ) -> 'ServersCreateServerActionResponseServerDatacenterServerTypes':
