...
class VolumeActionsAttachVolumeToServerRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["server", "automount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["server", "automount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        server: typing.Union[MetaOapg.properties.server, decimal.Decimal, int, ],
