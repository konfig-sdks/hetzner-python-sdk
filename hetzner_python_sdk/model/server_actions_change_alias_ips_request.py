...
class ServerActionsChangeAliasIpsRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def alias_ips() -> typing.Type['ServerActionsChangeAliasIpsRequestAliasIps']:
                return ServerActionsChangeAliasIpsRequestAliasIps
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["alias_ips"]) -> 'ServerActionsChangeAliasIpsRequestAliasIps': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["alias_ips", "network", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["alias_ips"]) -> 'ServerActionsChangeAliasIpsRequestAliasIps': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["alias_ips", "network", ], str]):
