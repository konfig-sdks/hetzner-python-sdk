...
class FirewallsUpdateFirewallByIdResponseFirewallAppliedToItemAppliedToResourcesItemServer(
    schemas.DictSchema
):
    """
    ...
    ) -> 'FirewallsUpdateFirewallByIdResponseFirewallAppliedToItemAppliedToResourcesItemServer':
