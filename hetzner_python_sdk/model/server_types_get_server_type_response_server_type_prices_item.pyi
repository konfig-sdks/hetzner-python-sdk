...
class ServerTypesGetServerTypeResponseServerTypePricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['ServerTypesGetServerTypeResponseServerTypePricesItemPriceHourly']:
                return ServerTypesGetServerTypeResponseServerTypePricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['ServerTypesGetServerTypeResponseServerTypePricesItemPriceMonthly']:
                return ServerTypesGetServerTypeResponseServerTypePricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'ServerTypesGetServerTypeResponseServerTypePricesItemPriceMonthly': ...
    ...
    ) -> 'ServerTypesGetServerTypeResponseServerTypePricesItem':
