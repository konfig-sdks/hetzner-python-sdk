...
class FirewallActionsRemoveFromResourcesResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['FirewallActionsRemoveFromResourcesResponseActionsItemError']:
                return FirewallActionsRemoveFromResourcesResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['FirewallActionsRemoveFromResourcesResponseActionsItemResources']:
                return FirewallActionsRemoveFromResourcesResponseActionsItemResources
    ...
    resources: 'FirewallActionsRemoveFromResourcesResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'FirewallActionsRemoveFromResourcesResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsRemoveFromResourcesResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsRemoveFromResourcesResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'FirewallActionsRemoveFromResourcesResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'FirewallActionsRemoveFromResourcesResponseActionsItemResources': ...
    ...
    ) -> 'FirewallActionsRemoveFromResourcesResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
