...
class LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesItemPriceMonthly':
