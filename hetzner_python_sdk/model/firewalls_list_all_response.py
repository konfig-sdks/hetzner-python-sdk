...
class FirewallsListAllResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def firewalls() -> typing.Type['FirewallsListAllResponseFirewalls']:
                return FirewallsListAllResponseFirewalls
        
            @staticmethod
            def meta() -> typing.Type['FirewallsListAllResponseMeta']:
                return FirewallsListAllResponseMeta
            __annotations__ = {
                "firewalls": firewalls,
                "meta": meta,
            }
    
    firewalls: 'FirewallsListAllResponseFirewalls'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firewalls"]) -> 'FirewallsListAllResponseFirewalls': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'FirewallsListAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["firewalls", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firewalls"]) -> 'FirewallsListAllResponseFirewalls': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['FirewallsListAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["firewalls", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        firewalls: 'FirewallsListAllResponseFirewalls',
        meta: typing.Union['FirewallsListAllResponseMeta', schemas.Unset] = schemas.unset,
