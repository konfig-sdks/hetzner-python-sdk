...
class LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerType(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prices() -> typing.Type['LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePrices']:
                return LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePrices
            __annotations__ = {
    ...
    prices: 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePrices'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePrices': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prices"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePrices': ...
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerType':
        return super().__new__(
            cls,
            *args,
            max_targets=max_targets,
