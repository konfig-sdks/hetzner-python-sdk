...
class PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterLocation(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "city", "country", "id", "latitude", "longitude", "name", "network_zone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "city", "country", "id", "latitude", "longitude", "name", "network_zone", ], str]):
    ...
    ) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterLocation':
