...
class LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemHealthStatusItem':
