...
class DatacentersGetAllResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def datacenters() -> typing.Type['DatacentersGetAllResponseDatacenters']:
                return DatacentersGetAllResponseDatacenters
        
            @staticmethod
            def meta() -> typing.Type['DatacentersGetAllResponseMeta']:
                return DatacentersGetAllResponseMeta
            recommendation = schemas.Int64Schema
            __annotations__ = {
    ...
    datacenters: 'DatacentersGetAllResponseDatacenters'
    meta: 'DatacentersGetAllResponseMeta'
    recommendation: MetaOapg.properties.recommendation
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["datacenters"]) -> 'DatacentersGetAllResponseDatacenters': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'DatacentersGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recommendation"]) -> MetaOapg.properties.recommendation: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["datacenters", "meta", "recommendation", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["datacenters"]) -> 'DatacentersGetAllResponseDatacenters': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> 'DatacentersGetAllResponseMeta': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recommendation"]) -> MetaOapg.properties.recommendation: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["datacenters", "meta", "recommendation", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        datacenters: 'DatacentersGetAllResponseDatacenters',
        meta: 'DatacentersGetAllResponseMeta',
        recommendation: typing.Union[MetaOapg.properties.recommendation, decimal.Decimal, int, ],
