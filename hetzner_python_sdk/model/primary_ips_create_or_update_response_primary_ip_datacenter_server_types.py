...
class PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailable']:
                return PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailableForMigration']:
                return PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesSupported']:
                return PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailableForMigration'
    available: 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailable'
    supported: 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesSupported': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["available", "available_for_migration", "supported", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypesSupported': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["available", "available_for_migration", "supported", ], str]):
    ...
    ) -> 'PrimaryIPsCreateOrUpdateResponsePrimaryIpDatacenterServerTypes':
