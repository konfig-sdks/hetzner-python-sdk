...
class LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def health_status() -> typing.Type['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatus']:
                return LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatus
        
            @staticmethod
            def server() -> typing.Type['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemServer']:
                return LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemServer
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["health_status"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatus': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["server"]) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemServer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["health_status"]) -> typing.Union['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatus', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["server"]) -> typing.Union['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemServer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        health_status: typing.Union['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatus', schemas.Unset] = schemas.unset,
        server: typing.Union['LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemServer', schemas.Unset] = schemas.unset,
    ...
    ) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItem':
