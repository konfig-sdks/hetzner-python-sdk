...
class PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailable']:
                return PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailableForMigration']:
                return PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesSupported']:
                return PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailableForMigration'
    available: 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailable'
    supported: 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypesSupported': ...
    ...
    ) -> 'PrimaryIPsGetByIdResponsePrimaryIpDatacenterServerTypes':
