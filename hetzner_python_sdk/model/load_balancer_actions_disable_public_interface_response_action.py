...
class LoadBalancerActionsDisablePublicInterfaceResponseAction(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['LoadBalancerActionsDisablePublicInterfaceResponseActionError']:
                return LoadBalancerActionsDisablePublicInterfaceResponseActionError
            ...
            @staticmethod
            def resources() -> typing.Type['LoadBalancerActionsDisablePublicInterfaceResponseActionResources']:
                return LoadBalancerActionsDisablePublicInterfaceResponseActionResources
    ...
    resources: 'LoadBalancerActionsDisablePublicInterfaceResponseActionResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'LoadBalancerActionsDisablePublicInterfaceResponseActionError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'LoadBalancerActionsDisablePublicInterfaceResponseActionError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'LoadBalancerActionsDisablePublicInterfaceResponseActionResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'LoadBalancerActionsDisablePublicInterfaceResponseActionError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'LoadBalancerActionsDisablePublicInterfaceResponseActionResources': ...
    ...
    ) -> 'LoadBalancerActionsDisablePublicInterfaceResponseAction':
        return super().__new__(
            cls,
            *args,
            progress=progress,
