...
class NetworksUpdatePropertiesResponseNetworkRoutesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destination", "gateway", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destination", "gateway", ], str]):
    ...
    ) -> 'NetworksUpdatePropertiesResponseNetworkRoutesItem':
