...
class PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailable']:
                return PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailableForMigration']:
                return PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesSupported']:
                return PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailableForMigration'
    available: 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailable'
    supported: 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypesSupported': ...
    ...
    ) -> 'PrimaryIPsUpdateIpLabelsResponsePrimaryIpDatacenterServerTypes':
