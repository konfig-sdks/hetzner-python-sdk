...
class FloatingIpActionsGetAllActions200ResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['FloatingIpActionsGetAllActions200ResponseActionsItemError']:
                return FloatingIpActionsGetAllActions200ResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['FloatingIpActionsGetAllActions200ResponseActionsItemResources']:
                return FloatingIpActionsGetAllActions200ResponseActionsItemResources
    ...
    resources: 'FloatingIpActionsGetAllActions200ResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'FloatingIpActionsGetAllActions200ResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'FloatingIpActionsGetAllActions200ResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'FloatingIpActionsGetAllActions200ResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'FloatingIpActionsGetAllActions200ResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'FloatingIpActionsGetAllActions200ResponseActionsItemResources': ...
    ...
    ) -> 'FloatingIpActionsGetAllActions200ResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
