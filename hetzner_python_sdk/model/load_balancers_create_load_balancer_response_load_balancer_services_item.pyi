...
class LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            destination_port = schemas.IntSchema
        
            @staticmethod
            def health_check() -> typing.Type['LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck']:
                return LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck
            ...
            class protocol(
                ...
                def HTTPS(cls):
                    return cls("https")
            proxyprotocol = schemas.BoolSchema
        
            @staticmethod
            def http() -> typing.Type['LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHttp']:
                return LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHttp
            __annotations__ = {
    ...
    listen_port: MetaOapg.properties.listen_port
    destination_port: MetaOapg.properties.destination_port
    health_check: 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck'
    proxyprotocol: MetaOapg.properties.proxyprotocol
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["destination_port"]) -> MetaOapg.properties.destination_port: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["health_check"]) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["proxyprotocol"]) -> MetaOapg.properties.proxyprotocol: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["http"]) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHttp': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destination_port", "health_check", "listen_port", "protocol", "proxyprotocol", "http", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["health_check"]) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["listen_port"]) -> MetaOapg.properties.listen_port: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["protocol"]) -> MetaOapg.properties.protocol: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["proxyprotocol"]) -> MetaOapg.properties.proxyprotocol: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["http"]) -> typing.Union['LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHttp', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destination_port", "health_check", "listen_port", "protocol", "proxyprotocol", "http", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        listen_port: typing.Union[MetaOapg.properties.listen_port, decimal.Decimal, int, ],
        destination_port: typing.Union[MetaOapg.properties.destination_port, decimal.Decimal, int, ],
        health_check: 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHealthCheck',
        proxyprotocol: typing.Union[MetaOapg.properties.proxyprotocol, bool, ],
        http: typing.Union['LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItemHttp', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerServicesItem':
