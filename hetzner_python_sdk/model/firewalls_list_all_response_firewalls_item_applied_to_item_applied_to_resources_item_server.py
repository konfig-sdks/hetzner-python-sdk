...
class FirewallsListAllResponseFirewallsItemAppliedToItemAppliedToResourcesItemServer(
    schemas.DictSchema
):
    """
    ...
    ) -> 'FirewallsListAllResponseFirewallsItemAppliedToItemAppliedToResourcesItemServer':
