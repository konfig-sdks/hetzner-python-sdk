...
class LoadBalancersGetAllResponseLoadBalancersItemPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ipv4() -> typing.Type['LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv4']:
                return LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6']:
                return LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6
            __annotations__ = {
                "enabled": enabled,
                "ipv4": ipv4,
                "ipv6": ipv6,
    ...
    ipv4: 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv4'
    ipv6: 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6': ...
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNet':
