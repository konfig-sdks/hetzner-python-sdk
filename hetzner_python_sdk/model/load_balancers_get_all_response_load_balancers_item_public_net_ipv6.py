...
class LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dns_ptr"]) -> typing.Union[MetaOapg.properties.dns_ptr, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        dns_ptr: typing.Union[MetaOapg.properties.dns_ptr, None, str, schemas.Unset] = schemas.unset,
        ip: typing.Union[MetaOapg.properties.ip, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemPublicNetIpv6':
        return super().__new__(
            cls,
            *args,
            dns_ptr=dns_ptr,
