...
class LoadBalancerActionsAddTargetRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ip() -> typing.Type['LoadBalancerActionsAddTargetRequestIp']:
                return LoadBalancerActionsAddTargetRequestIp
        
            @staticmethod
            def label_selector() -> typing.Type['LoadBalancerActionsAddTargetRequestLabelSelector']:
                return LoadBalancerActionsAddTargetRequestLabelSelector
        
            @staticmethod
            def server() -> typing.Type['LoadBalancerActionsAddTargetRequestServer']:
                return LoadBalancerActionsAddTargetRequestServer
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ip"]) -> 'LoadBalancerActionsAddTargetRequestIp': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["label_selector"]) -> 'LoadBalancerActionsAddTargetRequestLabelSelector': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["server"]) -> 'LoadBalancerActionsAddTargetRequestServer': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "ip", "label_selector", "server", "use_private_ip", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ip"]) -> typing.Union['LoadBalancerActionsAddTargetRequestIp', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["label_selector"]) -> typing.Union['LoadBalancerActionsAddTargetRequestLabelSelector', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["server"]) -> typing.Union['LoadBalancerActionsAddTargetRequestServer', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "ip", "label_selector", "server", "use_private_ip", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ip: typing.Union['LoadBalancerActionsAddTargetRequestIp', schemas.Unset] = schemas.unset,
        label_selector: typing.Union['LoadBalancerActionsAddTargetRequestLabelSelector', schemas.Unset] = schemas.unset,
        server: typing.Union['LoadBalancerActionsAddTargetRequestServer', schemas.Unset] = schemas.unset,
