...
class PrimaryIpActionsGetAllActionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['PrimaryIpActionsGetAllActionsResponseActions']:
                return PrimaryIpActionsGetAllActionsResponseActions
        
            @staticmethod
            def meta() -> typing.Type['PrimaryIpActionsGetAllActionsResponseMeta']:
                return PrimaryIpActionsGetAllActionsResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'PrimaryIpActionsGetAllActionsResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'PrimaryIpActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'PrimaryIpActionsGetAllActionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'PrimaryIpActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['PrimaryIpActionsGetAllActionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'PrimaryIpActionsGetAllActionsResponseActions',
        meta: typing.Union['PrimaryIpActionsGetAllActionsResponseMeta', schemas.Unset] = schemas.unset,
