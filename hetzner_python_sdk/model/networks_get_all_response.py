...
class NetworksGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def networks() -> typing.Type['NetworksGetAllResponseNetworks']:
                return NetworksGetAllResponseNetworks
        
            @staticmethod
            def meta() -> typing.Type['NetworksGetAllResponseMeta']:
                return NetworksGetAllResponseMeta
            __annotations__ = {
                "networks": networks,
                "meta": meta,
            }
    
    networks: 'NetworksGetAllResponseNetworks'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["networks"]) -> 'NetworksGetAllResponseNetworks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'NetworksGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["networks", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["networks"]) -> 'NetworksGetAllResponseNetworks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['NetworksGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["networks", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        networks: 'NetworksGetAllResponseNetworks',
        meta: typing.Union['NetworksGetAllResponseMeta', schemas.Unset] = schemas.unset,
