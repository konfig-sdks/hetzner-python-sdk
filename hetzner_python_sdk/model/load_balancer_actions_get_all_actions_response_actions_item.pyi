...
class LoadBalancerActionsGetAllActionsResponseActionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['LoadBalancerActionsGetAllActionsResponseActionsItemError']:
                return LoadBalancerActionsGetAllActionsResponseActionsItemError
            ...
            @staticmethod
            def resources() -> typing.Type['LoadBalancerActionsGetAllActionsResponseActionsItemResources']:
                return LoadBalancerActionsGetAllActionsResponseActionsItemResources
    ...
    resources: 'LoadBalancerActionsGetAllActionsResponseActionsItemResources'
    finished: MetaOapg.properties.finished
    started: MetaOapg.properties.started
    id: MetaOapg.properties.id
    error: 'LoadBalancerActionsGetAllActionsResponseActionsItemError'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'LoadBalancerActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resources"]) -> 'LoadBalancerActionsGetAllActionsResponseActionsItemResources': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> 'LoadBalancerActionsGetAllActionsResponseActionsItemError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resources"]) -> 'LoadBalancerActionsGetAllActionsResponseActionsItemResources': ...
    ...
    ) -> 'LoadBalancerActionsGetAllActionsResponseActionsItem':
        return super().__new__(
            cls,
            *args,
            progress=progress,
