...
class LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemLoadBalancerTypePricesItemPriceHourly':
