...
class ServersGetServerResponseServerPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def floating_ips() -> typing.Type['ServersGetServerResponseServerPublicNetFloatingIps']:
                return ServersGetServerResponseServerPublicNetFloatingIps
        
            @staticmethod
            def ipv4() -> typing.Type['ServersGetServerResponseServerPublicNetIpv4']:
                return ServersGetServerResponseServerPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['ServersGetServerResponseServerPublicNetIpv6']:
                return ServersGetServerResponseServerPublicNetIpv6
        
            @staticmethod
            def firewalls() -> typing.Type['ServersGetServerResponseServerPublicNetFirewalls']:
                return ServersGetServerResponseServerPublicNetFirewalls
            __annotations__ = {
    ...
    ipv4: 'ServersGetServerResponseServerPublicNetIpv4'
    ipv6: 'ServersGetServerResponseServerPublicNetIpv6'
    floating_ips: 'ServersGetServerResponseServerPublicNetFloatingIps'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersGetServerResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersGetServerResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersGetServerResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firewalls"]) -> 'ServersGetServerResponseServerPublicNetFirewalls': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["floating_ips"]) -> 'ServersGetServerResponseServerPublicNetFloatingIps': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'ServersGetServerResponseServerPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'ServersGetServerResponseServerPublicNetIpv6': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firewalls"]) -> typing.Union['ServersGetServerResponseServerPublicNetFirewalls', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ipv6: 'ServersGetServerResponseServerPublicNetIpv6',
        floating_ips: 'ServersGetServerResponseServerPublicNetFloatingIps',
        firewalls: typing.Union['ServersGetServerResponseServerPublicNetFirewalls', schemas.Unset] = schemas.unset,
