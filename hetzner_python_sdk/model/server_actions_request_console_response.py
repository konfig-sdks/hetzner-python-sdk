...
class ServerActionsRequestConsoleResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def action() -> typing.Type['ServerActionsRequestConsoleResponseAction']:
                return ServerActionsRequestConsoleResponseAction
            password = schemas.StrSchema
            wss_url = schemas.StrSchema
            __annotations__ = {
                "action": action,
                "password": password,
                "wss_url": wss_url,
    ...
    wss_url: MetaOapg.properties.wss_url
    action: 'ServerActionsRequestConsoleResponseAction'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["action"]) -> 'ServerActionsRequestConsoleResponseAction': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["password"]) -> MetaOapg.properties.password: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wss_url"]) -> MetaOapg.properties.wss_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "password", "wss_url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["action"]) -> 'ServerActionsRequestConsoleResponseAction': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["password"]) -> MetaOapg.properties.password: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wss_url"]) -> MetaOapg.properties.wss_url: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "password", "wss_url", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        wss_url: typing.Union[MetaOapg.properties.wss_url, str, ],
        action: 'ServerActionsRequestConsoleResponseAction',
