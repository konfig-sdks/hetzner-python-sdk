...
class LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerTargetsItemTargetsItemHealthStatusItem':
