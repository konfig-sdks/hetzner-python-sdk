...
class VolumeActionsGetAllActions200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['VolumeActionsGetAllActions200ResponseActions']:
                return VolumeActionsGetAllActions200ResponseActions
        
            @staticmethod
            def meta() -> typing.Type['VolumeActionsGetAllActions200ResponseMeta']:
                return VolumeActionsGetAllActions200ResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'VolumeActionsGetAllActions200ResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'VolumeActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'VolumeActionsGetAllActions200ResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'VolumeActionsGetAllActions200ResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['VolumeActionsGetAllActions200ResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'VolumeActionsGetAllActions200ResponseActions',
        meta: typing.Union['VolumeActionsGetAllActions200ResponseMeta', schemas.Unset] = schemas.unset,
