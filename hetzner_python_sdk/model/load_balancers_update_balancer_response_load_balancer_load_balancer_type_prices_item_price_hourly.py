...
class LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesItemPriceHourly':
