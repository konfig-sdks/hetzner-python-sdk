...
class FloatingIpActionsGetAllActionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['FloatingIpActionsGetAllActionsResponseActions']:
                return FloatingIpActionsGetAllActionsResponseActions
        
            @staticmethod
            def meta() -> typing.Type['FloatingIpActionsGetAllActionsResponseMeta']:
                return FloatingIpActionsGetAllActionsResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'FloatingIpActionsGetAllActionsResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'FloatingIpActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'FloatingIpActionsGetAllActionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'FloatingIpActionsGetAllActionsResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['FloatingIpActionsGetAllActionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'FloatingIpActionsGetAllActionsResponseActions',
        meta: typing.Union['FloatingIpActionsGetAllActionsResponseMeta', schemas.Unset] = schemas.unset,
