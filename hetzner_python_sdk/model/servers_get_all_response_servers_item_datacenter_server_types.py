...
class ServersGetAllResponseServersItemDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['ServersGetAllResponseServersItemDatacenterServerTypesAvailable']:
                return ServersGetAllResponseServersItemDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['ServersGetAllResponseServersItemDatacenterServerTypesAvailableForMigration']:
                return ServersGetAllResponseServersItemDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['ServersGetAllResponseServersItemDatacenterServerTypesSupported']:
                return ServersGetAllResponseServersItemDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'ServersGetAllResponseServersItemDatacenterServerTypesAvailableForMigration'
    available: 'ServersGetAllResponseServersItemDatacenterServerTypesAvailable'
    supported: 'ServersGetAllResponseServersItemDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'ServersGetAllResponseServersItemDatacenterServerTypesSupported': ...
    ...
    ) -> 'ServersGetAllResponseServersItemDatacenterServerTypes':
