...
class ImagesGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def images() -> typing.Type['ImagesGetAllResponseImages']:
                return ImagesGetAllResponseImages
        
            @staticmethod
            def meta() -> typing.Type['ImagesGetAllResponseMeta']:
                return ImagesGetAllResponseMeta
            __annotations__ = {
                "images": images,
                "meta": meta,
            }
    
    images: 'ImagesGetAllResponseImages'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["images"]) -> 'ImagesGetAllResponseImages': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'ImagesGetAllResponseMeta': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["images", "meta", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["images"]) -> 'ImagesGetAllResponseImages': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['ImagesGetAllResponseMeta', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["images", "meta", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        images: 'ImagesGetAllResponseImages',
        meta: typing.Union['ImagesGetAllResponseMeta', schemas.Unset] = schemas.unset,
