...
class ServersCreateServerActionResponseServerIso(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def deprecation() -> typing.Type['ServersCreateServerActionResponseServerIsoDeprecation']:
                return ServersCreateServerActionResponseServerIsoDeprecation
    ...
    deprecation: 'ServersCreateServerActionResponseServerIsoDeprecation'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deprecation"]) -> 'ServersCreateServerActionResponseServerIsoDeprecation': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "architecture", "deprecation", "id", "name", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deprecation"]) -> 'ServersCreateServerActionResponseServerIsoDeprecation': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "architecture", "deprecation", "id", "name", "type", ], str]):
