...
class LoadBalancersGetAllResponseLoadBalancersItemTargetsItemTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersGetAllResponseLoadBalancersItemTargetsItemTargetsItemHealthStatusItem':
