...
class LoadBalancersGetByIdResponseLoadBalancerPublicNet(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ipv4() -> typing.Type['LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4']:
                return LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4
        
            @staticmethod
            def ipv6() -> typing.Type['LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6']:
                return LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6
            __annotations__ = {
                "enabled": enabled,
                "ipv4": ipv4,
                "ipv6": ipv6,
    ...
    ipv4: 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4'
    ipv6: 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv4': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv6"]) -> 'LoadBalancersGetByIdResponseLoadBalancerPublicNetIpv6': ...
