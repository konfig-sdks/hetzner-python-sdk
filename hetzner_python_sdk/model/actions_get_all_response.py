...
class ActionsGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['ActionsGetAllResponseActions']:
                return ActionsGetAllResponseActions
        
            @staticmethod
            def meta() -> typing.Type['ActionsGetAllResponseMeta']:
                return ActionsGetAllResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'ActionsGetAllResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'ActionsGetAllResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'ActionsGetAllResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'ActionsGetAllResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['ActionsGetAllResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'ActionsGetAllResponseActions',
        meta: typing.Union['ActionsGetAllResponseMeta', schemas.Unset] = schemas.unset,
