...
class FirewallActionsApplyToResourcesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actions() -> typing.Type['FirewallActionsApplyToResourcesResponseActions']:
                return FirewallActionsApplyToResourcesResponseActions
        
            @staticmethod
            def meta() -> typing.Type['FirewallActionsApplyToResourcesResponseMeta']:
                return FirewallActionsApplyToResourcesResponseMeta
            __annotations__ = {
                "actions": actions,
                "meta": meta,
            }
    
    actions: 'FirewallActionsApplyToResourcesResponseActions'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'FirewallActionsApplyToResourcesResponseActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'FirewallActionsApplyToResourcesResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> 'FirewallActionsApplyToResourcesResponseActions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['FirewallActionsApplyToResourcesResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        actions: 'FirewallActionsApplyToResourcesResponseActions',
        meta: typing.Union['FirewallActionsApplyToResourcesResponseMeta', schemas.Unset] = schemas.unset,
