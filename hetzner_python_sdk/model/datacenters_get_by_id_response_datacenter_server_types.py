...
class DatacentersGetByIdResponseDatacenterServerTypes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def available() -> typing.Type['DatacentersGetByIdResponseDatacenterServerTypesAvailable']:
                return DatacentersGetByIdResponseDatacenterServerTypesAvailable
        
            @staticmethod
            def available_for_migration() -> typing.Type['DatacentersGetByIdResponseDatacenterServerTypesAvailableForMigration']:
                return DatacentersGetByIdResponseDatacenterServerTypesAvailableForMigration
        
            @staticmethod
            def supported() -> typing.Type['DatacentersGetByIdResponseDatacenterServerTypesSupported']:
                return DatacentersGetByIdResponseDatacenterServerTypesSupported
            __annotations__ = {
                "available": available,
    ...
    available_for_migration: 'DatacentersGetByIdResponseDatacenterServerTypesAvailableForMigration'
    available: 'DatacentersGetByIdResponseDatacenterServerTypesAvailable'
    supported: 'DatacentersGetByIdResponseDatacenterServerTypesSupported'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["available_for_migration"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supported"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesSupported': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesAvailable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["available_for_migration"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesAvailableForMigration': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supported"]) -> 'DatacentersGetByIdResponseDatacenterServerTypesSupported': ...
    ...
    ) -> 'DatacentersGetByIdResponseDatacenterServerTypes':
