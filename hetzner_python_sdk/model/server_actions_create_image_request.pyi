...
class ServerActionsCreateImageRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def labels() -> typing.Type['ServerActionsCreateImageRequestLabels']:
                return ServerActionsCreateImageRequestLabels
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labels"]) -> 'ServerActionsCreateImageRequestLabels': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "labels", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labels"]) -> typing.Union['ServerActionsCreateImageRequestLabels', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "labels", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        labels: typing.Union['ServerActionsCreateImageRequestLabels', schemas.Unset] = schemas.unset,
