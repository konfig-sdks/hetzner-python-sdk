...
class LoadBalancersCreateLoadBalancerResponseLoadBalancerTargetsItemHealthStatusItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'LoadBalancersCreateLoadBalancerResponseLoadBalancerTargetsItemHealthStatusItem':
