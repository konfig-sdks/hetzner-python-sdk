...
class LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price_hourly() -> typing.Type['LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceHourly']:
                return LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceHourly
        
            @staticmethod
            def price_monthly() -> typing.Type['LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceMonthly']:
                return LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceMonthly
            __annotations__ = {
                "location": location,
    ...
    price_monthly: 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceMonthly'
    location: MetaOapg.properties.location
    price_hourly: 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceHourly'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_hourly"]) -> 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceHourly': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_monthly"]) -> 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItemPriceMonthly': ...
    ...
    ) -> 'LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesItem':
